...
module IncidentIoSdk
  class ActionsV1Api
    ...
    # @option opts [Boolean] :is_follow_up Filter to actions marked as being follow up actions
    # @option opts [String] :incident_mode Filter to actions from incidents of the given mode. If not set, only actions from &#x60;real&#x60; incidents are returned
    # @return [ActionsListResultV1]
    def actions_v1_list(opts = {})
      data, _status_code, _headers = actions_v1_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [Boolean] :is_follow_up Filter to actions marked as being follow up actions
    # @option opts [String] :incident_mode Filter to actions from incidents of the given mode. If not set, only actions from &#x60;real&#x60; incidents are returned
    # @return [Array<(ActionsListResultV1, Integer, Hash)>] ActionsListResultV1 data, response status code and response headers
    def actions_v1_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActionsV1Api.actions_v1_list ...'
      end
      allowable_values = ["real", "test", "tutorial"]
      ...
      query_params[:'is_follow_up'] = opts[:'is_follow_up'] if !opts[:'is_follow_up'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ActionsListResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ActionsV1Api.actions_v1_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsV1Api#actions_v1_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ActionsShowResultV1]
    def actions_v1_show(id, opts = {})
      data, _status_code, _headers = actions_v1_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier for the action
    # @param [Hash] opts the optional parameters
    # @return [Array<(ActionsShowResultV1, Integer, Hash)>] ActionsShowResultV1 data, response status code and response headers
    def actions_v1_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActionsV1Api.actions_v1_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ActionsV1Api.actions_v1_show"
      end
      # resource path
      local_var_path = '/v1/actions/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ActionsShowResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ActionsV1Api.actions_v1_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsV1Api#actions_v1_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
