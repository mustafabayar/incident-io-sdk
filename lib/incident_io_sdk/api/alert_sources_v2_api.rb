...
module IncidentIoSdk
  class AlertSourcesV2Api
    ...
    # @param alert_sources_create_payload_v2 [AlertSourcesCreatePayloadV2] 
    # @param [Hash] opts the optional parameters
    # @return [AlertSourcesCreateResultV2]
    def alert_sources_v2_create(alert_sources_create_payload_v2, opts = {})
      data, _status_code, _headers = alert_sources_v2_create_with_http_info(alert_sources_create_payload_v2, opts)
      data
    end
    ...
    # @param alert_sources_create_payload_v2 [AlertSourcesCreatePayloadV2] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(AlertSourcesCreateResultV2, Integer, Hash)>] AlertSourcesCreateResultV2 data, response status code and response headers
    def alert_sources_v2_create_with_http_info(alert_sources_create_payload_v2, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlertSourcesV2Api.alert_sources_v2_create ...'
      end
      # verify the required parameter 'alert_sources_create_payload_v2' is set
      if @api_client.config.client_side_validation && alert_sources_create_payload_v2.nil?
        fail ArgumentError, "Missing the required parameter 'alert_sources_create_payload_v2' when calling AlertSourcesV2Api.alert_sources_v2_create"
      end
      # resource path
      local_var_path = '/v2/alert_sources'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(alert_sources_create_payload_v2)

      # return_type
      return_type = opts[:debug_return_type] || 'AlertSourcesCreateResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AlertSourcesV2Api.alert_sources_v2_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlertSourcesV2Api#alert_sources_v2_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] The ID of this alert source
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def alert_sources_v2_delete(id, opts = {})
      alert_sources_v2_delete_with_http_info(id, opts)
      nil
    end
    ...
    def alert_sources_v2_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlertSourcesV2Api.alert_sources_v2_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AlertSourcesV2Api.alert_sources_v2_delete"
      end
      # resource path
      local_var_path = '/v2/alert_sources/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AlertSourcesV2Api.alert_sources_v2_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlertSourcesV2Api#alert_sources_v2_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [AlertSourcesListResultV2]
    def alert_sources_v2_list(opts = {})
      data, _status_code, _headers = alert_sources_v2_list_with_http_info(opts)
      data
    end
    ...
    # List all alert sources in your account.
    # @param [Hash] opts the optional parameters
    # @return [Array<(AlertSourcesListResultV2, Integer, Hash)>] AlertSourcesListResultV2 data, response status code and response headers
    def alert_sources_v2_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlertSourcesV2Api.alert_sources_v2_list ...'
      end
      # resource path
      local_var_path = '/v2/alert_sources'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AlertSourcesListResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AlertSourcesV2Api.alert_sources_v2_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlertSourcesV2Api#alert_sources_v2_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] The ID of this alert source
    # @param [Hash] opts the optional parameters
    # @return [AlertSourcesShowResultV2]
    def alert_sources_v2_show(id, opts = {})
      data, _status_code, _headers = alert_sources_v2_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] The ID of this alert source
    # @param [Hash] opts the optional parameters
    # @return [Array<(AlertSourcesShowResultV2, Integer, Hash)>] AlertSourcesShowResultV2 data, response status code and response headers
    def alert_sources_v2_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlertSourcesV2Api.alert_sources_v2_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AlertSourcesV2Api.alert_sources_v2_show"
      end
      # resource path
      local_var_path = '/v2/alert_sources/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AlertSourcesShowResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AlertSourcesV2Api.alert_sources_v2_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlertSourcesV2Api#alert_sources_v2_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] The ID of this alert source
    # @param alert_sources_update_payload_v2 [AlertSourcesUpdatePayloadV2] 
    # @param [Hash] opts the optional parameters
    # @return [AlertSourcesUpdateResultV2]
    def alert_sources_v2_update(id, alert_sources_update_payload_v2, opts = {})
      data, _status_code, _headers = alert_sources_v2_update_with_http_info(id, alert_sources_update_payload_v2, opts)
      data
    end
    ...
    # @param alert_sources_update_payload_v2 [AlertSourcesUpdatePayloadV2] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(AlertSourcesUpdateResultV2, Integer, Hash)>] AlertSourcesUpdateResultV2 data, response status code and response headers
    def alert_sources_v2_update_with_http_info(id, alert_sources_update_payload_v2, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlertSourcesV2Api.alert_sources_v2_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AlertSourcesV2Api.alert_sources_v2_update"
      end
      # verify the required parameter 'alert_sources_update_payload_v2' is set
      if @api_client.config.client_side_validation && alert_sources_update_payload_v2.nil?
        fail ArgumentError, "Missing the required parameter 'alert_sources_update_payload_v2' when calling AlertSourcesV2Api.alert_sources_v2_update"
      end
      # resource path
      local_var_path = '/v2/alert_sources/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(alert_sources_update_payload_v2)

      # return_type
      return_type = opts[:debug_return_type] || 'AlertSourcesUpdateResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AlertSourcesV2Api.alert_sources_v2_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlertSourcesV2Api#alert_sources_v2_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
