...
module IncidentIoSdk
  class AlertsV2Api
    ...
    # @param page_size [Integer] Number of alerts to return per page
    # @param [Hash] opts the optional parameters
    # @option opts [String] :after If provided, pass this as the &#39;after&#39; param to load the next page
    # @option opts [Hash<String, Array<String>>] :deduplication_key Filter on alert deduplication key. The accepted operator is &#39;is&#39;.
    # @option opts [Hash<String, Array<String>>] :status Filter on alert status. The accepted operators are &#39;one_of&#39;, or &#39;not_in&#39;.
    # @return [AlertsListResultV2]
    def alerts_v2_list(page_size, opts = {})
      data, _status_code, _headers = alerts_v2_list_with_http_info(page_size, opts)
      data
    end
    ...
    # @option opts [Hash<String, Array<String>>] :deduplication_key Filter on alert deduplication key. The accepted operator is &#39;is&#39;.
    # @option opts [Hash<String, Array<String>>] :status Filter on alert status. The accepted operators are &#39;one_of&#39;, or &#39;not_in&#39;.
    # @return [Array<(AlertsListResultV2, Integer, Hash)>] AlertsListResultV2 data, response status code and response headers
    def alerts_v2_list_with_http_info(page_size, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlertsV2Api.alerts_v2_list ...'
      end
      # verify the required parameter 'page_size' is set
      if @api_client.config.client_side_validation && page_size.nil?
        fail ArgumentError, "Missing the required parameter 'page_size' when calling AlertsV2Api.alerts_v2_list"
      end
      if @api_client.config.client_side_validation && page_size > 50
        fail ArgumentError, 'invalid value for "page_size" when calling AlertsV2Api.alerts_v2_list, must be smaller than or equal to 50.'
      end

      if @api_client.config.client_side_validation && page_size < 1
        fail ArgumentError, 'invalid value for "page_size" when calling AlertsV2Api.alerts_v2_list, must be greater than or equal to 1.'
      end
      ...
      query_params[:'deduplication_key'] = opts[:'deduplication_key'] if !opts[:'deduplication_key'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AlertsListResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AlertsV2Api.alerts_v2_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlertsV2Api#alerts_v2_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param page_size [Integer] Number of incident alerts to return per page
    # @param [Hash] opts the optional parameters
    # @option opts [String] :after If provided, pass this as the &#39;after&#39; param to load the next page
    # @option opts [String] :alert_id Alert that this incident alert refers to
    # @option opts [String] :incident_id Incident that this incident alert is attached to
    # @return [AlertsListIncidentAlertsResultV2]
    def alerts_v2_list_incident_alerts(page_size, opts = {})
      data, _status_code, _headers = alerts_v2_list_incident_alerts_with_http_info(page_size, opts)
      data
    end
    ...
    # @option opts [String] :alert_id Alert that this incident alert refers to
    # @option opts [String] :incident_id Incident that this incident alert is attached to
    # @return [Array<(AlertsListIncidentAlertsResultV2, Integer, Hash)>] AlertsListIncidentAlertsResultV2 data, response status code and response headers
    def alerts_v2_list_incident_alerts_with_http_info(page_size, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlertsV2Api.alerts_v2_list_incident_alerts ...'
      end
      # verify the required parameter 'page_size' is set
      if @api_client.config.client_side_validation && page_size.nil?
        fail ArgumentError, "Missing the required parameter 'page_size' when calling AlertsV2Api.alerts_v2_list_incident_alerts"
      end
      if @api_client.config.client_side_validation && page_size > 50
        fail ArgumentError, 'invalid value for "page_size" when calling AlertsV2Api.alerts_v2_list_incident_alerts, must be smaller than or equal to 50.'
      end

      if @api_client.config.client_side_validation && page_size < 1
        fail ArgumentError, 'invalid value for "page_size" when calling AlertsV2Api.alerts_v2_list_incident_alerts, must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = '/v2/incident_alerts'

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'page_size'] = page_size
      query_params[:'after'] = opts[:'after'] if !opts[:'after'].nil?
      query_params[:'alert_id'] = opts[:'alert_id'] if !opts[:'alert_id'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AlertsListIncidentAlertsResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AlertsV2Api.alerts_v2_list_incident_alerts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlertsV2Api#alerts_v2_list_incident_alerts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique identifier for the alert
    # @param [Hash] opts the optional parameters
    # @return [AlertsShowResultV2]
    def alerts_v2_show(id, opts = {})
      data, _status_code, _headers = alerts_v2_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier for the alert
    # @param [Hash] opts the optional parameters
    # @return [Array<(AlertsShowResultV2, Integer, Hash)>] AlertsShowResultV2 data, response status code and response headers
    def alerts_v2_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AlertsV2Api.alerts_v2_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AlertsV2Api.alerts_v2_show"
      end
      # resource path
      local_var_path = '/v2/alerts/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AlertsShowResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AlertsV2Api.alerts_v2_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AlertsV2Api#alerts_v2_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
