...
module IncidentIoSdk
  class CustomFieldsV1Api
    ...
    # @param custom_fields_create_payload_v1 [CustomFieldsCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [CustomFieldsCreateResultV1]
    def custom_fields_v1_create(custom_fields_create_payload_v1, opts = {})
      data, _status_code, _headers = custom_fields_v1_create_with_http_info(custom_fields_create_payload_v1, opts)
      data
    end
    ...
    # @param custom_fields_create_payload_v1 [CustomFieldsCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomFieldsCreateResultV1, Integer, Hash)>] CustomFieldsCreateResultV1 data, response status code and response headers
    def custom_fields_v1_create_with_http_info(custom_fields_create_payload_v1, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV1Api.custom_fields_v1_create ...'
      end
      # verify the required parameter 'custom_fields_create_payload_v1' is set
      if @api_client.config.client_side_validation && custom_fields_create_payload_v1.nil?
        fail ArgumentError, "Missing the required parameter 'custom_fields_create_payload_v1' when calling CustomFieldsV1Api.custom_fields_v1_create"
      end
      # resource path
      local_var_path = '/v1/custom_fields'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(custom_fields_create_payload_v1)

      # return_type
      return_type = opts[:debug_return_type] || 'CustomFieldsCreateResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CustomFieldsV1Api.custom_fields_v1_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV1Api#custom_fields_v1_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def custom_fields_v1_delete(id, opts = {})
      custom_fields_v1_delete_with_http_info(id, opts)
      nil
    end
    ...
    def custom_fields_v1_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV1Api.custom_fields_v1_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomFieldsV1Api.custom_fields_v1_delete"
      end
      # resource path
      local_var_path = '/v1/custom_fields/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CustomFieldsV1Api.custom_fields_v1_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV1Api#custom_fields_v1_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [CustomFieldsListResultV1]
    def custom_fields_v1_list(opts = {})
      data, _status_code, _headers = custom_fields_v1_list_with_http_info(opts)
      data
    end
    ...
    # List all custom fields for an organisation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomFieldsListResultV1, Integer, Hash)>] CustomFieldsListResultV1 data, response status code and response headers
    def custom_fields_v1_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV1Api.custom_fields_v1_list ...'
      end
      # resource path
      local_var_path = '/v1/custom_fields'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CustomFieldsListResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CustomFieldsV1Api.custom_fields_v1_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV1Api#custom_fields_v1_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique identifier for the custom field
    # @param [Hash] opts the optional parameters
    # @return [CustomFieldsShowResultV1]
    def custom_fields_v1_show(id, opts = {})
      data, _status_code, _headers = custom_fields_v1_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier for the custom field
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomFieldsShowResultV1, Integer, Hash)>] CustomFieldsShowResultV1 data, response status code and response headers
    def custom_fields_v1_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV1Api.custom_fields_v1_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomFieldsV1Api.custom_fields_v1_show"
      end
      # resource path
      local_var_path = '/v1/custom_fields/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CustomFieldsShowResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CustomFieldsV1Api.custom_fields_v1_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV1Api#custom_fields_v1_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique identifier for the custom field
    # @param custom_fields_update_payload_v1 [CustomFieldsUpdatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [CustomFieldsUpdateResultV1]
    def custom_fields_v1_update(id, custom_fields_update_payload_v1, opts = {})
      data, _status_code, _headers = custom_fields_v1_update_with_http_info(id, custom_fields_update_payload_v1, opts)
      data
    end
    ...
    # @param custom_fields_update_payload_v1 [CustomFieldsUpdatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomFieldsUpdateResultV1, Integer, Hash)>] CustomFieldsUpdateResultV1 data, response status code and response headers
    def custom_fields_v1_update_with_http_info(id, custom_fields_update_payload_v1, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV1Api.custom_fields_v1_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomFieldsV1Api.custom_fields_v1_update"
      end
      # verify the required parameter 'custom_fields_update_payload_v1' is set
      if @api_client.config.client_side_validation && custom_fields_update_payload_v1.nil?
        fail ArgumentError, "Missing the required parameter 'custom_fields_update_payload_v1' when calling CustomFieldsV1Api.custom_fields_v1_update"
      end
      # resource path
      local_var_path = '/v1/custom_fields/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(custom_fields_update_payload_v1)

      # return_type
      return_type = opts[:debug_return_type] || 'CustomFieldsUpdateResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CustomFieldsV1Api.custom_fields_v1_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV1Api#custom_fields_v1_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
