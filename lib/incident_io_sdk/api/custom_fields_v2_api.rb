...
module IncidentIoSdk
  class CustomFieldsV2Api
    ...
    # @param custom_fields_create_payload_v2 [CustomFieldsCreatePayloadV2] 
    # @param [Hash] opts the optional parameters
    # @return [CustomFieldsCreateResultV2]
    def custom_fields_v2_create(custom_fields_create_payload_v2, opts = {})
      data, _status_code, _headers = custom_fields_v2_create_with_http_info(custom_fields_create_payload_v2, opts)
      data
    end
    ...
    # @param custom_fields_create_payload_v2 [CustomFieldsCreatePayloadV2] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomFieldsCreateResultV2, Integer, Hash)>] CustomFieldsCreateResultV2 data, response status code and response headers
    def custom_fields_v2_create_with_http_info(custom_fields_create_payload_v2, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV2Api.custom_fields_v2_create ...'
      end
      # verify the required parameter 'custom_fields_create_payload_v2' is set
      if @api_client.config.client_side_validation && custom_fields_create_payload_v2.nil?
        fail ArgumentError, "Missing the required parameter 'custom_fields_create_payload_v2' when calling CustomFieldsV2Api.custom_fields_v2_create"
      end
      # resource path
      local_var_path = '/v2/custom_fields'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(custom_fields_create_payload_v2)

      # return_type
      return_type = opts[:debug_return_type] || 'CustomFieldsCreateResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CustomFieldsV2Api.custom_fields_v2_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV2Api#custom_fields_v2_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def custom_fields_v2_delete(id, opts = {})
      custom_fields_v2_delete_with_http_info(id, opts)
      nil
    end
    ...
    def custom_fields_v2_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV2Api.custom_fields_v2_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomFieldsV2Api.custom_fields_v2_delete"
      end
      # resource path
      local_var_path = '/v2/custom_fields/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CustomFieldsV2Api.custom_fields_v2_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV2Api#custom_fields_v2_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [CustomFieldsListResultV2]
    def custom_fields_v2_list(opts = {})
      data, _status_code, _headers = custom_fields_v2_list_with_http_info(opts)
      data
    end
    ...
    # List all custom fields for an organisation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomFieldsListResultV2, Integer, Hash)>] CustomFieldsListResultV2 data, response status code and response headers
    def custom_fields_v2_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV2Api.custom_fields_v2_list ...'
      end
      # resource path
      local_var_path = '/v2/custom_fields'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CustomFieldsListResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CustomFieldsV2Api.custom_fields_v2_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV2Api#custom_fields_v2_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique identifier for the custom field
    # @param [Hash] opts the optional parameters
    # @return [CustomFieldsShowResultV2]
    def custom_fields_v2_show(id, opts = {})
      data, _status_code, _headers = custom_fields_v2_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier for the custom field
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomFieldsShowResultV2, Integer, Hash)>] CustomFieldsShowResultV2 data, response status code and response headers
    def custom_fields_v2_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV2Api.custom_fields_v2_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomFieldsV2Api.custom_fields_v2_show"
      end
      # resource path
      local_var_path = '/v2/custom_fields/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CustomFieldsShowResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CustomFieldsV2Api.custom_fields_v2_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV2Api#custom_fields_v2_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique identifier for the custom field
    # @param custom_fields_update_payload_v2 [CustomFieldsUpdatePayloadV2] 
    # @param [Hash] opts the optional parameters
    # @return [CustomFieldsUpdateResultV2]
    def custom_fields_v2_update(id, custom_fields_update_payload_v2, opts = {})
      data, _status_code, _headers = custom_fields_v2_update_with_http_info(id, custom_fields_update_payload_v2, opts)
      data
    end
    ...
    # @param custom_fields_update_payload_v2 [CustomFieldsUpdatePayloadV2] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CustomFieldsUpdateResultV2, Integer, Hash)>] CustomFieldsUpdateResultV2 data, response status code and response headers
    def custom_fields_v2_update_with_http_info(id, custom_fields_update_payload_v2, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomFieldsV2Api.custom_fields_v2_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomFieldsV2Api.custom_fields_v2_update"
      end
      # verify the required parameter 'custom_fields_update_payload_v2' is set
      if @api_client.config.client_side_validation && custom_fields_update_payload_v2.nil?
        fail ArgumentError, "Missing the required parameter 'custom_fields_update_payload_v2' when calling CustomFieldsV2Api.custom_fields_v2_update"
      end
      # resource path
      local_var_path = '/v2/custom_fields/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(custom_fields_update_payload_v2)

      # return_type
      return_type = opts[:debug_return_type] || 'CustomFieldsUpdateResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CustomFieldsV2Api.custom_fields_v2_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomFieldsV2Api#custom_fields_v2_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
