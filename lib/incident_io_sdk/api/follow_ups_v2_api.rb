...
module IncidentIoSdk
  class FollowUpsV2Api
    ...
    # @option opts [String] :incident_id Find follow-ups related to this incident
    # @option opts [String] :incident_mode Filter to follow-ups from incidents of the given mode. If not set, only follow-ups from &#x60;standard&#x60; and &#x60;retrospective&#x60; incidents are returned
    # @return [FollowUpsListResultV2]
    def follow_ups_v2_list(opts = {})
      data, _status_code, _headers = follow_ups_v2_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :incident_id Find follow-ups related to this incident
    # @option opts [String] :incident_mode Filter to follow-ups from incidents of the given mode. If not set, only follow-ups from &#x60;standard&#x60; and &#x60;retrospective&#x60; incidents are returned
    # @return [Array<(FollowUpsListResultV2, Integer, Hash)>] FollowUpsListResultV2 data, response status code and response headers
    def follow_ups_v2_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FollowUpsV2Api.follow_ups_v2_list ...'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FollowUpsListResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FollowUpsV2Api.follow_ups_v2_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FollowUpsV2Api#follow_ups_v2_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] Unique identifier for the follow-up
    # @param [Hash] opts the optional parameters
    # @return [FollowUpsShowResultV2]
    def follow_ups_v2_show(id, opts = {})
      data, _status_code, _headers = follow_ups_v2_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier for the follow-up
    # @param [Hash] opts the optional parameters
    # @return [Array<(FollowUpsShowResultV2, Integer, Hash)>] FollowUpsShowResultV2 data, response status code and response headers
    def follow_ups_v2_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FollowUpsV2Api.follow_ups_v2_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling FollowUpsV2Api.follow_ups_v2_show"
      end
      # resource path
      local_var_path = '/v2/follow_ups/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FollowUpsShowResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"FollowUpsV2Api.follow_ups_v2_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FollowUpsV2Api#follow_ups_v2_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
