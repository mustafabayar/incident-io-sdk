...
module IncidentIoSdk
  class IncidentAttachmentsV1Api
    ...
    # @param incident_attachments_create_payload_v1 [IncidentAttachmentsCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [IncidentAttachmentsCreateResultV1]
    def incident_attachments_v1_create(incident_attachments_create_payload_v1, opts = {})
      data, _status_code, _headers = incident_attachments_v1_create_with_http_info(incident_attachments_create_payload_v1, opts)
      data
    end
    ...
    # @param incident_attachments_create_payload_v1 [IncidentAttachmentsCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentAttachmentsCreateResultV1, Integer, Hash)>] IncidentAttachmentsCreateResultV1 data, response status code and response headers
    def incident_attachments_v1_create_with_http_info(incident_attachments_create_payload_v1, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentAttachmentsV1Api.incident_attachments_v1_create ...'
      end
      # verify the required parameter 'incident_attachments_create_payload_v1' is set
      if @api_client.config.client_side_validation && incident_attachments_create_payload_v1.nil?
        fail ArgumentError, "Missing the required parameter 'incident_attachments_create_payload_v1' when calling IncidentAttachmentsV1Api.incident_attachments_v1_create"
      end
      # resource path
      local_var_path = '/v1/incident_attachments'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(incident_attachments_create_payload_v1)

      # return_type
      return_type = opts[:debug_return_type] || 'IncidentAttachmentsCreateResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentAttachmentsV1Api.incident_attachments_v1_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentAttachmentsV1Api#incident_attachments_v1_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] Unique identifier of this incident membership
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def incident_attachments_v1_delete(id, opts = {})
      incident_attachments_v1_delete_with_http_info(id, opts)
      nil
    end
    ...
    def incident_attachments_v1_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentAttachmentsV1Api.incident_attachments_v1_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentAttachmentsV1Api.incident_attachments_v1_delete"
      end
      # resource path
      local_var_path = '/v1/incident_attachments/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"IncidentAttachmentsV1Api.incident_attachments_v1_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentAttachmentsV1Api#incident_attachments_v1_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :incident_id Incident that this attachment is against
    # @option opts [String] :external_id ID of the resource in the external system
    # @option opts [String] :resource_type E.g. PagerDuty: the external system that holds the resource
    # @return [IncidentAttachmentsListResultV1]
    def incident_attachments_v1_list(opts = {})
      data, _status_code, _headers = incident_attachments_v1_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :external_id ID of the resource in the external system
    # @option opts [String] :resource_type E.g. PagerDuty: the external system that holds the resource
    # @return [Array<(IncidentAttachmentsListResultV1, Integer, Hash)>] IncidentAttachmentsListResultV1 data, response status code and response headers
    def incident_attachments_v1_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentAttachmentsV1Api.incident_attachments_v1_list ...'
      end
      allowable_values = ["pager_duty_incident", "opsgenie_alert", "datadog_monitor_alert", "github_pull_request", "gitlab_merge_request", "sentry_issue", "jira_issue", "atlassian_statuspage_incident", "zendesk_ticket", "google_calendar_event", "outlook_calendar_event", "slack_file", "scrubbed", "statuspage_incident"]
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentAttachmentsListResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentAttachmentsV1Api.incident_attachments_v1_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentAttachmentsV1Api#incident_attachments_v1_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
