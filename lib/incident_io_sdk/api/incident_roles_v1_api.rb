...
module IncidentIoSdk
  class IncidentRolesV1Api
    ...
    # @param incident_roles_create_payload_v1 [IncidentRolesCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [IncidentRolesCreateResultV1]
    def incident_roles_v1_create(incident_roles_create_payload_v1, opts = {})
      data, _status_code, _headers = incident_roles_v1_create_with_http_info(incident_roles_create_payload_v1, opts)
      data
    end
    ...
    # @param incident_roles_create_payload_v1 [IncidentRolesCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentRolesCreateResultV1, Integer, Hash)>] IncidentRolesCreateResultV1 data, response status code and response headers
    def incident_roles_v1_create_with_http_info(incident_roles_create_payload_v1, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentRolesV1Api.incident_roles_v1_create ...'
      end
      # verify the required parameter 'incident_roles_create_payload_v1' is set
      if @api_client.config.client_side_validation && incident_roles_create_payload_v1.nil?
        fail ArgumentError, "Missing the required parameter 'incident_roles_create_payload_v1' when calling IncidentRolesV1Api.incident_roles_v1_create"
      end
      # resource path
      local_var_path = '/v1/incident_roles'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(incident_roles_create_payload_v1)

      # return_type
      return_type = opts[:debug_return_type] || 'IncidentRolesCreateResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentRolesV1Api.incident_roles_v1_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentRolesV1Api#incident_roles_v1_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def incident_roles_v1_delete(id, opts = {})
      incident_roles_v1_delete_with_http_info(id, opts)
      nil
    end
    ...
    def incident_roles_v1_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentRolesV1Api.incident_roles_v1_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentRolesV1Api.incident_roles_v1_delete"
      end
      # resource path
      local_var_path = '/v1/incident_roles/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"IncidentRolesV1Api.incident_roles_v1_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentRolesV1Api#incident_roles_v1_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [IncidentRolesListResultV1]
    def incident_roles_v1_list(opts = {})
      data, _status_code, _headers = incident_roles_v1_list_with_http_info(opts)
      data
    end
    ...
    # List all incident roles for an organisation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentRolesListResultV1, Integer, Hash)>] IncidentRolesListResultV1 data, response status code and response headers
    def incident_roles_v1_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentRolesV1Api.incident_roles_v1_list ...'
      end
      # resource path
      local_var_path = '/v1/incident_roles'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentRolesListResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentRolesV1Api.incident_roles_v1_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentRolesV1Api#incident_roles_v1_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique identifier for the role
    # @param [Hash] opts the optional parameters
    # @return [IncidentRolesShowResultV1]
    def incident_roles_v1_show(id, opts = {})
      data, _status_code, _headers = incident_roles_v1_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier for the role
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentRolesShowResultV1, Integer, Hash)>] IncidentRolesShowResultV1 data, response status code and response headers
    def incident_roles_v1_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentRolesV1Api.incident_roles_v1_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentRolesV1Api.incident_roles_v1_show"
      end
      # resource path
      local_var_path = '/v1/incident_roles/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentRolesShowResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentRolesV1Api.incident_roles_v1_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentRolesV1Api#incident_roles_v1_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique identifier for the role
    # @param incident_roles_update_payload_v1 [IncidentRolesUpdatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [IncidentRolesUpdateResultV1]
    def incident_roles_v1_update(id, incident_roles_update_payload_v1, opts = {})
      data, _status_code, _headers = incident_roles_v1_update_with_http_info(id, incident_roles_update_payload_v1, opts)
      data
    end
    ...
    # @param incident_roles_update_payload_v1 [IncidentRolesUpdatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentRolesUpdateResultV1, Integer, Hash)>] IncidentRolesUpdateResultV1 data, response status code and response headers
    def incident_roles_v1_update_with_http_info(id, incident_roles_update_payload_v1, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentRolesV1Api.incident_roles_v1_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentRolesV1Api.incident_roles_v1_update"
      end
      # verify the required parameter 'incident_roles_update_payload_v1' is set
      if @api_client.config.client_side_validation && incident_roles_update_payload_v1.nil?
        fail ArgumentError, "Missing the required parameter 'incident_roles_update_payload_v1' when calling IncidentRolesV1Api.incident_roles_v1_update"
      end
      # resource path
      local_var_path = '/v1/incident_roles/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(incident_roles_update_payload_v1)

      # return_type
      return_type = opts[:debug_return_type] || 'IncidentRolesUpdateResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentRolesV1Api.incident_roles_v1_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentRolesV1Api#incident_roles_v1_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
