...
module IncidentIoSdk
  class IncidentStatusesV1Api
    ...
    # @param incident_statuses_create_payload_v1 [IncidentStatusesCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [IncidentStatusesCreateResultV1]
    def incident_statuses_v1_create(incident_statuses_create_payload_v1, opts = {})
      data, _status_code, _headers = incident_statuses_v1_create_with_http_info(incident_statuses_create_payload_v1, opts)
      data
    end
    ...
    # @param incident_statuses_create_payload_v1 [IncidentStatusesCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentStatusesCreateResultV1, Integer, Hash)>] IncidentStatusesCreateResultV1 data, response status code and response headers
    def incident_statuses_v1_create_with_http_info(incident_statuses_create_payload_v1, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentStatusesV1Api.incident_statuses_v1_create ...'
      end
      # verify the required parameter 'incident_statuses_create_payload_v1' is set
      if @api_client.config.client_side_validation && incident_statuses_create_payload_v1.nil?
        fail ArgumentError, "Missing the required parameter 'incident_statuses_create_payload_v1' when calling IncidentStatusesV1Api.incident_statuses_v1_create"
      end
      # resource path
      local_var_path = '/v1/incident_statuses'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(incident_statuses_create_payload_v1)

      # return_type
      return_type = opts[:debug_return_type] || 'IncidentStatusesCreateResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentStatusesV1Api.incident_statuses_v1_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentStatusesV1Api#incident_statuses_v1_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] Unique ID of this incident status
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def incident_statuses_v1_delete(id, opts = {})
      incident_statuses_v1_delete_with_http_info(id, opts)
      nil
    end
    ...
    def incident_statuses_v1_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentStatusesV1Api.incident_statuses_v1_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentStatusesV1Api.incident_statuses_v1_delete"
      end
      # resource path
      local_var_path = '/v1/incident_statuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"IncidentStatusesV1Api.incident_statuses_v1_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentStatusesV1Api#incident_statuses_v1_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def incident_statuses_v1_list(opts = {})
      data, _status_code, _headers = incident_statuses_v1_list_with_http_info(opts)
      data
    end
    ...
    # List all incident statuses for an organisation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentStatusesListResultV1, Integer, Hash)>] IncidentStatusesListResultV1 data, response status code and response headers
    def incident_statuses_v1_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentStatusesV1Api.incident_statuses_v1_list ...'
      end
      # resource path
      local_var_path = '/v1/incident_statuses'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentStatusesListResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentStatusesV1Api.incident_statuses_v1_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentStatusesV1Api#incident_statuses_v1_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def incident_statuses_v1_show(id, opts = {})
      data, _status_code, _headers = incident_statuses_v1_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique ID of this incident status
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentStatusesShowResultV1, Integer, Hash)>] IncidentStatusesShowResultV1 data, response status code and response headers
    def incident_statuses_v1_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentStatusesV1Api.incident_statuses_v1_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentStatusesV1Api.incident_statuses_v1_show"
      end
      # resource path
      local_var_path = '/v1/incident_statuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentStatusesShowResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentStatusesV1Api.incident_statuses_v1_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentStatusesV1Api#incident_statuses_v1_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] Unique ID of this incident status
    # @param incident_statuses_update_payload_v1 [IncidentStatusesUpdatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [IncidentStatusesUpdateResultV1]
    def incident_statuses_v1_update(id, incident_statuses_update_payload_v1, opts = {})
      data, _status_code, _headers = incident_statuses_v1_update_with_http_info(id, incident_statuses_update_payload_v1, opts)
      data
    end
    ...
    # @param incident_statuses_update_payload_v1 [IncidentStatusesUpdatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentStatusesUpdateResultV1, Integer, Hash)>] IncidentStatusesUpdateResultV1 data, response status code and response headers
    def incident_statuses_v1_update_with_http_info(id, incident_statuses_update_payload_v1, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentStatusesV1Api.incident_statuses_v1_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentStatusesV1Api.incident_statuses_v1_update"
      end
      # verify the required parameter 'incident_statuses_update_payload_v1' is set
      if @api_client.config.client_side_validation && incident_statuses_update_payload_v1.nil?
        fail ArgumentError, "Missing the required parameter 'incident_statuses_update_payload_v1' when calling IncidentStatusesV1Api.incident_statuses_v1_update"
      end
      # resource path
      local_var_path = '/v1/incident_statuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(incident_statuses_update_payload_v1)

      # return_type
      return_type = opts[:debug_return_type] || 'IncidentStatusesUpdateResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentStatusesV1Api.incident_statuses_v1_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentStatusesV1Api#incident_statuses_v1_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
