...
module IncidentIoSdk
  class IncidentTimestampsV2Api
    ...
    def incident_timestamps_v2_list(opts = {})
      data, _status_code, _headers = incident_timestamps_v2_list_with_http_info(opts)
      data
    end
    ...
    # List all incident timestamps for an organisation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentTimestampsListResultV2, Integer, Hash)>] IncidentTimestampsListResultV2 data, response status code and response headers
    def incident_timestamps_v2_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentTimestampsV2Api.incident_timestamps_v2_list ...'
      end
      # resource path
      local_var_path = '/v2/incident_timestamps'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentTimestampsListResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentTimestampsV2Api.incident_timestamps_v2_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentTimestampsV2Api#incident_timestamps_v2_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] Unique ID of this incident timestamp
    # @param [Hash] opts the optional parameters
    # @return [IncidentTimestampsShowResultV2]
    def incident_timestamps_v2_show(id, opts = {})
      data, _status_code, _headers = incident_timestamps_v2_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique ID of this incident timestamp
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentTimestampsShowResultV2, Integer, Hash)>] IncidentTimestampsShowResultV2 data, response status code and response headers
    def incident_timestamps_v2_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentTimestampsV2Api.incident_timestamps_v2_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentTimestampsV2Api.incident_timestamps_v2_show"
      end
      # resource path
      local_var_path = '/v2/incident_timestamps/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentTimestampsShowResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentTimestampsV2Api.incident_timestamps_v2_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentTimestampsV2Api#incident_timestamps_v2_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
