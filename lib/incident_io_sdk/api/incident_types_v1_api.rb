...
module IncidentIoSdk
  class IncidentTypesV1Api
    ...
    def incident_types_v1_list(opts = {})
      data, _status_code, _headers = incident_types_v1_list_with_http_info(opts)
      data
    end
    ...
    # List all incident types for an organisation.
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentTypesListResultV1, Integer, Hash)>] IncidentTypesListResultV1 data, response status code and response headers
    def incident_types_v1_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentTypesV1Api.incident_types_v1_list ...'
      end
      # resource path
      local_var_path = '/v1/incident_types'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentTypesListResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentTypesV1Api.incident_types_v1_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentTypesV1Api#incident_types_v1_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] Unique identifier for this Incident Type
    # @param [Hash] opts the optional parameters
    # @return [IncidentTypesShowResultV1]
    def incident_types_v1_show(id, opts = {})
      data, _status_code, _headers = incident_types_v1_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier for this Incident Type
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentTypesShowResultV1, Integer, Hash)>] IncidentTypesShowResultV1 data, response status code and response headers
    def incident_types_v1_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentTypesV1Api.incident_types_v1_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentTypesV1Api.incident_types_v1_show"
      end
      # resource path
      local_var_path = '/v1/incident_types/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentTypesShowResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentTypesV1Api.incident_types_v1_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentTypesV1Api#incident_types_v1_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
