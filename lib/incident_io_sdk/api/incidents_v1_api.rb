...
module IncidentIoSdk
  class IncidentsV1Api
    ...
    # @param incidents_create_payload_v1 [IncidentsCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [IncidentsCreateResultV1]
    def incidents_v1_create(incidents_create_payload_v1, opts = {})
      data, _status_code, _headers = incidents_v1_create_with_http_info(incidents_create_payload_v1, opts)
      data
    end
    ...
    # @param incidents_create_payload_v1 [IncidentsCreatePayloadV1] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentsCreateResultV1, Integer, Hash)>] IncidentsCreateResultV1 data, response status code and response headers
    def incidents_v1_create_with_http_info(incidents_create_payload_v1, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentsV1Api.incidents_v1_create ...'
      end
      # verify the required parameter 'incidents_create_payload_v1' is set
      if @api_client.config.client_side_validation && incidents_create_payload_v1.nil?
        fail ArgumentError, "Missing the required parameter 'incidents_create_payload_v1' when calling IncidentsV1Api.incidents_v1_create"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(incidents_create_payload_v1)

      # return_type
      return_type = opts[:debug_return_type] || 'IncidentsCreateResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentsV1Api.incidents_v1_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentsV1Api#incidents_v1_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def incidents_v1_list(opts = {})
      data, _status_code, _headers = incidents_v1_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :after An record&#39;s ID. This endpoint will return a list of records after this ID in relation to the API response order.
    # @option opts [Array<String>] :status Filter for incidents in these statuses
    # @return [Array<(IncidentsListResultV1, Integer, Hash)>] IncidentsListResultV1 data, response status code and response headers
    def incidents_v1_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentsV1Api.incidents_v1_list ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 500
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling IncidentsV1Api.incidents_v1_list, must be smaller than or equal to 500.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentsListResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentsV1Api.incidents_v1_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentsV1Api#incidents_v1_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def incidents_v1_show(id, opts = {})
      data, _status_code, _headers = incidents_v1_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier for the incident
    # @param [Hash] opts the optional parameters
    # @return [Array<(IncidentsShowResultV1, Integer, Hash)>] IncidentsShowResultV1 data, response status code and response headers
    def incidents_v1_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentsV1Api.incidents_v1_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IncidentsV1Api.incidents_v1_show"
      end
      # resource path
      local_var_path = '/v1/incidents/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentsShowResultV1'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"IncidentsV1Api.incidents_v1_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentsV1Api#incidents_v1_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
