...
module IncidentIoSdk
  class SchedulesV2Api
    ...
    def create_with_http_info(schedules_create_payload_v2, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(schedules_create_payload_v2)

      # return_type
      return_type = opts[:debug_return_type] || 'SchedulesCreateResultV2'
    ...
    def create_override_with_http_info(schedules_create_override_payload_v2, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(schedules_create_override_payload_v2)

      # return_type
      return_type = opts[:debug_return_type] || 'SchedulesCreateOverrideResultV2'
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SchedulesListResultV2'
    ...
    # @param schedule_id [String] The ID of the schedule to get entries for.
    # @param [Hash] opts the optional parameters
    ...
    def list_schedule_entries_with_http_info(schedule_id, opts = {})
      ...
      query_params[:'entry_window_start'] = opts[:'entry_window_start'] if !opts[:'entry_window_start'].nil?
      query_params[:'entry_window_end'] = opts[:'entry_window_end'] if !opts[:'entry_window_end'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SchedulesListScheduleEntriesResultV2'
    ...
    def show_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SchedulesShowResultV2'
    ...
    # Update Schedules V2
    # Update a schedule.
    # @param id [String] The schedule ID to update.
    ...
    def update_with_http_info(id, schedules_update_payload_v2, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(schedules_update_payload_v2)

      # return_type
      return_type = opts[:debug_return_type] || 'SchedulesUpdateResultV2'
