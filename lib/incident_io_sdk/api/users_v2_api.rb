...
module IncidentIoSdk
  class UsersV2Api
    ...
    def users_v2_list(opts = {})
      data, _status_code, _headers = users_v2_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :page_size Integer number of records to return (default to 25)
    # @option opts [String] :after An record&#39;s ID. This endpoint will return a list of records after this ID in relation to the API response order.
    # @return [Array<(UsersListResultV2, Integer, Hash)>] UsersListResultV2 data, response status code and response headers
    def users_v2_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersV2Api.users_v2_list ...'
      end
      # resource path
      ...
      query_params[:'slack_user_id'] = opts[:'slack_user_id'] if !opts[:'slack_user_id'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UsersListResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"UsersV2Api.users_v2_list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersV2Api#users_v2_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def users_v2_show(id, opts = {})
      data, _status_code, _headers = users_v2_show_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] Unique identifier of the user
    # @param [Hash] opts the optional parameters
    # @return [Array<(UsersShowResultV2, Integer, Hash)>] UsersShowResultV2 data, response status code and response headers
    def users_v2_show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersV2Api.users_v2_show ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UsersV2Api.users_v2_show"
      end
      # resource path
      local_var_path = '/v2/users/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UsersShowResultV2'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"UsersV2Api.users_v2_show",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersV2Api#users_v2_show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
