  ...
  class AlertAttributesCreateResultV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::AlertAttributesCreateResultV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::AlertAttributesCreateResultV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'alert_attribute')
        self.alert_attribute = attributes[:'alert_attribute']
      else
        self.alert_attribute = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @alert_attribute.nil?
        invalid_properties.push('invalid value for "alert_attribute", alert_attribute cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @alert_attribute.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] alert_attribute Value to be assigned
    def alert_attribute=(alert_attribute)
      if alert_attribute.nil?
        fail ArgumentError, 'alert_attribute cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          alert_attribute == o.alert_attribute
    end
