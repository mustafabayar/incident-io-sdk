  ...
  class AlertRouteAutoGeneratedTemplateBindingV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @autogenerated.nil?
        invalid_properties.push('invalid value for "autogenerated", autogenerated cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @autogenerated.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] autogenerated Value to be assigned
    def autogenerated=(autogenerated)
      if autogenerated.nil?
        fail ArgumentError, 'autogenerated cannot be nil'
      end
