...
module IncidentIoSdk
  class AlertRouteChannelTargetPayloadV2
    ...
    attr_accessor :channel_visibility
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::AlertRouteChannelTargetPayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::AlertRouteChannelTargetPayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'channel_visibility')
        self.channel_visibility = attributes[:'channel_visibility']
      else
        self.channel_visibility = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @channel_visibility.nil?
        invalid_properties.push('invalid value for "channel_visibility", channel_visibility cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @channel_visibility.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] channel_visibility Value to be assigned
    def channel_visibility=(channel_visibility)
      if channel_visibility.nil?
        fail ArgumentError, 'channel_visibility cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          binding == o.binding &&
          channel_visibility == o.channel_visibility
    end
    ...
    def hash
      [binding, channel_visibility].hash
    end
