...
module IncidentIoSdk
  class AlertRouteEscalationConfigPayloadV2
    ...
    attr_accessor :auto_cancel_escalations

    # Targets for escalation
    attr_accessor :escalation_targets
    ...
    def self.openapi_types
      {
        ...
        :'escalation_targets' => :'Array<AlertRouteEscalationTargetPayloadV2>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::AlertRouteEscalationConfigPayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::AlertRouteEscalationConfigPayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'auto_cancel_escalations')
        self.auto_cancel_escalations = attributes[:'auto_cancel_escalations']
      else
        self.auto_cancel_escalations = nil
      end

      if attributes.key?(:'escalation_targets')
        if (value = attributes[:'escalation_targets']).is_a?(Array)
          self.escalation_targets = value
        end
      else
        self.escalation_targets = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @auto_cancel_escalations.nil?
        invalid_properties.push('invalid value for "auto_cancel_escalations", auto_cancel_escalations cannot be nil.')
      end

      if @escalation_targets.nil?
        invalid_properties.push('invalid value for "escalation_targets", escalation_targets cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @auto_cancel_escalations.nil?
      return false if @escalation_targets.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] auto_cancel_escalations Value to be assigned
    def auto_cancel_escalations=(auto_cancel_escalations)
      if auto_cancel_escalations.nil?
        fail ArgumentError, 'auto_cancel_escalations cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] escalation_targets Value to be assigned
    def escalation_targets=(escalation_targets)
      if escalation_targets.nil?
        fail ArgumentError, 'escalation_targets cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          auto_cancel_escalations == o.auto_cancel_escalations &&
          escalation_targets == o.escalation_targets
    end
    ...
    def hash
      [auto_cancel_escalations, escalation_targets].hash
    end
