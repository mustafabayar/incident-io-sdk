...
module IncidentIoSdk
  class AlertRouteIncidentConfigPayloadV2
    ...
    attr_accessor :auto_decline_enabled
    ...
    attr_accessor :defer_time_seconds
    ...
    attr_accessor :grouping_window_seconds
    ...
    def self.openapi_types
      {
        ...
        :'defer_time_seconds' => :'Integer',
        :'enabled' => :'Boolean',
        :'grouping_keys' => :'Array<GroupingKeyV2>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::AlertRouteIncidentConfigPayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::AlertRouteIncidentConfigPayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'auto_decline_enabled')
        self.auto_decline_enabled = attributes[:'auto_decline_enabled']
      else
        self.auto_decline_enabled = nil
      end
      ...
      if attributes.key?(:'defer_time_seconds')
        self.defer_time_seconds = attributes[:'defer_time_seconds']
      else
        self.defer_time_seconds = nil
      end
      ...
      if attributes.key?(:'grouping_keys')
        if (value = attributes[:'grouping_keys']).is_a?(Array)
          self.grouping_keys = value
        end
      else
        self.grouping_keys = nil
      end

      if attributes.key?(:'grouping_window_seconds')
        self.grouping_window_seconds = attributes[:'grouping_window_seconds']
      else
        self.grouping_window_seconds = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @auto_decline_enabled.nil?
        invalid_properties.push('invalid value for "auto_decline_enabled", auto_decline_enabled cannot be nil.')
      end
      ...
      if @defer_time_seconds.nil?
        invalid_properties.push('invalid value for "defer_time_seconds", defer_time_seconds cannot be nil.')
      end
      ...
      if @grouping_keys.nil?
        invalid_properties.push('invalid value for "grouping_keys", grouping_keys cannot be nil.')
      end

      if @grouping_window_seconds.nil?
        invalid_properties.push('invalid value for "grouping_window_seconds", grouping_window_seconds cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @auto_decline_enabled.nil?
      return false if @condition_groups.nil?
      return false if @defer_time_seconds.nil?
      return false if @enabled.nil?
      return false if @grouping_keys.nil?
      return false if @grouping_window_seconds.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] auto_decline_enabled Value to be assigned
    def auto_decline_enabled=(auto_decline_enabled)
      if auto_decline_enabled.nil?
        fail ArgumentError, 'auto_decline_enabled cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] defer_time_seconds Value to be assigned
    def defer_time_seconds=(defer_time_seconds)
      if defer_time_seconds.nil?
        fail ArgumentError, 'defer_time_seconds cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] grouping_keys Value to be assigned
    def grouping_keys=(grouping_keys)
      if grouping_keys.nil?
        fail ArgumentError, 'grouping_keys cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] grouping_window_seconds Value to be assigned
    def grouping_window_seconds=(grouping_window_seconds)
      if grouping_window_seconds.nil?
        fail ArgumentError, 'grouping_window_seconds cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          auto_decline_enabled == o.auto_decline_enabled &&
          condition_groups == o.condition_groups &&
          defer_time_seconds == o.defer_time_seconds &&
          enabled == o.enabled &&
          grouping_keys == o.grouping_keys &&
          grouping_window_seconds == o.grouping_window_seconds
    end
    ...
    def hash
      [auto_decline_enabled, condition_groups, defer_time_seconds, enabled, grouping_keys, grouping_window_seconds].hash
    end
