...
module IncidentIoSdk
  class AlertRouteIncidentTemplateV2
    ...
    def self.openapi_types
      {
        :'custom_fields' => :'Array<AlertRouteCustomFieldBindingV2>',
        :'incident_mode' => :'AlertRouteTemplateBindingV2',
        :'incident_type' => :'AlertRouteTemplateBindingV2',
        :'name' => :'AlertRouteAutoGeneratedTemplateBindingV2',
        :'severity' => :'AlertRouteSeverityBindingV2',
        :'start_in_triage' => :'AlertRouteTemplateBindingV2',
        :'summary' => :'AlertRouteAutoGeneratedTemplateBindingV2',
        :'workspace' => :'AlertRouteTemplateBindingV2'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::AlertRouteIncidentTemplateV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::AlertRouteIncidentTemplateV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'incident_mode')
        self.incident_mode = attributes[:'incident_mode']
      end
      ...
      if attributes.key?(:'start_in_triage')
        self.start_in_triage = attributes[:'start_in_triage']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          incident_mode == o.incident_mode &&
          incident_type == o.incident_type &&
          name == o.name &&
          severity == o.severity &&
          start_in_triage == o.start_in_triage &&
          summary == o.summary &&
    ...
    def hash
      [custom_fields, incident_mode, incident_type, name, severity, start_in_triage, summary, workspace].hash
    end
