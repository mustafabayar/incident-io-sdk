...
module IncidentIoSdk
  class AlertTemplateAttributePayloadV2
    ...
    attr_accessor :alert_attribute_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::AlertTemplateAttributePayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::AlertTemplateAttributePayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'alert_attribute_id')
        self.alert_attribute_id = attributes[:'alert_attribute_id']
      else
        self.alert_attribute_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @alert_attribute_id.nil?
        invalid_properties.push('invalid value for "alert_attribute_id", alert_attribute_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @alert_attribute_id.nil?
      return false if @binding.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] alert_attribute_id Value to be assigned
    def alert_attribute_id=(alert_attribute_id)
      if alert_attribute_id.nil?
        fail ArgumentError, 'alert_attribute_id cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          alert_attribute_id == o.alert_attribute_id &&
          binding == o.binding
    end
    ...
    def hash
      [alert_attribute_id, binding].hash
    end
