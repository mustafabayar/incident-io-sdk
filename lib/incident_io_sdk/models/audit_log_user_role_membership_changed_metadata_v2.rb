  ...
  class AuditLogUserRoleMembershipChangedMetadataV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::AuditLogUserRoleMembershipChangedMetadataV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::AuditLogUserRoleMembershipChangedMetadataV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'after_base_role_slug')
        self.after_base_role_slug = attributes[:'after_base_role_slug']
      else
        self.after_base_role_slug = nil
      end

      if attributes.key?(:'after_custom_role_slugs')
        self.after_custom_role_slugs = attributes[:'after_custom_role_slugs']
      else
        self.after_custom_role_slugs = nil
      end

      if attributes.key?(:'before_base_role_slug')
        self.before_base_role_slug = attributes[:'before_base_role_slug']
      else
        self.before_base_role_slug = nil
      end

      if attributes.key?(:'before_custom_role_slugs')
        self.before_custom_role_slugs = attributes[:'before_custom_role_slugs']
      else
        self.before_custom_role_slugs = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @after_base_role_slug.nil?
        invalid_properties.push('invalid value for "after_base_role_slug", after_base_role_slug cannot be nil.')
      end

      if @after_custom_role_slugs.nil?
        invalid_properties.push('invalid value for "after_custom_role_slugs", after_custom_role_slugs cannot be nil.')
      end

      if @before_base_role_slug.nil?
        invalid_properties.push('invalid value for "before_base_role_slug", before_base_role_slug cannot be nil.')
      end

      if @before_custom_role_slugs.nil?
        invalid_properties.push('invalid value for "before_custom_role_slugs", before_custom_role_slugs cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @after_base_role_slug.nil?
      return false if @after_custom_role_slugs.nil?
      return false if @before_base_role_slug.nil?
      return false if @before_custom_role_slugs.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] after_base_role_slug Value to be assigned
    def after_base_role_slug=(after_base_role_slug)
      if after_base_role_slug.nil?
        fail ArgumentError, 'after_base_role_slug cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] after_custom_role_slugs Value to be assigned
    def after_custom_role_slugs=(after_custom_role_slugs)
      if after_custom_role_slugs.nil?
        fail ArgumentError, 'after_custom_role_slugs cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] before_base_role_slug Value to be assigned
    def before_base_role_slug=(before_base_role_slug)
      if before_base_role_slug.nil?
        fail ArgumentError, 'before_base_role_slug cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] before_custom_role_slugs Value to be assigned
    def before_custom_role_slugs=(before_custom_role_slugs)
      if before_custom_role_slugs.nil?
        fail ArgumentError, 'before_custom_role_slugs cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          after_base_role_slug == o.after_base_role_slug &&
          after_custom_role_slugs == o.after_custom_role_slugs &&
          before_base_role_slug == o.before_base_role_slug &&
          before_custom_role_slugs == o.before_custom_role_slugs
    end
    ...
    def hash
      [after_base_role_slug, after_custom_role_slugs, before_base_role_slug, before_custom_role_slugs].hash
    end
