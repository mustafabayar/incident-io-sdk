...
module IncidentIoSdk
  class CatalogEntryEngineParamBindingValueV2
    ...
    # This field is deprecated. It will not be present in any responses, and will be removed in a future version
    attr_accessor :is_image_slack_icon
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::CatalogEntryEngineParamBindingValueV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::CatalogEntryEngineParamBindingValueV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'catalog_entry')
        self.catalog_entry = attributes[:'catalog_entry']
      end
      ...
      if attributes.key?(:'is_image_slack_icon')
        self.is_image_slack_icon = attributes[:'is_image_slack_icon']
      end
      ...
      if attributes.key?(:'literal')
        self.literal = attributes[:'literal']
      end
    ...
    def sort_key=(sort_key)
      if sort_key.nil?
        fail ArgumentError, 'sort_key cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          catalog_entry == o.catalog_entry &&
          helptext == o.helptext &&
          image_url == o.image_url &&
          is_image_slack_icon == o.is_image_slack_icon &&
          label == o.label &&
          literal == o.literal &&
    ...
    def hash
      [catalog_entry, helptext, image_url, is_image_slack_icon, label, literal, reference, sort_key, unavailable, value].hash
    end
