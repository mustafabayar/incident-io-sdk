...
module IncidentIoSdk
  class CatalogEntryReferenceV2
    ...
    attr_accessor :catalog_entry_id

    # The name of this entry
    attr_accessor :catalog_entry_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::CatalogEntryReferenceV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::CatalogEntryReferenceV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'catalog_entry_id')
        self.catalog_entry_id = attributes[:'catalog_entry_id']
      else
        self.catalog_entry_id = nil
      end

      if attributes.key?(:'catalog_entry_name')
        self.catalog_entry_name = attributes[:'catalog_entry_name']
      else
        self.catalog_entry_name = nil
      end

      if attributes.key?(:'catalog_type_id')
        self.catalog_type_id = attributes[:'catalog_type_id']
      else
        self.catalog_type_id = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @catalog_entry_id.nil?
        invalid_properties.push('invalid value for "catalog_entry_id", catalog_entry_id cannot be nil.')
      end

      if @catalog_entry_name.nil?
        invalid_properties.push('invalid value for "catalog_entry_name", catalog_entry_name cannot be nil.')
      end

      if @catalog_type_id.nil?
        invalid_properties.push('invalid value for "catalog_type_id", catalog_type_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @catalog_entry_id.nil?
      return false if @catalog_entry_name.nil?
      return false if @catalog_type_id.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] catalog_entry_id Value to be assigned
    def catalog_entry_id=(catalog_entry_id)
      if catalog_entry_id.nil?
        fail ArgumentError, 'catalog_entry_id cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] catalog_entry_name Value to be assigned
    def catalog_entry_name=(catalog_entry_name)
      if catalog_entry_name.nil?
        fail ArgumentError, 'catalog_entry_name cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] catalog_type_id Value to be assigned
    def catalog_type_id=(catalog_type_id)
      if catalog_type_id.nil?
        fail ArgumentError, 'catalog_type_id cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          catalog_entry_id == o.catalog_entry_id &&
          catalog_entry_name == o.catalog_entry_name &&
    ...
    def hash
      [archived_at, catalog_entry_id, catalog_entry_name, catalog_type_id].hash
    end
