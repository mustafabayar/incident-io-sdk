  ...
  class CatalogResourceV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::CatalogResourceV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::CatalogResourceV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'value_docstring')
        self.value_docstring = attributes[:'value_docstring']
      else
        self.value_docstring = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @value_docstring.nil?
        invalid_properties.push('invalid value for "value_docstring", value_docstring cannot be nil.')
      end
    ...
    def valid?
      ...
      category_validator = EnumAttributeValidator.new('String', ["primitive", "custom", "external"])
      return false unless category_validator.valid?(@category)
      return false if @description.nil?
      return false if @label.nil?
      return false if @type.nil?
      return false if @value_docstring.nil?
      true
    end
    ...
    def category=(category)
      validator = EnumAttributeValidator.new('String', ["primitive", "custom", "external"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] value_docstring Value to be assigned
    def value_docstring=(value_docstring)
      if value_docstring.nil?
        fail ArgumentError, 'value_docstring cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          label == o.label &&
          type == o.type &&
          value_docstring == o.value_docstring
    end
    ...
    def hash
      [category, description, label, type, value_docstring].hash
    end
