...
module IncidentIoSdk
  class CatalogTypeAttributePayloadV3
    ...
    attr_accessor :backlink_attribute
    ...
    def self.openapi_types
      {
        ...
        :'mode' => :'String',
        :'name' => :'String',
        :'path' => :'Array<CatalogTypeAttributePathItemPayloadV3>',
        :'type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::CatalogTypeAttributePayloadV3` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::CatalogTypeAttributePayloadV3`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'backlink_attribute')
        self.backlink_attribute = attributes[:'backlink_attribute']
      end
    ...
    def list_invalid_properties
      ...
      if @array.nil?
        invalid_properties.push('invalid value for "array", array cannot be nil.')
      end
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('String', ["", "api", "dashboard", "external", "internal", "dynamic", "backlink", "path"])
    ...
    # @param [Object] array Value to be assigned
    def array=(array)
      if array.nil?
        fail ArgumentError, 'array cannot be nil'
      end
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('String', ["", "api", "dashboard", "external", "internal", "dynamic", "backlink", "path"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          array == o.array &&
          backlink_attribute == o.backlink_attribute &&
          id == o.id &&
          mode == o.mode &&
          name == o.name &&
          path == o.path &&
    ...
    def hash
      [array, backlink_attribute, id, mode, name, path, type].hash
    end
