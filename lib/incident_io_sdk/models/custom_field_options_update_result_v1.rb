...
module IncidentIoSdk
  class CustomFieldOptionsUpdateResultV1
    attr_accessor :custom_field_option
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::CustomFieldOptionsUpdateResultV1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::CustomFieldOptionsUpdateResultV1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'custom_field_option')
        self.custom_field_option = attributes[:'custom_field_option']
      else
        self.custom_field_option = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @custom_field_option.nil?
        invalid_properties.push('invalid value for "custom_field_option", custom_field_option cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @custom_field_option.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] custom_field_option Value to be assigned
    def custom_field_option=(custom_field_option)
      if custom_field_option.nil?
        fail ArgumentError, 'custom_field_option cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          custom_field_option == o.custom_field_option
    end
