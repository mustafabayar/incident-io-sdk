  ...
  class CustomFieldV1
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::CustomFieldV1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::CustomFieldV1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'catalog_type_id')
        self.catalog_type_id = attributes[:'catalog_type_id']
      end
      ...
      if attributes.key?(:'required_v2')
        self.required_v2 = attributes[:'required_v2']
      end

      if attributes.key?(:'show_before_closure')
        self.show_before_closure = attributes[:'show_before_closure']
      else
        self.show_before_closure = nil
      end

      if attributes.key?(:'show_before_creation')
        self.show_before_creation = attributes[:'show_before_creation']
      else
        self.show_before_creation = nil
      end

      if attributes.key?(:'show_before_update')
        self.show_before_update = attributes[:'show_before_update']
      else
        self.show_before_update = nil
      end

      if attributes.key?(:'show_in_announcement_post')
        self.show_in_announcement_post = attributes[:'show_in_announcement_post']
      end
    ...
    def list_invalid_properties
      ...
      if @show_before_closure.nil?
        invalid_properties.push('invalid value for "show_before_closure", show_before_closure cannot be nil.')
      end

      if @show_before_creation.nil?
        invalid_properties.push('invalid value for "show_before_creation", show_before_creation cannot be nil.')
      end

      if @show_before_update.nil?
        invalid_properties.push('invalid value for "show_before_update", show_before_update cannot be nil.')
      end
    ...
    def valid?
      ...
      field_type_validator = EnumAttributeValidator.new('String', ["single_select", "multi_select", "text", "link", "numeric"])
      return false unless field_type_validator.valid?(@field_type)
      return false if @id.nil?
      return false if @name.nil?
      return false if @name.to_s.length > 50
      return false if @options.nil?
      required_validator = EnumAttributeValidator.new('String', ["never", "before_closure", "always"])
      return false unless required_validator.valid?(@required)
      required_v2_validator = EnumAttributeValidator.new('String', ["never", "before_resolution", "always"])
      return false unless required_v2_validator.valid?(@required_v2)
      return false if @show_before_closure.nil?
      return false if @show_before_creation.nil?
      return false if @show_before_update.nil?
    ...
    def field_type=(field_type)
      validator = EnumAttributeValidator.new('String', ["single_select", "multi_select", "text", "link", "numeric"])
    ...
    def required=(required)
      validator = EnumAttributeValidator.new('String', ["never", "before_closure", "always"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] required_v2 Object to be assigned
    def required_v2=(required_v2)
      validator = EnumAttributeValidator.new('String', ["never", "before_resolution", "always"])
      unless validator.valid?(required_v2)
        fail ArgumentError, "invalid value for \"required_v2\", must be one of #{validator.allowable_values}."
      end
      @required_v2 = required_v2
    end

    # Custom attribute writer method with validation
    # @param [Object] show_before_closure Value to be assigned
    def show_before_closure=(show_before_closure)
      if show_before_closure.nil?
        fail ArgumentError, 'show_before_closure cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] show_before_creation Value to be assigned
    def show_before_creation=(show_before_creation)
      if show_before_creation.nil?
        fail ArgumentError, 'show_before_creation cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] show_before_update Value to be assigned
    def show_before_update=(show_before_update)
      if show_before_update.nil?
        fail ArgumentError, 'show_before_update cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          catalog_type_id == o.catalog_type_id &&
          ...
          options == o.options &&
          required == o.required &&
          required_v2 == o.required_v2 &&
          show_before_closure == o.show_before_closure &&
          show_before_creation == o.show_before_creation &&
          show_before_update == o.show_before_update &&
          show_in_announcement_post == o.show_in_announcement_post &&
    ...
    def hash
      [catalog_type_id, created_at, description, field_type, id, name, options, required, required_v2, show_before_closure, show_before_creation, show_before_update, show_in_announcement_post, updated_at].hash
    end
