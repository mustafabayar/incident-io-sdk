  ...
  class CustomFieldValuePayloadV1
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::CustomFieldValuePayloadV1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::CustomFieldValuePayloadV1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'value_catalog_entry_id')
        self.value_catalog_entry_id = attributes[:'value_catalog_entry_id']
      end

      if attributes.key?(:'value_link')
        self.value_link = attributes[:'value_link']
      end

      if attributes.key?(:'value_numeric')
        self.value_numeric = attributes[:'value_numeric']
      end

      if attributes.key?(:'value_option_id')
        self.value_option_id = attributes[:'value_option_id']
      end
      ...
      if attributes.key?(:'value_timestamp')
        self.value_timestamp = attributes[:'value_timestamp']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          value_catalog_entry_id == o.value_catalog_entry_id &&
          value_link == o.value_link &&
          value_numeric == o.value_numeric &&
          value_option_id == o.value_option_id &&
          value_text == o.value_text &&
          value_timestamp == o.value_timestamp
    end
    ...
    def hash
      [id, value_catalog_entry_id, value_link, value_numeric, value_option_id, value_text, value_timestamp].hash
    end
