...
module IncidentIoSdk
  class CustomFieldsCreatePayloadV2
    ...
    attr_accessor :group_by_catalog_attribute_id

    # Which catalog attribute provides helptext for the options
    attr_accessor :helptext_catalog_attribute_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::CustomFieldsCreatePayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::CustomFieldsCreatePayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'filter_by')
        self.filter_by = attributes[:'filter_by']
      end

      if attributes.key?(:'group_by_catalog_attribute_id')
        self.group_by_catalog_attribute_id = attributes[:'group_by_catalog_attribute_id']
      end

      if attributes.key?(:'helptext_catalog_attribute_id')
        self.helptext_catalog_attribute_id = attributes[:'helptext_catalog_attribute_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          group_by_catalog_attribute_id == o.group_by_catalog_attribute_id &&
          helptext_catalog_attribute_id == o.helptext_catalog_attribute_id &&
          name == o.name
    end
    ...
    def hash
      [catalog_type_id, description, field_type, filter_by, group_by_catalog_attribute_id, helptext_catalog_attribute_id, name].hash
    end
