...
module IncidentIoSdk
  class EscalationPathNodeIfElsePayloadV2
    ...
    def self.openapi_types
      {
        :'conditions' => :'Array<ConditionPayloadV2>',
        :'else_path' => :'Array<EscalationPathNodePayloadV2>',
        :'then_path' => :'Array<EscalationPathNodePayloadV2>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::EscalationPathNodeIfElsePayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::EscalationPathNodeIfElsePayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'else_path')
        if (value = attributes[:'else_path']).is_a?(Array)
          self.else_path = value
        end
      else
        self.else_path = nil
      end

      if attributes.key?(:'then_path')
        if (value = attributes[:'then_path']).is_a?(Array)
          self.then_path = value
        end
      else
        self.then_path = nil
      end
    ...
    def list_invalid_properties
      ...
      if @else_path.nil?
        invalid_properties.push('invalid value for "else_path", else_path cannot be nil.')
      end

      if @then_path.nil?
        invalid_properties.push('invalid value for "then_path", then_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @else_path.nil?
      return false if @then_path.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] else_path Value to be assigned
    def else_path=(else_path)
      if else_path.nil?
        fail ArgumentError, 'else_path cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] then_path Value to be assigned
    def then_path=(then_path)
      if then_path.nil?
        fail ArgumentError, 'then_path cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          else_path == o.else_path &&
          then_path == o.then_path
    end
    ...
    def hash
      [conditions, else_path, then_path].hash
    end
