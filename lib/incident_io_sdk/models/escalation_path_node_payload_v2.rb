  ...
  class EscalationPathNodePayloadV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::EscalationPathNodePayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::EscalationPathNodePayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'if_else')
        self.if_else = attributes[:'if_else']
      end
      ...
      if attributes.key?(:'notify_channel')
        self.notify_channel = attributes[:'notify_channel']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["if_else", "repeat", "level", "notify_channel"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["if_else", "repeat", "level", "notify_channel"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          if_else == o.if_else &&
          level == o.level &&
          notify_channel == o.notify_channel &&
          repeat == o.repeat &&
          type == o.type
    end
    ...
    def hash
      [id, if_else, level, notify_channel, repeat, type].hash
    end
