  ...
  class EscalationsCreatePathResultV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::EscalationsCreatePathResultV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::EscalationsCreatePathResultV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'escalation_path')
        self.escalation_path = attributes[:'escalation_path']
      else
        self.escalation_path = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @escalation_path.nil?
        invalid_properties.push('invalid value for "escalation_path", escalation_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @escalation_path.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] escalation_path Value to be assigned
    def escalation_path=(escalation_path)
      if escalation_path.nil?
        fail ArgumentError, 'escalation_path cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          escalation_path == o.escalation_path
    end
