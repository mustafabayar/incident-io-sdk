  ...
  class ExpressionPayloadV2
    ...
    def self.openapi_types
      {
        ...
        :'label' => :'String',
        :'operations' => :'Array<ExpressionOperationPayloadV2>',
        :'reference' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::ExpressionPayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::ExpressionPayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'else_branch')
        self.else_branch = attributes[:'else_branch']
      end
      ...
      if attributes.key?(:'root_reference')
        self.root_reference = attributes[:'root_reference']
      else
        self.root_reference = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @root_reference.nil?
        invalid_properties.push('invalid value for "root_reference", root_reference cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @root_reference.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] root_reference Value to be assigned
    def root_reference=(root_reference)
      if root_reference.nil?
        fail ArgumentError, 'root_reference cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          else_branch == o.else_branch &&
          label == o.label &&
          operations == o.operations &&
          reference == o.reference &&
          root_reference == o.root_reference
    end
    ...
    def hash
      [else_branch, label, operations, reference, root_reference].hash
    end
