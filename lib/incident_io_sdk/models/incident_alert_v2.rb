  ...
  class IncidentAlertV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::IncidentAlertV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::IncidentAlertV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'alert_route_id')
        self.alert_route_id = attributes[:'alert_route_id']
      end
    ...
    # @param [Object] alert Value to be assigned
    def alert=(alert)
      if alert.nil?
        fail ArgumentError, 'alert cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          alert == o.alert &&
          alert_route_id == o.alert_route_id &&
          id == o.id &&
          incident == o.incident
    end
    ...
    def hash
      [alert, alert_route_id, id, incident].hash
    end
