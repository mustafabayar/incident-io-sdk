...
module IncidentIoSdk
  class IncidentRoleAssignmentPayloadV1
    ...
    attr_accessor :incident_role_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::IncidentRoleAssignmentPayloadV1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::IncidentRoleAssignmentPayloadV1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'incident_role_id')
        self.incident_role_id = attributes[:'incident_role_id']
      else
        self.incident_role_id = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @incident_role_id.nil?
        invalid_properties.push('invalid value for "incident_role_id", incident_role_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @incident_role_id.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] assignee Value to be assigned
    def assignee=(assignee)
      if assignee.nil?
        fail ArgumentError, 'assignee cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] incident_role_id Value to be assigned
    def incident_role_id=(incident_role_id)
      if incident_role_id.nil?
        fail ArgumentError, 'incident_role_id cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          assignee == o.assignee &&
          incident_role_id == o.incident_role_id
    end
    ...
    def hash
      [assignee, incident_role_id].hash
    end
