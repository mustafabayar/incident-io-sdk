...
module IncidentIoSdk
  class IncidentTypeV1
    ...
    attr_accessor :create_in_triage
    ...
    attr_accessor :private_incidents_only
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::IncidentTypeV1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::IncidentTypeV1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'create_in_triage')
        self.create_in_triage = attributes[:'create_in_triage']
      else
        self.create_in_triage = nil
      end
      ...
      if attributes.key?(:'private_incidents_only')
        self.private_incidents_only = attributes[:'private_incidents_only']
      else
        self.private_incidents_only = nil
      end
    ...
    def list_invalid_properties
      ...
      if @create_in_triage.nil?
        invalid_properties.push('invalid value for "create_in_triage", create_in_triage cannot be nil.')
      end
      ...
      if @private_incidents_only.nil?
        invalid_properties.push('invalid value for "private_incidents_only", private_incidents_only cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @create_in_triage.nil?
      create_in_triage_validator = EnumAttributeValidator.new('String', ["always", "optional"])
      return false unless create_in_triage_validator.valid?(@create_in_triage)
      return false if @created_at.nil?
      return false if @description.nil?
      return false if @id.nil?
      return false if @is_default.nil?
      return false if @name.nil?
      return false if @private_incidents_only.nil?
      return false if @updated_at.nil?
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] create_in_triage Object to be assigned
    def create_in_triage=(create_in_triage)
      validator = EnumAttributeValidator.new('String', ["always", "optional"])
      unless validator.valid?(create_in_triage)
        fail ArgumentError, "invalid value for \"create_in_triage\", must be one of #{validator.allowable_values}."
      end
      @create_in_triage = create_in_triage
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] private_incidents_only Value to be assigned
    def private_incidents_only=(private_incidents_only)
      if private_incidents_only.nil?
        fail ArgumentError, 'private_incidents_only cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          create_in_triage == o.create_in_triage &&
          created_at == o.created_at &&
          description == o.description &&
          id == o.id &&
          is_default == o.is_default &&
          name == o.name &&
          private_incidents_only == o.private_incidents_only &&
    ...
    def hash
      [create_in_triage, created_at, description, id, is_default, name, private_incidents_only, updated_at].hash
    end
