...
module IncidentIoSdk
  class IncidentUpdateV2
    ...
    attr_accessor :merged_into_incident_id

    # Message that explains the context behind the update
    attr_accessor :message

    attr_accessor :new_incident_status

    attr_accessor :new_severity
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::IncidentUpdateV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::IncidentUpdateV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'merged_into_incident_id')
        self.merged_into_incident_id = attributes[:'merged_into_incident_id']
      end
      ...
      if attributes.key?(:'new_incident_status')
        self.new_incident_status = attributes[:'new_incident_status']
      else
        self.new_incident_status = nil
      end

      if attributes.key?(:'new_severity')
        self.new_severity = attributes[:'new_severity']
      end
    ...
    def list_invalid_properties
      ...
      if @new_incident_status.nil?
        invalid_properties.push('invalid value for "new_incident_status", new_incident_status cannot be nil.')
      end

      if @updater.nil?
        invalid_properties.push('invalid value for "updater", updater cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @new_incident_status.nil?
      return false if @updater.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] new_incident_status Value to be assigned
    def new_incident_status=(new_incident_status)
      if new_incident_status.nil?
        fail ArgumentError, 'new_incident_status cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] updater Value to be assigned
    def updater=(updater)
      if updater.nil?
        fail ArgumentError, 'updater cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          merged_into_incident_id == o.merged_into_incident_id &&
          message == o.message &&
          new_incident_status == o.new_incident_status &&
          new_severity == o.new_severity &&
          updater == o.updater
    end
    ...
    def hash
      [created_at, id, incident_id, merged_into_incident_id, message, new_incident_status, new_severity, updater].hash
    end
