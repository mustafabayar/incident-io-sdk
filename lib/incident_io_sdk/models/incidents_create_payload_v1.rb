...
module IncidentIoSdk
  class IncidentsCreatePayloadV1
    ...
    attr_accessor :incident_type_id
    ...
    attr_accessor :source_message_channel_id

    # Timestamp of the source message, if this incident was created from one
    attr_accessor :source_message_timestamp
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::IncidentsCreatePayloadV1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::IncidentsCreatePayloadV1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'incident_type_id')
        self.incident_type_id = attributes[:'incident_type_id']
      end
      ...
      if attributes.key?(:'severity_id')
        self.severity_id = attributes[:'severity_id']
      end
      ...
      if attributes.key?(:'source_message_channel_id')
        self.source_message_channel_id = attributes[:'source_message_channel_id']
      end

      if attributes.key?(:'source_message_timestamp')
        self.source_message_timestamp = attributes[:'source_message_timestamp']
      end
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('String', ["real", "test"])
      return false unless mode_validator.valid?(@mode)
      status_validator = EnumAttributeValidator.new('String', ["triage", "investigating", "fixing", "monitoring", "closed", "declined"])
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('String', ["real", "test"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["triage", "investigating", "fixing", "monitoring", "closed", "declined"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mode == o.mode &&
          name == o.name &&
          severity_id == o.severity_id &&
          slack_team_id == o.slack_team_id &&
          source_message_channel_id == o.source_message_channel_id &&
          source_message_timestamp == o.source_message_timestamp &&
          status == o.status &&
          summary == o.summary &&
    ...
    def hash
      [custom_field_entries, idempotency_key, incident_role_assignments, incident_type_id, mode, name, severity_id, slack_team_id, source_message_channel_id, source_message_timestamp, status, summary, visibility].hash
    end
