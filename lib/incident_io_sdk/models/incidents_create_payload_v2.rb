...
module IncidentIoSdk
  class IncidentsCreatePayloadV2
    ...
    attr_accessor :incident_status_id
    ...
    def self.openapi_types
      {
        :'custom_field_entries' => :'Array<CustomFieldEntryPayloadV2>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::IncidentsCreatePayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::IncidentsCreatePayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'incident_status_id')
        self.incident_status_id = attributes[:'incident_status_id']
      end
      ...
      if attributes.key?(:'retrospective_incident_options')
        self.retrospective_incident_options = attributes[:'retrospective_incident_options']
      end
      ...
      if attributes.key?(:'slack_channel_name_override')
        self.slack_channel_name_override = attributes[:'slack_channel_name_override']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          incident_status_id == o.incident_status_id &&
          incident_timestamp_values == o.incident_timestamp_values &&
          incident_type_id == o.incident_type_id &&
          mode == o.mode &&
          name == o.name &&
          retrospective_incident_options == o.retrospective_incident_options &&
          severity_id == o.severity_id &&
          slack_channel_name_override == o.slack_channel_name_override &&
    ...
    def hash
      [custom_field_entries, idempotency_key, incident_role_assignments, incident_status_id, incident_timestamp_values, incident_type_id, mode, name, retrospective_incident_options, severity_id, slack_channel_name_override, slack_team_id, summary, visibility].hash
    end
