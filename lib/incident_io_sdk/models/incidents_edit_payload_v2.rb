...
module IncidentIoSdk
  class IncidentsEditPayloadV2
    ...
    attr_accessor :notify_incident_channel
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::IncidentsEditPayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::IncidentsEditPayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'notify_incident_channel')
        self.notify_incident_channel = attributes[:'notify_incident_channel']
      else
        self.notify_incident_channel = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @incident.nil?
        invalid_properties.push('invalid value for "incident", incident cannot be nil.')
      end

      if @notify_incident_channel.nil?
        invalid_properties.push('invalid value for "notify_incident_channel", notify_incident_channel cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @notify_incident_channel.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] incident Value to be assigned
    def incident=(incident)
      if incident.nil?
        fail ArgumentError, 'incident cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] notify_incident_channel Value to be assigned
    def notify_incident_channel=(notify_incident_channel)
      if notify_incident_channel.nil?
        fail ArgumentError, 'notify_incident_channel cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          incident == o.incident &&
          notify_incident_channel == o.notify_incident_channel
    end
    ...
    def hash
      [incident, notify_incident_channel].hash
    end
