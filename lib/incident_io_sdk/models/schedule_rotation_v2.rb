  ...
  class ScheduleRotationV2
    ...
    def self.openapi_types
      {
        ...
        :'handovers' => :'Array<ScheduleRotationHandoverV2>',
        :'id' => :'String',
        :'layers' => :'Array<ScheduleLayerV2>',
        :'name' => :'String',
        :'users' => :'Array<UserV2>',
        :'working_interval' => :'Array<ScheduleRotationWorkingIntervalV2>',
        :'working_intervals' => :'Array<ScheduleRotationWorkingIntervalV2>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::ScheduleRotationV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::ScheduleRotationV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'handover_start_at')
        self.handover_start_at = attributes[:'handover_start_at']
      else
        self.handover_start_at = nil
      end

      if attributes.key?(:'handovers')
        if (value = attributes[:'handovers']).is_a?(Array)
          self.handovers = value
        end
      else
        self.handovers = nil
      end
      ...
      if attributes.key?(:'working_interval')
        if (value = attributes[:'working_interval']).is_a?(Array)
          self.working_interval = value
        end
      end

      if attributes.key?(:'working_intervals')
        if (value = attributes[:'working_intervals']).is_a?(Array)
          self.working_intervals = value
        end
      else
        self.working_intervals = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @handover_start_at.nil?
        invalid_properties.push('invalid value for "handover_start_at", handover_start_at cannot be nil.')
      end

      if @handovers.nil?
        invalid_properties.push('invalid value for "handovers", handovers cannot be nil.')
      end
      ...
      if @working_intervals.nil?
        invalid_properties.push('invalid value for "working_intervals", working_intervals cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @handover_start_at.nil?
      return false if @handovers.nil?
      return false if @id.nil?
      return false if @layers.nil?
      return false if @name.nil?
      return false if @users.nil?
      return false if @working_intervals.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] handover_start_at Value to be assigned
    def handover_start_at=(handover_start_at)
      if handover_start_at.nil?
        fail ArgumentError, 'handover_start_at cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] handovers Value to be assigned
    def handovers=(handovers)
      if handovers.nil?
        fail ArgumentError, 'handovers cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] working_intervals Value to be assigned
    def working_intervals=(working_intervals)
      if working_intervals.nil?
        fail ArgumentError, 'working_intervals cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          handover_start_at == o.handover_start_at &&
          handovers == o.handovers &&
          id == o.id &&
          layers == o.layers &&
          name == o.name &&
          users == o.users &&
          working_interval == o.working_interval &&
          working_intervals == o.working_intervals
    end
    ...
    def hash
      [effective_from, handover_start_at, handovers, id, layers, name, users, working_interval, working_intervals].hash
    end
