...
module IncidentIoSdk
  class ScheduleV2
    ...
    attr_accessor :current_shifts

    attr_accessor :holidays_public_config
    ...
    def self.openapi_types
      {
        ...
        :'created_at' => :'Time',
        :'current_shifts' => :'Array<ScheduleEntryV2>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::ScheduleV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::ScheduleV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'current_shifts')
        if (value = attributes[:'current_shifts']).is_a?(Array)
          self.current_shifts = value
        end
      end

      if attributes.key?(:'holidays_public_config')
        self.holidays_public_config = attributes[:'holidays_public_config']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          current_shifts == o.current_shifts &&
          holidays_public_config == o.holidays_public_config &&
          id == o.id &&
          name == o.name &&
          team_ids == o.team_ids &&
          timezone == o.timezone &&
    ...
    def hash
      [annotations, config, created_at, current_shifts, holidays_public_config, id, name, team_ids, timezone, updated_at].hash
    end
