  ...
  class SchedulesCreateOverridePayloadV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::SchedulesCreateOverridePayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::SchedulesCreateOverridePayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rotation_id')
        self.rotation_id = attributes[:'rotation_id']
      else
        self.rotation_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @layer_id.nil?
        invalid_properties.push('invalid value for "layer_id", layer_id cannot be nil.')
      end

      if @rotation_id.nil?
        invalid_properties.push('invalid value for "rotation_id", rotation_id cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] layer_id Value to be assigned
    def layer_id=(layer_id)
      if layer_id.nil?
        fail ArgumentError, 'layer_id cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] rotation_id Value to be assigned
    def rotation_id=(rotation_id)
      if rotation_id.nil?
        fail ArgumentError, 'rotation_id cannot be nil'
      end
    ...
    def hash
      [end_at, layer_id, rotation_id, schedule_id, start_at, user].hash
    end
