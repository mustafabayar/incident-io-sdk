  ...
  class SchedulesListScheduleEntriesResultV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::SchedulesListScheduleEntriesResultV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::SchedulesListScheduleEntriesResultV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'schedule_entries')
        self.schedule_entries = attributes[:'schedule_entries']
      else
        self.schedule_entries = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @schedule_entries.nil?
        invalid_properties.push('invalid value for "schedule_entries", schedule_entries cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @schedule_entries.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] schedule_entries Value to be assigned
    def schedule_entries=(schedule_entries)
      if schedule_entries.nil?
        fail ArgumentError, 'schedule_entries cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          schedule_entries == o.schedule_entries
    end
    ...
    def hash
      [pagination_meta, schedule_entries].hash
    end
