  ...
  class StepConfigPayloadV2
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'String',
        :'name' => :'String',
        :'param_bindings' => :'Array<EngineParamBindingPayloadV2>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::StepConfigPayloadV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::StepConfigPayloadV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'param_bindings')
        if (value = attributes[:'param_bindings']).is_a?(Array)
          self.param_bindings = value
        end
      else
        self.param_bindings = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @param_bindings.nil?
        invalid_properties.push('invalid value for "param_bindings", param_bindings cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @param_bindings.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] param_bindings Value to be assigned
    def param_bindings=(param_bindings)
      if param_bindings.nil?
        fail ArgumentError, 'param_bindings cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          name == o.name &&
          param_bindings == o.param_bindings
    end
    ...
    def hash
      [for_each, id, name, param_bindings].hash
    end
