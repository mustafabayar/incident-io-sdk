...
module IncidentIoSdk
  class WebhookIncidentV2
    ...
    attr_accessor :most_recent_update_message
    ...
    attr_accessor :related_incidents
    ...
    def self.openapi_types
      {
        ...
        :'external_issue_reference' => :'ExternalIssueReferenceV6',
        :'has_debrief' => :'Boolean',
        :'id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::WebhookIncidentV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::WebhookIncidentV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'most_recent_update_message')
        self.most_recent_update_message = attributes[:'most_recent_update_message']
      end
      ...
      if attributes.key?(:'related_incidents')
        if (value = attributes[:'related_incidents']).is_a?(Array)
          self.related_incidents = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mode == o.mode &&
          most_recent_update_message == o.most_recent_update_message &&
          name == o.name &&
