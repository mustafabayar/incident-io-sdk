...
module IncidentIoSdk
  class WebhooksPrivateIncidentFollowUpUpdatedV1ResponseBody
    ...
    attr_accessor :private_incident_follow_up_updated_v1
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::WebhooksPrivateIncidentFollowUpUpdatedV1ResponseBody` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::WebhooksPrivateIncidentFollowUpUpdatedV1ResponseBody`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'private_incident_follow_up_updated_v1')
        self.private_incident_follow_up_updated_v1 = attributes[:'private_incident_follow_up_updated_v1']
      else
        self.private_incident_follow_up_updated_v1 = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @private_incident_follow_up_updated_v1.nil?
        invalid_properties.push('invalid value for "private_incident_follow_up_updated_v1", private_incident_follow_up_updated_v1 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @private_incident_follow_up_updated_v1.nil?
      true
    end
    ...
    # @param [Object] private_incident_follow_up_updated_v1 Value to be assigned
    def private_incident_follow_up_updated_v1=(private_incident_follow_up_updated_v1)
      if private_incident_follow_up_updated_v1.nil?
        fail ArgumentError, 'private_incident_follow_up_updated_v1 cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          private_incident_follow_up_updated_v1 == o.private_incident_follow_up_updated_v1
    end
    ...
    def hash
      [event_type, private_incident_follow_up_updated_v1].hash
    end
