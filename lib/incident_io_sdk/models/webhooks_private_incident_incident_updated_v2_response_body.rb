...
module IncidentIoSdk
  class WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody
    ...
    attr_accessor :private_incident_incident_updated_v2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'private_incident_incident_updated_v2')
        self.private_incident_incident_updated_v2 = attributes[:'private_incident_incident_updated_v2']
      else
        self.private_incident_incident_updated_v2 = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @private_incident_incident_updated_v2.nil?
        invalid_properties.push('invalid value for "private_incident_incident_updated_v2", private_incident_incident_updated_v2 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @private_incident_incident_updated_v2.nil?
      true
    end
    ...
    # @param [Object] private_incident_incident_updated_v2 Value to be assigned
    def private_incident_incident_updated_v2=(private_incident_incident_updated_v2)
      if private_incident_incident_updated_v2.nil?
        fail ArgumentError, 'private_incident_incident_updated_v2 cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          private_incident_incident_updated_v2 == o.private_incident_incident_updated_v2
    end
    ...
    def hash
      [event_type, private_incident_incident_updated_v2].hash
    end
