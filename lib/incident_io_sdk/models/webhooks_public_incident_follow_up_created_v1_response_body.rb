...
module IncidentIoSdk
  class WebhooksPublicIncidentFollowUpCreatedV1ResponseBody
    ...
    attr_accessor :public_incident_follow_up_created_v1
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::WebhooksPublicIncidentFollowUpCreatedV1ResponseBody` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::WebhooksPublicIncidentFollowUpCreatedV1ResponseBody`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'public_incident_follow_up_created_v1')
        self.public_incident_follow_up_created_v1 = attributes[:'public_incident_follow_up_created_v1']
      else
        self.public_incident_follow_up_created_v1 = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @public_incident_follow_up_created_v1.nil?
        invalid_properties.push('invalid value for "public_incident_follow_up_created_v1", public_incident_follow_up_created_v1 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @public_incident_follow_up_created_v1.nil?
      true
    end
    ...
    # @param [Object] public_incident_follow_up_created_v1 Value to be assigned
    def public_incident_follow_up_created_v1=(public_incident_follow_up_created_v1)
      if public_incident_follow_up_created_v1.nil?
        fail ArgumentError, 'public_incident_follow_up_created_v1 cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          public_incident_follow_up_created_v1 == o.public_incident_follow_up_created_v1
    end
    ...
    def hash
      [event_type, public_incident_follow_up_created_v1].hash
    end
