...
module IncidentIoSdk
  class WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody
    ...
    attr_accessor :public_incident_incident_status_updated_v2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'public_incident_incident_status_updated_v2')
        self.public_incident_incident_status_updated_v2 = attributes[:'public_incident_incident_status_updated_v2']
      else
        self.public_incident_incident_status_updated_v2 = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @public_incident_incident_status_updated_v2.nil?
        invalid_properties.push('invalid value for "public_incident_incident_status_updated_v2", public_incident_incident_status_updated_v2 cannot be nil.')
      end
    ...
    def event_type=(event_type)
      validator = EnumAttributeValidator.new('String', ["public_incident.incident_created_v2", "private_incident.incident_created_v2", "public_incident.incident_updated_v2", "private_incident.incident_updated_v2", "public_incident.incident_status_updated_v2", "public_incident.follow_up_created_v1", "private_incident.follow_up_created_v1", "public_incident.follow_up_updated_v1", "private_incident.follow_up_updated_v1", "public_incident.action_created_v1", "private_incident.action_created_v1", "public_incident.action_updated_v1", "private_incident.action_updated_v1", "private_incident.membership_granted_v1", "private_incident.membership_revoked_v1"])
    ...
    # @param [Object] public_incident_incident_status_updated_v2 Value to be assigned
    def public_incident_incident_status_updated_v2=(public_incident_incident_status_updated_v2)
      if public_incident_incident_status_updated_v2.nil?
        fail ArgumentError, 'public_incident_incident_status_updated_v2 cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          public_incident_incident_status_updated_v2 == o.public_incident_incident_status_updated_v2
    end
    ...
    def hash
      [event_type, public_incident_incident_status_updated_v2].hash
    end
