...
module IncidentIoSdk
  class WeekdayIntervalConfigV2
    ...
    attr_accessor :weekday_intervals
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'timezone' => :'String',
        :'weekday_intervals' => :'Array<WeekdayIntervalV2>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::WeekdayIntervalConfigV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::WeekdayIntervalConfigV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'weekday_intervals')
        if (value = attributes[:'weekday_intervals']).is_a?(Array)
          self.weekday_intervals = value
        end
      else
        self.weekday_intervals = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @weekday_intervals.nil?
        invalid_properties.push('invalid value for "weekday_intervals", weekday_intervals cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @weekday_intervals.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] weekday_intervals Value to be assigned
    def weekday_intervals=(weekday_intervals)
      if weekday_intervals.nil?
        fail ArgumentError, 'weekday_intervals cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          timezone == o.timezone &&
          weekday_intervals == o.weekday_intervals
    end
    ...
    def hash
      [id, name, timezone, weekday_intervals].hash
    end
