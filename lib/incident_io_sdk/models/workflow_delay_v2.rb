...
module IncidentIoSdk
  class WorkflowDelayV2
    ...
    attr_accessor :conditions_apply_over_delay
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IncidentIoSdk::WorkflowDelayV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IncidentIoSdk::WorkflowDelayV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'conditions_apply_over_delay')
        self.conditions_apply_over_delay = attributes[:'conditions_apply_over_delay']
      else
        self.conditions_apply_over_delay = nil
      end

      if attributes.key?(:'for_seconds')
        self.for_seconds = attributes[:'for_seconds']
      else
        self.for_seconds = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @conditions_apply_over_delay.nil?
        invalid_properties.push('invalid value for "conditions_apply_over_delay", conditions_apply_over_delay cannot be nil.')
      end

      if @for_seconds.nil?
        invalid_properties.push('invalid value for "for_seconds", for_seconds cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @conditions_apply_over_delay.nil?
      return false if @for_seconds.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] conditions_apply_over_delay Value to be assigned
    def conditions_apply_over_delay=(conditions_apply_over_delay)
      if conditions_apply_over_delay.nil?
        fail ArgumentError, 'conditions_apply_over_delay cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] for_seconds Value to be assigned
    def for_seconds=(for_seconds)
      if for_seconds.nil?
        fail ArgumentError, 'for_seconds cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          conditions_apply_over_delay == o.conditions_apply_over_delay &&
          for_seconds == o.for_seconds
    end
    ...
    def hash
      [conditions_apply_over_delay, for_seconds].hash
    end
