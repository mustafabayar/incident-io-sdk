...
# Unit tests for IncidentIoSdk::ActionsV1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ActionsV1Api' do
  before do
  ...
  describe 'test an instance of ActionsV1Api' do
    it 'should create an instance of ActionsV1Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::ActionsV1Api)
    end
  end

  # unit tests for actions_v1_list
  # List Actions V1
