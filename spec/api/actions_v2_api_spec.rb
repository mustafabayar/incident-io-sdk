...
# Unit tests for IncidentIoSdk::ActionsV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ActionsV2Api' do
  before do
  ...
  describe 'test an instance of ActionsV2Api' do
    it 'should create an instance of ActionsV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::ActionsV2Api)
    end
  end

  # unit tests for actions_v2_list
  # List Actions V2
