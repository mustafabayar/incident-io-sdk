...
# Unit tests for IncidentIoSdk::AlertAttributesV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AlertAttributesV2Api' do
  before do
  ...
  describe 'test an instance of AlertAttributesV2Api' do
    it 'should create an instance of AlertAttributesV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::AlertAttributesV2Api)
    end
  end

  # unit tests for alert_attributes_v2_create
  # Create Alert Attributes V2
  # Create a new alert attribute.
  # @param alert_attributes_create_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [AlertAttributesCreateResultV2]
  describe 'alert_attributes_v2_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_attributes_v2_destroy
  # Destroy Alert Attributes V2
  # Destroy an alert attribute.
  # @param id The ID of this attribute
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'alert_attributes_v2_destroy test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_attributes_v2_list
  # List Alert Attributes V2
  # List alert attributes.
  # @param [Hash] opts the optional parameters
  # @return [AlertAttributesListResultV2]
  describe 'alert_attributes_v2_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_attributes_v2_show
  # Show Alert Attributes V2
  # Show an alert attribute.
  # @param id The ID of this attribute
  # @param [Hash] opts the optional parameters
  # @return [AlertAttributesShowResultV2]
  describe 'alert_attributes_v2_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_attributes_v2_update
  # Update Alert Attributes V2
  # Update an alert attribute.
  # @param id The ID of this attribute
  # @param alert_attributes_update_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [AlertAttributesUpdateResultV2]
  describe 'alert_attributes_v2_update test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
