...
# Unit tests for IncidentIoSdk::AlertEventsV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AlertEventsV2Api' do
  before do
  ...
  describe 'test an instance of AlertEventsV2Api' do
    it 'should create an instance of AlertEventsV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::AlertEventsV2Api)
    end
  end

  # unit tests for alert_events_v2_create_http
  # CreateHTTP Alert Events V2
  # Create an alert event using an HTTP source.
  # @param alert_source_config_id Which alert source config produced this alert
  # @param alert_events_create_http_payload_v2 
  ...
  describe 'alert_events_v2_create_http test' do
    it 'should work' do
