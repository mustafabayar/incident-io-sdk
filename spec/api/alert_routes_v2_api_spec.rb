...
# Unit tests for IncidentIoSdk::AlertRoutesV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AlertRoutesV2Api' do
  before do
  ...
  describe 'test an instance of AlertRoutesV2Api' do
    it 'should create an instance of AlertRoutesV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::AlertRoutesV2Api)
    end
  end

  # unit tests for alert_routes_v2_create
  # Create Alert Routes V2
  # Create a new alert route in your account.
  # @param alert_routes_create_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [AlertRoutesCreateResultV2]
  describe 'alert_routes_v2_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_routes_v2_delete
  # Delete Alert Routes V2
  # Delete an existing alert route in your account.
  # @param id Unique identifier of the alert route
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'alert_routes_v2_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_routes_v2_list
  # List Alert Routes V2
  # List all alert routes in your account.
  # @param page_size Number of alert routes to return per page
  # @param [Hash] opts the optional parameters
  # @option opts [String] :after The ID of the last alert route on the previous page
  # @return [AlertRoutesListResultV2]
  describe 'alert_routes_v2_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_routes_v2_show
  # Show Alert Routes V2
  # Load details about a specific alert route in your account.
  # @param id Unique identifier of the alert route
  # @param [Hash] opts the optional parameters
  # @return [AlertRoutesShowResultV2]
  describe 'alert_routes_v2_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_routes_v2_update
  # Update Alert Routes V2
  # Update an existing alert route in your account.
  # @param id Unique identifier of the alert route
  # @param alert_routes_update_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [AlertRoutesUpdateResultV2]
  describe 'alert_routes_v2_update test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
