...
# Unit tests for IncidentIoSdk::AlertSourcesV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AlertSourcesV2Api' do
  before do
  ...
  describe 'test an instance of AlertSourcesV2Api' do
    it 'should create an instance of AlertSourcesV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::AlertSourcesV2Api)
    end
  end

  # unit tests for alert_sources_v2_create
  # Create Alert Sources V2
  # Create a new alert source in your account.
  # @param alert_sources_create_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [AlertSourcesCreateResultV2]
  describe 'alert_sources_v2_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_sources_v2_delete
  # Delete Alert Sources V2
  # Delete an existing alert source in your account.
  # @param id The ID of this alert source
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'alert_sources_v2_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_sources_v2_list
  # List Alert Sources V2
  # List all alert sources in your account.
  # @param [Hash] opts the optional parameters
  # @return [AlertSourcesListResultV2]
  describe 'alert_sources_v2_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_sources_v2_show
  # Show Alert Sources V2
  # Load details about a specific alert source in your account.
  # @param id The ID of this alert source
  # @param [Hash] opts the optional parameters
  # @return [AlertSourcesShowResultV2]
  describe 'alert_sources_v2_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alert_sources_v2_update
  # Update Alert Sources V2
  # Update an existing alert source in your account.
  # @param id The ID of this alert source
  # @param alert_sources_update_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [AlertSourcesUpdateResultV2]
  describe 'alert_sources_v2_update test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
