...
# Unit tests for IncidentIoSdk::AlertsV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AlertsV2Api' do
  before do
  ...
  describe 'test an instance of AlertsV2Api' do
    it 'should create an instance of AlertsV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::AlertsV2Api)
    end
  end

  # unit tests for alerts_v2_list
  # List Alerts V2
  ...
  # @param page_size Number of alerts to return per page
  ...
  describe 'alerts_v2_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alerts_v2_list_incident_alerts
  # ListIncidentAlerts Alerts V2
  # List the connections between incidents and alerts
  # @param page_size Number of incident alerts to return per page
  # @param [Hash] opts the optional parameters
  # @option opts [String] :after If provided, pass this as the &#39;after&#39; param to load the next page
  ...
  describe 'alerts_v2_list_incident_alerts test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for alerts_v2_show
  # Show Alerts V2
  # Show a single alert for your account
  # @param id Unique identifier for the alert
  # @param [Hash] opts the optional parameters
  # @return [AlertsShowResultV2]
  describe 'alerts_v2_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
