...
# Unit tests for IncidentIoSdk::CatalogV3Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CatalogV3Api' do
  before do
  ...
  describe 'test an instance of CatalogV3Api' do
    it 'should create an instance of CatalogV3Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::CatalogV3Api)
    end
  end

  # unit tests for catalog_v3_create_entry
  ...
  describe 'catalog_v3_list_entries test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for catalog_v3_list_resources
  ...
  describe 'catalog_v3_list_resources test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for catalog_v3_list_types
  ...
  describe 'catalog_v3_list_types test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for catalog_v3_show_entry
  # ShowEntry Catalog V3
  # Show a single catalog entry.
  # @param id ID of this catalog entry
  # @param [Hash] opts the optional parameters
  # @return [CatalogShowEntryResultV3]
  describe 'catalog_v3_show_entry test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for catalog_v3_show_type
  # ShowType Catalog V3
  # Show a single catalog type.
  # @param id ID of this catalog type
  # @param [Hash] opts the optional parameters
  # @return [CatalogShowTypeResultV3]
  describe 'catalog_v3_show_type test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for catalog_v3_update_entry
  # UpdateEntry Catalog V3
  # Updates an existing catalog entry.
  # @param id ID of this catalog entry
  # @param catalog_update_entry_payload_v3 
  # @param [Hash] opts the optional parameters
  # @return [CatalogUpdateEntryResultV3]
  describe 'catalog_v3_update_entry test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for catalog_v3_update_type
  # UpdateType Catalog V3
  # Updates an existing catalog type. The schema must be updated using the UpdateTypeSchema endpoint.
  # @param id ID of this catalog type
  # @param catalog_update_type_payload_v3 
  # @param [Hash] opts the optional parameters
  # @return [CatalogUpdateTypeResultV3]
  describe 'catalog_v3_update_type test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for catalog_v3_update_type_schema
  ...
  # @param id ID of this catalog type
  # @param catalog_update_type_schema_payload_v3 
  # @param [Hash] opts the optional parameters
  # @return [CatalogUpdateTypeSchemaResultV3]
  describe 'catalog_v3_update_type_schema test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
