...
# Unit tests for IncidentIoSdk::CustomFieldOptionsV1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomFieldOptionsV1Api' do
  before do
  ...
  describe 'test an instance of CustomFieldOptionsV1Api' do
    it 'should create an instance of CustomFieldOptionsV1Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::CustomFieldOptionsV1Api)
    end
  end

  # unit tests for custom_field_options_v1_create
  ...
  # @param custom_field_options_create_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldOptionsCreateResultV1]
  describe 'custom_field_options_v1_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_field_options_v1_delete
  # Delete Custom Field Options V1
  # Delete a custom field option
  # @param id Unique identifier for the custom field option
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'custom_field_options_v1_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_field_options_v1_list
  # List Custom Field Options V1
  # Show custom field options for a custom field
  # @param custom_field_id The custom field to list options for.
  # @param [Hash] opts the optional parameters
  ...
  describe 'custom_field_options_v1_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_field_options_v1_show
  # Show Custom Field Options V1
  # Get a single custom field option
  # @param id Unique identifier for the custom field option
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldOptionsShowResultV1]
  describe 'custom_field_options_v1_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_field_options_v1_update
  # Update Custom Field Options V1
  # Update a custom field option
  # @param id Unique identifier for the custom field option
  # @param custom_field_options_update_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldOptionsUpdateResultV1]
  describe 'custom_field_options_v1_update test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
