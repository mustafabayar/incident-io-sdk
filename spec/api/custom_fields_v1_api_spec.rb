...
# Unit tests for IncidentIoSdk::CustomFieldsV1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomFieldsV1Api' do
  before do
  ...
  describe 'test an instance of CustomFieldsV1Api' do
    it 'should create an instance of CustomFieldsV1Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::CustomFieldsV1Api)
    end
  end

  # unit tests for custom_fields_v1_create
  # Create Custom Fields V1
  # Create a new custom field
  # @param custom_fields_create_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldsCreateResultV1]
  describe 'custom_fields_v1_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_fields_v1_delete
  # Delete Custom Fields V1
  # Delete a custom field
  # @param id Unique identifier for the custom field
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'custom_fields_v1_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_fields_v1_list
  # List Custom Fields V1
  # List all custom fields for an organisation.
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldsListResultV1]
  describe 'custom_fields_v1_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_fields_v1_show
  # Show Custom Fields V1
  # Get a single custom field.
  # @param id Unique identifier for the custom field
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldsShowResultV1]
  describe 'custom_fields_v1_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_fields_v1_update
  # Update Custom Fields V1
  # Update the details of a custom field
  # @param id Unique identifier for the custom field
  # @param custom_fields_update_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldsUpdateResultV1]
  describe 'custom_fields_v1_update test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
