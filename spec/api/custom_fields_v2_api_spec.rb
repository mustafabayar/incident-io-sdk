...
# Unit tests for IncidentIoSdk::CustomFieldsV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomFieldsV2Api' do
  before do
  ...
  describe 'test an instance of CustomFieldsV2Api' do
    it 'should create an instance of CustomFieldsV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::CustomFieldsV2Api)
    end
  end

  # unit tests for custom_fields_v2_create
  # Create Custom Fields V2
  # Create a new custom field
  # @param custom_fields_create_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldsCreateResultV2]
  describe 'custom_fields_v2_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_fields_v2_delete
  # Delete Custom Fields V2
  # Delete a custom field
  # @param id Unique identifier for the custom field
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'custom_fields_v2_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_fields_v2_list
  # List Custom Fields V2
  # List all custom fields for an organisation.
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldsListResultV2]
  describe 'custom_fields_v2_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_fields_v2_show
  # Show Custom Fields V2
  # Get a single custom field.
  # @param id Unique identifier for the custom field
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldsShowResultV2]
  describe 'custom_fields_v2_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for custom_fields_v2_update
  # Update Custom Fields V2
  # Update the details of a custom field
  # @param id Unique identifier for the custom field
  # @param custom_fields_update_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [CustomFieldsUpdateResultV2]
  describe 'custom_fields_v2_update test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
