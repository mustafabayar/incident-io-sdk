...
# Unit tests for IncidentIoSdk::EscalationsV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EscalationsV2Api' do
  before do
  ...
  describe 'test an instance of EscalationsV2Api' do
    it 'should create an instance of EscalationsV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::EscalationsV2Api)
    end
  end

  # unit tests for escalations_v2_create_path
  ...
  # @param escalations_create_path_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [EscalationsCreatePathResultV2]
  describe 'escalations_v2_create_path test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for escalations_v2_destroy_path
  ...
  # @param id Unique identifier for this escalation path.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'escalations_v2_destroy_path test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for escalations_v2_show_path
  ...
  describe 'escalations_v2_show_path test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for escalations_v2_update_path
  ...
  # @param id Unique identifier for this escalation path.
  # @param escalations_update_path_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [EscalationsUpdatePathResultV2]
  describe 'escalations_v2_update_path test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
