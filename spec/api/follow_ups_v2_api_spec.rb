...
# Unit tests for IncidentIoSdk::FollowUpsV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FollowUpsV2Api' do
  before do
  ...
  describe 'test an instance of FollowUpsV2Api' do
    it 'should create an instance of FollowUpsV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::FollowUpsV2Api)
    end
  end

  # unit tests for follow_ups_v2_list
  # List Follow-ups V2
  ...
  describe 'follow_ups_v2_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for follow_ups_v2_show
  # Show Follow-ups V2
  # Get a single incident follow-up.
  # @param id Unique identifier for the follow-up
  # @param [Hash] opts the optional parameters
  # @return [FollowUpsShowResultV2]
  describe 'follow_ups_v2_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
