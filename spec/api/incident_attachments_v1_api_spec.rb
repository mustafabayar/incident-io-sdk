...
# Unit tests for IncidentIoSdk::IncidentAttachmentsV1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IncidentAttachmentsV1Api' do
  before do
  ...
  describe 'test an instance of IncidentAttachmentsV1Api' do
    it 'should create an instance of IncidentAttachmentsV1Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::IncidentAttachmentsV1Api)
    end
  end

  # unit tests for incident_attachments_v1_create
  # Create Incident Attachments V1
  # Attaches an external resource to an incident
  # @param incident_attachments_create_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [IncidentAttachmentsCreateResultV1]
  describe 'incident_attachments_v1_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_attachments_v1_delete
  # Delete Incident Attachments V1
  # Unattaches an external resource from an incident
  # @param id Unique identifier of this incident membership
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'incident_attachments_v1_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_attachments_v1_list
  ...
  describe 'incident_attachments_v1_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
