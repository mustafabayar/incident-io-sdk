...
# Unit tests for IncidentIoSdk::IncidentMembershipsV1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IncidentMembershipsV1Api' do
  before do
  ...
  describe 'test an instance of IncidentMembershipsV1Api' do
    it 'should create an instance of IncidentMembershipsV1Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::IncidentMembershipsV1Api)
    end
  end

  # unit tests for incident_memberships_v1_create
  # Create Incident Memberships V1
  # Makes a user a member of a private incident
  # @param incident_memberships_create_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [IncidentMembershipsCreateResultV1]
  describe 'incident_memberships_v1_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_memberships_v1_revoke
  # Revoke Incident Memberships V1
  # Revoke a user&#39;s membership of a private incident
  # @param incident_memberships_revoke_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'incident_memberships_v1_revoke test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
