...
# Unit tests for IncidentIoSdk::IncidentRolesV1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IncidentRolesV1Api' do
  before do
  ...
  describe 'test an instance of IncidentRolesV1Api' do
    it 'should create an instance of IncidentRolesV1Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::IncidentRolesV1Api)
    end
  end

  # unit tests for incident_roles_v1_create
  # Create Incident Roles V1
  # Create a new incident role
  # @param incident_roles_create_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [IncidentRolesCreateResultV1]
  describe 'incident_roles_v1_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_roles_v1_delete
  # Delete Incident Roles V1
  # Removes an existing role
  # @param id Unique identifier for the role
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'incident_roles_v1_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_roles_v1_list
  # List Incident Roles V1
  # List all incident roles for an organisation.
  # @param [Hash] opts the optional parameters
  # @return [IncidentRolesListResultV1]
  describe 'incident_roles_v1_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_roles_v1_show
  # Show Incident Roles V1
  # Get a single incident role.
  # @param id Unique identifier for the role
  # @param [Hash] opts the optional parameters
  # @return [IncidentRolesShowResultV1]
  describe 'incident_roles_v1_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_roles_v1_update
  # Update Incident Roles V1
  # Update an existing incident role
  # @param id Unique identifier for the role
  # @param incident_roles_update_payload_v1 
  # @param [Hash] opts the optional parameters
  # @return [IncidentRolesUpdateResultV1]
  describe 'incident_roles_v1_update test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
