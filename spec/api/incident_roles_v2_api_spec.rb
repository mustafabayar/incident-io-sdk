...
# Unit tests for IncidentIoSdk::IncidentRolesV2Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IncidentRolesV2Api' do
  before do
  ...
  describe 'test an instance of IncidentRolesV2Api' do
    it 'should create an instance of IncidentRolesV2Api' do
      expect(@api_instance).to be_instance_of(IncidentIoSdk::IncidentRolesV2Api)
    end
  end

  # unit tests for incident_roles_v2_create
  # Create Incident Roles V2
  # Create a new incident role
  # @param incident_roles_create_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [IncidentRolesCreateResultV2]
  describe 'incident_roles_v2_create test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_roles_v2_delete
  # Delete Incident Roles V2
  # Removes an existing role
  # @param id Unique identifier for the role
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'incident_roles_v2_delete test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_roles_v2_list
  # List Incident Roles V2
  # List all incident roles for an organisation.
  # @param [Hash] opts the optional parameters
  # @return [IncidentRolesListResultV2]
  describe 'incident_roles_v2_list test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_roles_v2_show
  # Show Incident Roles V2
  # Get a single incident role.
  # @param id Unique identifier for the role
  # @param [Hash] opts the optional parameters
  # @return [IncidentRolesShowResultV2]
  describe 'incident_roles_v2_show test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for incident_roles_v2_update
  # Update Incident Roles V2
  # Update an existing incident role
  # @param id Unique identifier for the role
  # @param incident_roles_update_payload_v2 
  # @param [Hash] opts the optional parameters
  # @return [IncidentRolesUpdateResultV2]
  describe 'incident_roles_v2_update test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
