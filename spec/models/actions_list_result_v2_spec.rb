...
# Unit tests for IncidentIoSdk::ActionsListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ActionsListResultV2 do
  let(:instance) { IncidentIoSdk::ActionsListResultV2.new }

  describe 'test an instance of ActionsListResultV2' do
    it 'should create an instance of ActionsListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ActionsListResultV2)
    end
  end
