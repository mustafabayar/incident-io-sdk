...
# Unit tests for IncidentIoSdk::ActionsShowResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ActionsShowResultV1 do
  let(:instance) { IncidentIoSdk::ActionsShowResultV1.new }

  describe 'test an instance of ActionsShowResultV1' do
    it 'should create an instance of ActionsShowResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ActionsShowResultV1)
    end
  end
