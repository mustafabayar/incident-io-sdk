...
# Unit tests for IncidentIoSdk::ActionsShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ActionsShowResultV2 do
  let(:instance) { IncidentIoSdk::ActionsShowResultV2.new }

  describe 'test an instance of ActionsShowResultV2' do
    it 'should create an instance of ActionsShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ActionsShowResultV2)
    end
  end
