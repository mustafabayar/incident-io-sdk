...
# Unit tests for IncidentIoSdk::ActorV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ActorV1 do
  let(:instance) { IncidentIoSdk::ActorV1.new }

  describe 'test an instance of ActorV1' do
    it 'should create an instance of ActorV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ActorV1)
    end
  end
