...
# Unit tests for IncidentIoSdk::ActorV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ActorV2 do
  let(:instance) { IncidentIoSdk::ActorV2.new }

  describe 'test an instance of ActorV2' do
    it 'should create an instance of ActorV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ActorV2)
    end
  end
