...
# Unit tests for IncidentIoSdk::AfterPaginationMetaResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AfterPaginationMetaResultV2 do
  let(:instance) { IncidentIoSdk::AfterPaginationMetaResultV2.new }

  describe 'test an instance of AfterPaginationMetaResultV2' do
    it 'should create an instance of AfterPaginationMetaResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AfterPaginationMetaResultV2)
    end
  end
  ...
  describe 'test attribute "after_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
