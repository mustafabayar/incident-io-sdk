...
# Unit tests for IncidentIoSdk::AlertAttributeCatalogEntryV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributeCatalogEntryV2 do
  let(:instance) { IncidentIoSdk::AlertAttributeCatalogEntryV2.new }

  describe 'test an instance of AlertAttributeCatalogEntryV2' do
    it 'should create an instance of AlertAttributeCatalogEntryV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributeCatalogEntryV2)
    end
  end
