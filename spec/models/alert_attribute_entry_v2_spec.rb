...
# Unit tests for IncidentIoSdk::AlertAttributeEntryV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributeEntryV2 do
  let(:instance) { IncidentIoSdk::AlertAttributeEntryV2.new }

  describe 'test an instance of AlertAttributeEntryV2' do
    it 'should create an instance of AlertAttributeEntryV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributeEntryV2)
    end
  end
