...
# Unit tests for IncidentIoSdk::AlertAttributeV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributeV2 do
  let(:instance) { IncidentIoSdk::AlertAttributeV2.new }

  describe 'test an instance of AlertAttributeV2' do
    it 'should create an instance of AlertAttributeV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributeV2)
    end
  end
