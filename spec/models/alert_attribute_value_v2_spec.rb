...
# Unit tests for IncidentIoSdk::AlertAttributeValueV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributeValueV2 do
  let(:instance) { IncidentIoSdk::AlertAttributeValueV2.new }

  describe 'test an instance of AlertAttributeValueV2' do
    it 'should create an instance of AlertAttributeValueV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributeValueV2)
    end
  end
