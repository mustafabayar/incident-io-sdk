...
# Unit tests for IncidentIoSdk::AlertAttributesCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributesCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertAttributesCreatePayloadV2.new }

  describe 'test an instance of AlertAttributesCreatePayloadV2' do
    it 'should create an instance of AlertAttributesCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributesCreatePayloadV2)
    end
  end
