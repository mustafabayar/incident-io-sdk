...
# Unit tests for IncidentIoSdk::AlertAttributesCreateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributesCreateResultV2 do
  let(:instance) { IncidentIoSdk::AlertAttributesCreateResultV2.new }

  describe 'test an instance of AlertAttributesCreateResultV2' do
    it 'should create an instance of AlertAttributesCreateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributesCreateResultV2)
    end
  end

  describe 'test attribute "alert_attribute"' do
    it 'should work' do
