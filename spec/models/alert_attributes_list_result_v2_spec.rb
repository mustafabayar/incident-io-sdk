...
# Unit tests for IncidentIoSdk::AlertAttributesListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributesListResultV2 do
  let(:instance) { IncidentIoSdk::AlertAttributesListResultV2.new }

  describe 'test an instance of AlertAttributesListResultV2' do
    it 'should create an instance of AlertAttributesListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributesListResultV2)
    end
  end

  describe 'test attribute "alert_attributes"' do
    it 'should work' do
