...
# Unit tests for IncidentIoSdk::AlertAttributesShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributesShowResultV2 do
  let(:instance) { IncidentIoSdk::AlertAttributesShowResultV2.new }

  describe 'test an instance of AlertAttributesShowResultV2' do
    it 'should create an instance of AlertAttributesShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributesShowResultV2)
    end
  end
