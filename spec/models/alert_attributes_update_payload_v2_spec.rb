...
# Unit tests for IncidentIoSdk::AlertAttributesUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributesUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertAttributesUpdatePayloadV2.new }

  describe 'test an instance of AlertAttributesUpdatePayloadV2' do
    it 'should create an instance of AlertAttributesUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributesUpdatePayloadV2)
    end
  end
