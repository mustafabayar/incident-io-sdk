...
# Unit tests for IncidentIoSdk::AlertAttributesUpdateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertAttributesUpdateResultV2 do
  let(:instance) { IncidentIoSdk::AlertAttributesUpdateResultV2.new }

  describe 'test an instance of AlertAttributesUpdateResultV2' do
    it 'should create an instance of AlertAttributesUpdateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertAttributesUpdateResultV2)
    end
  end
