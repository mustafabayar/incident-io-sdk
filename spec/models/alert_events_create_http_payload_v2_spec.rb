...
# Unit tests for IncidentIoSdk::AlertEventsCreateHTTPPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertEventsCreateHTTPPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertEventsCreateHTTPPayloadV2.new }

  describe 'test an instance of AlertEventsCreateHTTPPayloadV2' do
    it 'should create an instance of AlertEventsCreateHTTPPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertEventsCreateHTTPPayloadV2)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["firing", "resolved"])
