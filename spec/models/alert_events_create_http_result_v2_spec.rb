...
# Unit tests for IncidentIoSdk::AlertEventsCreateHTTPResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertEventsCreateHTTPResultV2 do
  let(:instance) { IncidentIoSdk::AlertEventsCreateHTTPResultV2.new }

  describe 'test an instance of AlertEventsCreateHTTPResultV2' do
    it 'should create an instance of AlertEventsCreateHTTPResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertEventsCreateHTTPResultV2)
    end
  end
