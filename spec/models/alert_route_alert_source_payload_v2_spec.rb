...
# Unit tests for IncidentIoSdk::AlertRouteAlertSourcePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteAlertSourcePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteAlertSourcePayloadV2.new }

  describe 'test an instance of AlertRouteAlertSourcePayloadV2' do
    it 'should create an instance of AlertRouteAlertSourcePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteAlertSourcePayloadV2)
    end
  end

  describe 'test attribute "alert_source_id"' do
    it 'should work' do
