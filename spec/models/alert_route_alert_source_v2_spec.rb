...
# Unit tests for IncidentIoSdk::AlertRouteAlertSourceV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteAlertSourceV2 do
  let(:instance) { IncidentIoSdk::AlertRouteAlertSourceV2.new }

  describe 'test an instance of AlertRouteAlertSourceV2' do
    it 'should create an instance of AlertRouteAlertSourceV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteAlertSourceV2)
    end
  end
