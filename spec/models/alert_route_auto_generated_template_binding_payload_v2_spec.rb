...
# Unit tests for IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingPayloadV2.new }

  describe 'test an instance of AlertRouteAutoGeneratedTemplateBindingPayloadV2' do
    it 'should create an instance of AlertRouteAutoGeneratedTemplateBindingPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingPayloadV2)
    end
  end

  describe 'test attribute "autogenerated"' do
    it 'should work' do
