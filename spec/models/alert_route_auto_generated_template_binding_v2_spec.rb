...
# Unit tests for IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingV2 do
  let(:instance) { IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingV2.new }

  describe 'test an instance of AlertRouteAutoGeneratedTemplateBindingV2' do
    it 'should create an instance of AlertRouteAutoGeneratedTemplateBindingV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteAutoGeneratedTemplateBindingV2)
    end
  end
