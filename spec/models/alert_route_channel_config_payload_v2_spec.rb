...
# Unit tests for IncidentIoSdk::AlertRouteChannelConfigPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteChannelConfigPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteChannelConfigPayloadV2.new }

  describe 'test an instance of AlertRouteChannelConfigPayloadV2' do
    it 'should create an instance of AlertRouteChannelConfigPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteChannelConfigPayloadV2)
    end
  end
  ...
  describe 'test attribute "ms_teams_targets"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "slack_targets"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
