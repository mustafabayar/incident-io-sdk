...
# Unit tests for IncidentIoSdk::AlertRouteChannelConfigV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteChannelConfigV2 do
  let(:instance) { IncidentIoSdk::AlertRouteChannelConfigV2.new }

  describe 'test an instance of AlertRouteChannelConfigV2' do
    it 'should create an instance of AlertRouteChannelConfigV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteChannelConfigV2)
    end
  end
