...
# Unit tests for IncidentIoSdk::AlertRouteChannelTargetPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteChannelTargetPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteChannelTargetPayloadV2.new }

  describe 'test an instance of AlertRouteChannelTargetPayloadV2' do
    it 'should create an instance of AlertRouteChannelTargetPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteChannelTargetPayloadV2)
    end
  end
  ...
  describe 'test attribute "channel_visibility"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
