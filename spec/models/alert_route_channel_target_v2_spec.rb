...
# Unit tests for IncidentIoSdk::AlertRouteChannelTargetV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteChannelTargetV2 do
  let(:instance) { IncidentIoSdk::AlertRouteChannelTargetV2.new }

  describe 'test an instance of AlertRouteChannelTargetV2' do
    it 'should create an instance of AlertRouteChannelTargetV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteChannelTargetV2)
    end
  end
