...
# Unit tests for IncidentIoSdk::AlertRouteCustomFieldBindingPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteCustomFieldBindingPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteCustomFieldBindingPayloadV2.new }

  describe 'test an instance of AlertRouteCustomFieldBindingPayloadV2' do
    it 'should create an instance of AlertRouteCustomFieldBindingPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteCustomFieldBindingPayloadV2)
    end
  end
  ...
  describe 'test attribute "merge_strategy"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["first-wins", "last-wins", "append"])
