...
# Unit tests for IncidentIoSdk::AlertRouteCustomFieldBindingV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteCustomFieldBindingV2 do
  let(:instance) { IncidentIoSdk::AlertRouteCustomFieldBindingV2.new }

  describe 'test an instance of AlertRouteCustomFieldBindingV2' do
    it 'should create an instance of AlertRouteCustomFieldBindingV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteCustomFieldBindingV2)
    end
  end
