...
# Unit tests for IncidentIoSdk::AlertRouteEscalationConfigPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteEscalationConfigPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteEscalationConfigPayloadV2.new }

  describe 'test an instance of AlertRouteEscalationConfigPayloadV2' do
    it 'should create an instance of AlertRouteEscalationConfigPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteEscalationConfigPayloadV2)
    end
  end

  describe 'test attribute "auto_cancel_escalations"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "escalation_targets"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
