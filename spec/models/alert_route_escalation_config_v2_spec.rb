...
# Unit tests for IncidentIoSdk::AlertRouteEscalationConfigV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteEscalationConfigV2 do
  let(:instance) { IncidentIoSdk::AlertRouteEscalationConfigV2.new }

  describe 'test an instance of AlertRouteEscalationConfigV2' do
    it 'should create an instance of AlertRouteEscalationConfigV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteEscalationConfigV2)
    end
  end
