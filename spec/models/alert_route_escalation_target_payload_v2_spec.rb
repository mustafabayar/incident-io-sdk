...
# Unit tests for IncidentIoSdk::AlertRouteEscalationTargetPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteEscalationTargetPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteEscalationTargetPayloadV2.new }

  describe 'test an instance of AlertRouteEscalationTargetPayloadV2' do
    it 'should create an instance of AlertRouteEscalationTargetPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteEscalationTargetPayloadV2)
    end
  end

  describe 'test attribute "escalation_paths"' do
    it 'should work' do
