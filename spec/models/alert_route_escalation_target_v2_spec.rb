...
# Unit tests for IncidentIoSdk::AlertRouteEscalationTargetV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteEscalationTargetV2 do
  let(:instance) { IncidentIoSdk::AlertRouteEscalationTargetV2.new }

  describe 'test an instance of AlertRouteEscalationTargetV2' do
    it 'should create an instance of AlertRouteEscalationTargetV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteEscalationTargetV2)
    end
  end
