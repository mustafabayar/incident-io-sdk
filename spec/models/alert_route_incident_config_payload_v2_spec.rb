...
# Unit tests for IncidentIoSdk::AlertRouteIncidentConfigPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteIncidentConfigPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteIncidentConfigPayloadV2.new }

  describe 'test an instance of AlertRouteIncidentConfigPayloadV2' do
    it 'should create an instance of AlertRouteIncidentConfigPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteIncidentConfigPayloadV2)
    end
  end

  describe 'test attribute "auto_decline_enabled"' do
    it 'should work' do
  ...
  describe 'test attribute "defer_time_seconds"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "grouping_keys"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "grouping_window_seconds"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
