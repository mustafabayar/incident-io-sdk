...
# Unit tests for IncidentIoSdk::AlertRouteIncidentConfigV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteIncidentConfigV2 do
  let(:instance) { IncidentIoSdk::AlertRouteIncidentConfigV2.new }

  describe 'test an instance of AlertRouteIncidentConfigV2' do
    it 'should create an instance of AlertRouteIncidentConfigV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteIncidentConfigV2)
    end
  end
