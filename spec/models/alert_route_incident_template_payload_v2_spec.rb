...
# Unit tests for IncidentIoSdk::AlertRouteIncidentTemplatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteIncidentTemplatePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteIncidentTemplatePayloadV2.new }

  describe 'test an instance of AlertRouteIncidentTemplatePayloadV2' do
    it 'should create an instance of AlertRouteIncidentTemplatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteIncidentTemplatePayloadV2)
    end
  end
  ...
  describe 'test attribute "incident_mode"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "start_in_triage"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
