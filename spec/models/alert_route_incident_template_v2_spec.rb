...
# Unit tests for IncidentIoSdk::AlertRouteIncidentTemplateV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteIncidentTemplateV2 do
  let(:instance) { IncidentIoSdk::AlertRouteIncidentTemplateV2.new }

  describe 'test an instance of AlertRouteIncidentTemplateV2' do
    it 'should create an instance of AlertRouteIncidentTemplateV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteIncidentTemplateV2)
    end
  end
