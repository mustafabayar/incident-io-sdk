...
# Unit tests for IncidentIoSdk::AlertRouteSeverityBindingV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteSeverityBindingV2 do
  let(:instance) { IncidentIoSdk::AlertRouteSeverityBindingV2.new }

  describe 'test an instance of AlertRouteSeverityBindingV2' do
    it 'should create an instance of AlertRouteSeverityBindingV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteSeverityBindingV2)
    end
  end
