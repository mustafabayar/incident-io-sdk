...
# Unit tests for IncidentIoSdk::AlertRouteSlimV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteSlimV2 do
  let(:instance) { IncidentIoSdk::AlertRouteSlimV2.new }

  describe 'test an instance of AlertRouteSlimV2' do
    it 'should create an instance of AlertRouteSlimV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteSlimV2)
    end
  end
