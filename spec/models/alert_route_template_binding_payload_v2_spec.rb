...
# Unit tests for IncidentIoSdk::AlertRouteTemplateBindingPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteTemplateBindingPayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRouteTemplateBindingPayloadV2.new }

  describe 'test an instance of AlertRouteTemplateBindingPayloadV2' do
    it 'should create an instance of AlertRouteTemplateBindingPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteTemplateBindingPayloadV2)
    end
  end
