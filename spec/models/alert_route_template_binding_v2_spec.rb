...
# Unit tests for IncidentIoSdk::AlertRouteTemplateBindingV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteTemplateBindingV2 do
  let(:instance) { IncidentIoSdk::AlertRouteTemplateBindingV2.new }

  describe 'test an instance of AlertRouteTemplateBindingV2' do
    it 'should create an instance of AlertRouteTemplateBindingV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteTemplateBindingV2)
    end
  end
