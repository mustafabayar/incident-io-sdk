...
# Unit tests for IncidentIoSdk::AlertRouteV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRouteV2 do
  let(:instance) { IncidentIoSdk::AlertRouteV2.new }

  describe 'test an instance of AlertRouteV2' do
    it 'should create an instance of AlertRouteV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRouteV2)
    end
  end
