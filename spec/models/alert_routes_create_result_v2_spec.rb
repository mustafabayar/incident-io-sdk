...
# Unit tests for IncidentIoSdk::AlertRoutesCreateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRoutesCreateResultV2 do
  let(:instance) { IncidentIoSdk::AlertRoutesCreateResultV2.new }

  describe 'test an instance of AlertRoutesCreateResultV2' do
    it 'should create an instance of AlertRoutesCreateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRoutesCreateResultV2)
    end
  end
