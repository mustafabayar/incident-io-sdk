...
# Unit tests for IncidentIoSdk::AlertRoutesListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRoutesListResultV2 do
  let(:instance) { IncidentIoSdk::AlertRoutesListResultV2.new }

  describe 'test an instance of AlertRoutesListResultV2' do
    it 'should create an instance of AlertRoutesListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRoutesListResultV2)
    end
  end

  describe 'test attribute "alert_routes"' do
    it 'should work' do
