...
# Unit tests for IncidentIoSdk::AlertRoutesShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRoutesShowResultV2 do
  let(:instance) { IncidentIoSdk::AlertRoutesShowResultV2.new }

  describe 'test an instance of AlertRoutesShowResultV2' do
    it 'should create an instance of AlertRoutesShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRoutesShowResultV2)
    end
  end
