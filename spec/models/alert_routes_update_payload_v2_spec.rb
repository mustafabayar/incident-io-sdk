...
# Unit tests for IncidentIoSdk::AlertRoutesUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRoutesUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertRoutesUpdatePayloadV2.new }

  describe 'test an instance of AlertRoutesUpdatePayloadV2' do
    it 'should create an instance of AlertRoutesUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRoutesUpdatePayloadV2)
    end
  end
