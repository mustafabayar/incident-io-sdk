...
# Unit tests for IncidentIoSdk::AlertRoutesUpdateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertRoutesUpdateResultV2 do
  let(:instance) { IncidentIoSdk::AlertRoutesUpdateResultV2.new }

  describe 'test an instance of AlertRoutesUpdateResultV2' do
    it 'should create an instance of AlertRoutesUpdateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertRoutesUpdateResultV2)
    end
  end

  describe 'test attribute "alert_route"' do
    it 'should work' do
