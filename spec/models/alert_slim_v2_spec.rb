...
# Unit tests for IncidentIoSdk::AlertSlimV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSlimV2 do
  let(:instance) { IncidentIoSdk::AlertSlimV2.new }

  describe 'test an instance of AlertSlimV2' do
    it 'should create an instance of AlertSlimV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSlimV2)
    end
  end
