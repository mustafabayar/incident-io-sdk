...
# Unit tests for IncidentIoSdk::AlertSourceEmailOptionsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourceEmailOptionsV2 do
  let(:instance) { IncidentIoSdk::AlertSourceEmailOptionsV2.new }

  describe 'test an instance of AlertSourceEmailOptionsV2' do
    it 'should create an instance of AlertSourceEmailOptionsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourceEmailOptionsV2)
    end
  end
