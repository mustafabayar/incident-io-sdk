...
# Unit tests for IncidentIoSdk::AlertSourceJiraOptionsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourceJiraOptionsV2 do
  let(:instance) { IncidentIoSdk::AlertSourceJiraOptionsV2.new }

  describe 'test an instance of AlertSourceJiraOptionsV2' do
    it 'should create an instance of AlertSourceJiraOptionsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourceJiraOptionsV2)
    end
  end
