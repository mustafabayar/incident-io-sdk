...
# Unit tests for IncidentIoSdk::AlertSourceV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourceV2 do
  let(:instance) { IncidentIoSdk::AlertSourceV2.new }

  describe 'test an instance of AlertSourceV2' do
    it 'should create an instance of AlertSourceV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourceV2)
    end
  end
