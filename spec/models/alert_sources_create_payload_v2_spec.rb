...
# Unit tests for IncidentIoSdk::AlertSourcesCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourcesCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertSourcesCreatePayloadV2.new }

  describe 'test an instance of AlertSourcesCreatePayloadV2' do
    it 'should create an instance of AlertSourcesCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourcesCreatePayloadV2)
    end
  end

  describe 'test attribute "jira_options"' do
    it 'should work' do
