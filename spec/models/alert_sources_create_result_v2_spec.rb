...
# Unit tests for IncidentIoSdk::AlertSourcesCreateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourcesCreateResultV2 do
  let(:instance) { IncidentIoSdk::AlertSourcesCreateResultV2.new }

  describe 'test an instance of AlertSourcesCreateResultV2' do
    it 'should create an instance of AlertSourcesCreateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourcesCreateResultV2)
    end
  end

  describe 'test attribute "alert_source"' do
    it 'should work' do
