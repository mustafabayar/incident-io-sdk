...
# Unit tests for IncidentIoSdk::AlertSourcesListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourcesListResultV2 do
  let(:instance) { IncidentIoSdk::AlertSourcesListResultV2.new }

  describe 'test an instance of AlertSourcesListResultV2' do
    it 'should create an instance of AlertSourcesListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourcesListResultV2)
    end
  end
