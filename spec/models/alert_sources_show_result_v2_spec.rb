...
# Unit tests for IncidentIoSdk::AlertSourcesShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourcesShowResultV2 do
  let(:instance) { IncidentIoSdk::AlertSourcesShowResultV2.new }

  describe 'test an instance of AlertSourcesShowResultV2' do
    it 'should create an instance of AlertSourcesShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourcesShowResultV2)
    end
  end
