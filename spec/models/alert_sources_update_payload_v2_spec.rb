...
# Unit tests for IncidentIoSdk::AlertSourcesUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourcesUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertSourcesUpdatePayloadV2.new }

  describe 'test an instance of AlertSourcesUpdatePayloadV2' do
    it 'should create an instance of AlertSourcesUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourcesUpdatePayloadV2)
    end
  end
