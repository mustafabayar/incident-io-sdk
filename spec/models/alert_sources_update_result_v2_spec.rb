...
# Unit tests for IncidentIoSdk::AlertSourcesUpdateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertSourcesUpdateResultV2 do
  let(:instance) { IncidentIoSdk::AlertSourcesUpdateResultV2.new }

  describe 'test an instance of AlertSourcesUpdateResultV2' do
    it 'should create an instance of AlertSourcesUpdateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertSourcesUpdateResultV2)
    end
  end
