...
# Unit tests for IncidentIoSdk::AlertTemplateAttributePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertTemplateAttributePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertTemplateAttributePayloadV2.new }

  describe 'test an instance of AlertTemplateAttributePayloadV2' do
    it 'should create an instance of AlertTemplateAttributePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertTemplateAttributePayloadV2)
    end
  end

  describe 'test attribute "alert_attribute_id"' do
    it 'should work' do
