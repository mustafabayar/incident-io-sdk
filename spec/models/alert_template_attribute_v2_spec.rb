...
# Unit tests for IncidentIoSdk::AlertTemplateAttributeV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertTemplateAttributeV2 do
  let(:instance) { IncidentIoSdk::AlertTemplateAttributeV2.new }

  describe 'test an instance of AlertTemplateAttributeV2' do
    it 'should create an instance of AlertTemplateAttributeV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertTemplateAttributeV2)
    end
  end
