...
# Unit tests for IncidentIoSdk::AlertTemplatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertTemplatePayloadV2 do
  let(:instance) { IncidentIoSdk::AlertTemplatePayloadV2.new }

  describe 'test an instance of AlertTemplatePayloadV2' do
    it 'should create an instance of AlertTemplatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertTemplatePayloadV2)
    end
  end
