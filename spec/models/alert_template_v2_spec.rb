...
# Unit tests for IncidentIoSdk::AlertTemplateV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertTemplateV2 do
  let(:instance) { IncidentIoSdk::AlertTemplateV2.new }

  describe 'test an instance of AlertTemplateV2' do
    it 'should create an instance of AlertTemplateV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertTemplateV2)
    end
  end
