...
# Unit tests for IncidentIoSdk::AlertV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertV2 do
  let(:instance) { IncidentIoSdk::AlertV2.new }

  describe 'test an instance of AlertV2' do
    it 'should create an instance of AlertV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertV2)
    end
  end
