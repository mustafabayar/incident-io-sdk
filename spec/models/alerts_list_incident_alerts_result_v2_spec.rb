...
# Unit tests for IncidentIoSdk::AlertsListIncidentAlertsResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertsListIncidentAlertsResultV2 do
  let(:instance) { IncidentIoSdk::AlertsListIncidentAlertsResultV2.new }

  describe 'test an instance of AlertsListIncidentAlertsResultV2' do
    it 'should create an instance of AlertsListIncidentAlertsResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertsListIncidentAlertsResultV2)
    end
  end

  describe 'test attribute "incident_alerts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "pagination_meta"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
