...
# Unit tests for IncidentIoSdk::AlertsListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertsListResultV2 do
  let(:instance) { IncidentIoSdk::AlertsListResultV2.new }

  describe 'test an instance of AlertsListResultV2' do
    it 'should create an instance of AlertsListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertsListResultV2)
    end
  end
