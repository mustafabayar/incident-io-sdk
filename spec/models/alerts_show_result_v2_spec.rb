...
# Unit tests for IncidentIoSdk::AlertsShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AlertsShowResultV2 do
  let(:instance) { IncidentIoSdk::AlertsShowResultV2.new }

  describe 'test an instance of AlertsShowResultV2' do
    it 'should create an instance of AlertsShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AlertsShowResultV2)
    end
  end
