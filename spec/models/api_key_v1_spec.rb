...
# Unit tests for IncidentIoSdk::APIKeyV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::APIKeyV1 do
  let(:instance) { IncidentIoSdk::APIKeyV1.new }

  describe 'test an instance of APIKeyV1' do
    it 'should create an instance of APIKeyV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::APIKeyV1)
    end
  end
