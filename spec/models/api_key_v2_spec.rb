...
# Unit tests for IncidentIoSdk::APIKeyV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::APIKeyV2 do
  let(:instance) { IncidentIoSdk::APIKeyV2.new }

  describe 'test an instance of APIKeyV2' do
    it 'should create an instance of APIKeyV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::APIKeyV2)
    end
  end
