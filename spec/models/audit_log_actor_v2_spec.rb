...
# Unit tests for IncidentIoSdk::AuditLogActorV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogActorV2 do
  let(:instance) { IncidentIoSdk::AuditLogActorV2.new }

  describe 'test an instance of AuditLogActorV2' do
    it 'should create an instance of AuditLogActorV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogActorV2)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["user", "system", "api_key", "workflow", "external_resource"])
