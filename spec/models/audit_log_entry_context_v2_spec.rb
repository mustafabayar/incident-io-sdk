...
# Unit tests for IncidentIoSdk::AuditLogEntryContextV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogEntryContextV2 do
  let(:instance) { IncidentIoSdk::AuditLogEntryContextV2.new }

  describe 'test an instance of AuditLogEntryContextV2' do
    it 'should create an instance of AuditLogEntryContextV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogEntryContextV2)
    end
  end
