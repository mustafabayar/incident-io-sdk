...
# Unit tests for IncidentIoSdk::AuditLogPrivateIncidentAccessAttemptedMetadataV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogPrivateIncidentAccessAttemptedMetadataV2 do
  let(:instance) { IncidentIoSdk::AuditLogPrivateIncidentAccessAttemptedMetadataV2.new }

  describe 'test an instance of AuditLogPrivateIncidentAccessAttemptedMetadataV2' do
    it 'should create an instance of AuditLogPrivateIncidentAccessAttemptedMetadataV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogPrivateIncidentAccessAttemptedMetadataV2)
    end
  end
