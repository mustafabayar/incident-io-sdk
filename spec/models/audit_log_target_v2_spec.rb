...
# Unit tests for IncidentIoSdk::AuditLogTargetV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogTargetV2 do
  let(:instance) { IncidentIoSdk::AuditLogTargetV2.new }

  describe 'test an instance of AuditLogTargetV2' do
    it 'should create an instance of AuditLogTargetV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogTargetV2)
    end
  end
