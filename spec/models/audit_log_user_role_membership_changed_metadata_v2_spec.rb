...
# Unit tests for IncidentIoSdk::AuditLogUserRoleMembershipChangedMetadataV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogUserRoleMembershipChangedMetadataV2 do
  let(:instance) { IncidentIoSdk::AuditLogUserRoleMembershipChangedMetadataV2.new }

  describe 'test an instance of AuditLogUserRoleMembershipChangedMetadataV2' do
    it 'should create an instance of AuditLogUserRoleMembershipChangedMetadataV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogUserRoleMembershipChangedMetadataV2)
    end
  end
