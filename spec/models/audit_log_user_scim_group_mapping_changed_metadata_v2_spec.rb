...
# Unit tests for IncidentIoSdk::AuditLogUserSCIMGroupMappingChangedMetadataV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogUserSCIMGroupMappingChangedMetadataV2 do
  let(:instance) { IncidentIoSdk::AuditLogUserSCIMGroupMappingChangedMetadataV2.new }

  describe 'test an instance of AuditLogUserSCIMGroupMappingChangedMetadataV2' do
    it 'should create an instance of AuditLogUserSCIMGroupMappingChangedMetadataV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogUserSCIMGroupMappingChangedMetadataV2)
    end
  end

  describe 'test attribute "after_base_role_slug"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "after_custom_role_slugs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "before_base_role_slug"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "before_custom_role_slugs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
