...
# Unit tests for IncidentIoSdk::AuditLogsAlertRouteCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAlertRouteCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAlertRouteCreatedV1.new }

  describe 'test an instance of AuditLogsAlertRouteCreatedV1' do
    it 'should create an instance of AuditLogsAlertRouteCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAlertRouteCreatedV1)
    end
  end
