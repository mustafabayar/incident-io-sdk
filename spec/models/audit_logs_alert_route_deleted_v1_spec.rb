...
# Unit tests for IncidentIoSdk::AuditLogsAlertRouteDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAlertRouteDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAlertRouteDeletedV1.new }

  describe 'test an instance of AuditLogsAlertRouteDeletedV1' do
    it 'should create an instance of AuditLogsAlertRouteDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAlertRouteDeletedV1)
    end
  end
