...
# Unit tests for IncidentIoSdk::AuditLogsAlertRouteUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAlertRouteUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAlertRouteUpdatedV1.new }

  describe 'test an instance of AuditLogsAlertRouteUpdatedV1' do
    it 'should create an instance of AuditLogsAlertRouteUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAlertRouteUpdatedV1)
    end
  end
