...
# Unit tests for IncidentIoSdk::AuditLogsAlertSchemaUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAlertSchemaUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAlertSchemaUpdatedV1.new }

  describe 'test an instance of AuditLogsAlertSchemaUpdatedV1' do
    it 'should create an instance of AuditLogsAlertSchemaUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAlertSchemaUpdatedV1)
    end
  end
