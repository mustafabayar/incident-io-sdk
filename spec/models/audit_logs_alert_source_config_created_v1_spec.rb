...
# Unit tests for IncidentIoSdk::AuditLogsAlertSourceConfigCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAlertSourceConfigCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAlertSourceConfigCreatedV1.new }

  describe 'test an instance of AuditLogsAlertSourceConfigCreatedV1' do
    it 'should create an instance of AuditLogsAlertSourceConfigCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAlertSourceConfigCreatedV1)
    end
  end
