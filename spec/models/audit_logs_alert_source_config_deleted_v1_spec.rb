...
# Unit tests for IncidentIoSdk::AuditLogsAlertSourceConfigDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAlertSourceConfigDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAlertSourceConfigDeletedV1.new }

  describe 'test an instance of AuditLogsAlertSourceConfigDeletedV1' do
    it 'should create an instance of AuditLogsAlertSourceConfigDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAlertSourceConfigDeletedV1)
    end
  end
