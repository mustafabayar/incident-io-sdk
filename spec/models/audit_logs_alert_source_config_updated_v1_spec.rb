...
# Unit tests for IncidentIoSdk::AuditLogsAlertSourceConfigUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAlertSourceConfigUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAlertSourceConfigUpdatedV1.new }

  describe 'test an instance of AuditLogsAlertSourceConfigUpdatedV1' do
    it 'should create an instance of AuditLogsAlertSourceConfigUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAlertSourceConfigUpdatedV1)
    end
  end
