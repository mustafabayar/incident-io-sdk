...
# Unit tests for IncidentIoSdk::AuditLogsAnnouncementRuleCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAnnouncementRuleCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAnnouncementRuleCreatedV1.new }

  describe 'test an instance of AuditLogsAnnouncementRuleCreatedV1' do
    it 'should create an instance of AuditLogsAnnouncementRuleCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAnnouncementRuleCreatedV1)
    end
  end
