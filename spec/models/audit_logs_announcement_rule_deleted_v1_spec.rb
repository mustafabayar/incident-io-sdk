...
# Unit tests for IncidentIoSdk::AuditLogsAnnouncementRuleDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAnnouncementRuleDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAnnouncementRuleDeletedV1.new }

  describe 'test an instance of AuditLogsAnnouncementRuleDeletedV1' do
    it 'should create an instance of AuditLogsAnnouncementRuleDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAnnouncementRuleDeletedV1)
    end
  end
