...
# Unit tests for IncidentIoSdk::AuditLogsAnnouncementRuleUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAnnouncementRuleUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAnnouncementRuleUpdatedV1.new }

  describe 'test an instance of AuditLogsAnnouncementRuleUpdatedV1' do
    it 'should create an instance of AuditLogsAnnouncementRuleUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAnnouncementRuleUpdatedV1)
    end
  end
