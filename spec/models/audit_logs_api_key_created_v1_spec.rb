...
# Unit tests for IncidentIoSdk::AuditLogsAPIKeyCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAPIKeyCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAPIKeyCreatedV1.new }

  describe 'test an instance of AuditLogsAPIKeyCreatedV1' do
    it 'should create an instance of AuditLogsAPIKeyCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAPIKeyCreatedV1)
    end
  end
