...
# Unit tests for IncidentIoSdk::AuditLogsAPIKeyDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsAPIKeyDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsAPIKeyDeletedV1.new }

  describe 'test an instance of AuditLogsAPIKeyDeletedV1' do
    it 'should create an instance of AuditLogsAPIKeyDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsAPIKeyDeletedV1)
    end
  end
