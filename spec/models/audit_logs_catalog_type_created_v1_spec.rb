...
# Unit tests for IncidentIoSdk::AuditLogsCatalogTypeCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsCatalogTypeCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsCatalogTypeCreatedV1.new }

  describe 'test an instance of AuditLogsCatalogTypeCreatedV1' do
    it 'should create an instance of AuditLogsCatalogTypeCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsCatalogTypeCreatedV1)
    end
  end
