...
# Unit tests for IncidentIoSdk::AuditLogsCatalogTypeDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsCatalogTypeDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsCatalogTypeDeletedV1.new }

  describe 'test an instance of AuditLogsCatalogTypeDeletedV1' do
    it 'should create an instance of AuditLogsCatalogTypeDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsCatalogTypeDeletedV1)
    end
  end
