...
# Unit tests for IncidentIoSdk::AuditLogsCatalogTypeUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsCatalogTypeUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsCatalogTypeUpdatedV1.new }

  describe 'test an instance of AuditLogsCatalogTypeUpdatedV1' do
    it 'should create an instance of AuditLogsCatalogTypeUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsCatalogTypeUpdatedV1)
    end
  end
