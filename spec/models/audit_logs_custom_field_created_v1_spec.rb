...
# Unit tests for IncidentIoSdk::AuditLogsCustomFieldCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsCustomFieldCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsCustomFieldCreatedV1.new }

  describe 'test an instance of AuditLogsCustomFieldCreatedV1' do
    it 'should create an instance of AuditLogsCustomFieldCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsCustomFieldCreatedV1)
    end
  end
