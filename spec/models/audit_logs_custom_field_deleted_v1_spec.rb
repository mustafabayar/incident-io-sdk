...
# Unit tests for IncidentIoSdk::AuditLogsCustomFieldDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsCustomFieldDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsCustomFieldDeletedV1.new }

  describe 'test an instance of AuditLogsCustomFieldDeletedV1' do
    it 'should create an instance of AuditLogsCustomFieldDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsCustomFieldDeletedV1)
    end
  end
