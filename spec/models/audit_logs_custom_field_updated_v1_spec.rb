...
# Unit tests for IncidentIoSdk::AuditLogsCustomFieldUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsCustomFieldUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsCustomFieldUpdatedV1.new }

  describe 'test an instance of AuditLogsCustomFieldUpdatedV1' do
    it 'should create an instance of AuditLogsCustomFieldUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsCustomFieldUpdatedV1)
    end
  end
