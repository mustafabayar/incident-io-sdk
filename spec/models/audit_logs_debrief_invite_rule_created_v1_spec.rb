...
# Unit tests for IncidentIoSdk::AuditLogsDebriefInviteRuleCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsDebriefInviteRuleCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsDebriefInviteRuleCreatedV1.new }

  describe 'test an instance of AuditLogsDebriefInviteRuleCreatedV1' do
    it 'should create an instance of AuditLogsDebriefInviteRuleCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsDebriefInviteRuleCreatedV1)
    end
  end
