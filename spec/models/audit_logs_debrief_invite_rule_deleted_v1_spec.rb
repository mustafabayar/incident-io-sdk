...
# Unit tests for IncidentIoSdk::AuditLogsDebriefInviteRuleDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsDebriefInviteRuleDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsDebriefInviteRuleDeletedV1.new }

  describe 'test an instance of AuditLogsDebriefInviteRuleDeletedV1' do
    it 'should create an instance of AuditLogsDebriefInviteRuleDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsDebriefInviteRuleDeletedV1)
    end
  end
