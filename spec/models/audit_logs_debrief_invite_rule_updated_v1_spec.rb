...
# Unit tests for IncidentIoSdk::AuditLogsDebriefInviteRuleUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsDebriefInviteRuleUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsDebriefInviteRuleUpdatedV1.new }

  describe 'test an instance of AuditLogsDebriefInviteRuleUpdatedV1' do
    it 'should create an instance of AuditLogsDebriefInviteRuleUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsDebriefInviteRuleUpdatedV1)
    end
  end
