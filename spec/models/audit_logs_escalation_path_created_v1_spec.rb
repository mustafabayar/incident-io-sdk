...
# Unit tests for IncidentIoSdk::AuditLogsEscalationPathCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsEscalationPathCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsEscalationPathCreatedV1.new }

  describe 'test an instance of AuditLogsEscalationPathCreatedV1' do
    it 'should create an instance of AuditLogsEscalationPathCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsEscalationPathCreatedV1)
    end
  end
