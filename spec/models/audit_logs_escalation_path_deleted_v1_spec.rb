...
# Unit tests for IncidentIoSdk::AuditLogsEscalationPathDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsEscalationPathDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsEscalationPathDeletedV1.new }

  describe 'test an instance of AuditLogsEscalationPathDeletedV1' do
    it 'should create an instance of AuditLogsEscalationPathDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsEscalationPathDeletedV1)
    end
  end
