...
# Unit tests for IncidentIoSdk::AuditLogsEscalationPathUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsEscalationPathUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsEscalationPathUpdatedV1.new }

  describe 'test an instance of AuditLogsEscalationPathUpdatedV1' do
    it 'should create an instance of AuditLogsEscalationPathUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsEscalationPathUpdatedV1)
    end
  end
