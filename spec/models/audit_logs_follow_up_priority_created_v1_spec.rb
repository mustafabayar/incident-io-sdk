...
# Unit tests for IncidentIoSdk::AuditLogsFollowUpPriorityCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsFollowUpPriorityCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsFollowUpPriorityCreatedV1.new }

  describe 'test an instance of AuditLogsFollowUpPriorityCreatedV1' do
    it 'should create an instance of AuditLogsFollowUpPriorityCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsFollowUpPriorityCreatedV1)
    end
  end
