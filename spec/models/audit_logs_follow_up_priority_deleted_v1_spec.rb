...
# Unit tests for IncidentIoSdk::AuditLogsFollowUpPriorityDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsFollowUpPriorityDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsFollowUpPriorityDeletedV1.new }

  describe 'test an instance of AuditLogsFollowUpPriorityDeletedV1' do
    it 'should create an instance of AuditLogsFollowUpPriorityDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsFollowUpPriorityDeletedV1)
    end
  end
