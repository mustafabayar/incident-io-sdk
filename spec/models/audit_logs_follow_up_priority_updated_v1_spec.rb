...
# Unit tests for IncidentIoSdk::AuditLogsFollowUpPriorityUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsFollowUpPriorityUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsFollowUpPriorityUpdatedV1.new }

  describe 'test an instance of AuditLogsFollowUpPriorityUpdatedV1' do
    it 'should create an instance of AuditLogsFollowUpPriorityUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsFollowUpPriorityUpdatedV1)
    end
  end
