...
# Unit tests for IncidentIoSdk::AuditLogsHolidayUserFeedCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsHolidayUserFeedCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsHolidayUserFeedCreatedV1.new }

  describe 'test an instance of AuditLogsHolidayUserFeedCreatedV1' do
    it 'should create an instance of AuditLogsHolidayUserFeedCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsHolidayUserFeedCreatedV1)
    end
  end
