...
# Unit tests for IncidentIoSdk::AuditLogsHolidayUserFeedDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsHolidayUserFeedDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsHolidayUserFeedDeletedV1.new }

  describe 'test an instance of AuditLogsHolidayUserFeedDeletedV1' do
    it 'should create an instance of AuditLogsHolidayUserFeedDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsHolidayUserFeedDeletedV1)
    end
  end
