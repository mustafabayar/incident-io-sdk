...
# Unit tests for IncidentIoSdk::AuditLogsHolidayUserFeedUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsHolidayUserFeedUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsHolidayUserFeedUpdatedV1.new }

  describe 'test an instance of AuditLogsHolidayUserFeedUpdatedV1' do
    it 'should create an instance of AuditLogsHolidayUserFeedUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsHolidayUserFeedUpdatedV1)
    end
  end
