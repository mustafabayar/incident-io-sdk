...
# Unit tests for IncidentIoSdk::AuditLogsIncidentCallSettingUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentCallSettingUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentCallSettingUpdatedV1.new }

  describe 'test an instance of AuditLogsIncidentCallSettingUpdatedV1' do
    it 'should create an instance of AuditLogsIncidentCallSettingUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentCallSettingUpdatedV1)
    end
  end
