...
# Unit tests for IncidentIoSdk::AuditLogsIncidentDurationMetricCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentDurationMetricCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentDurationMetricCreatedV1.new }

  describe 'test an instance of AuditLogsIncidentDurationMetricCreatedV1' do
    it 'should create an instance of AuditLogsIncidentDurationMetricCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentDurationMetricCreatedV1)
    end
  end
