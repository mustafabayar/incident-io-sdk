...
# Unit tests for IncidentIoSdk::AuditLogsIncidentDurationMetricDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentDurationMetricDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentDurationMetricDeletedV1.new }

  describe 'test an instance of AuditLogsIncidentDurationMetricDeletedV1' do
    it 'should create an instance of AuditLogsIncidentDurationMetricDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentDurationMetricDeletedV1)
    end
  end
