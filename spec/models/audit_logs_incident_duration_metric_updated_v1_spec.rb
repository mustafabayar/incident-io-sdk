...
# Unit tests for IncidentIoSdk::AuditLogsIncidentDurationMetricUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentDurationMetricUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentDurationMetricUpdatedV1.new }

  describe 'test an instance of AuditLogsIncidentDurationMetricUpdatedV1' do
    it 'should create an instance of AuditLogsIncidentDurationMetricUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentDurationMetricUpdatedV1)
    end
  end
