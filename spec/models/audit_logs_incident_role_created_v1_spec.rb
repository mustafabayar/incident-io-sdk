...
# Unit tests for IncidentIoSdk::AuditLogsIncidentRoleCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentRoleCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentRoleCreatedV1.new }

  describe 'test an instance of AuditLogsIncidentRoleCreatedV1' do
    it 'should create an instance of AuditLogsIncidentRoleCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentRoleCreatedV1)
    end
  end
