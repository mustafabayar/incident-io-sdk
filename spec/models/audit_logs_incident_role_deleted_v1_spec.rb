...
# Unit tests for IncidentIoSdk::AuditLogsIncidentRoleDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentRoleDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentRoleDeletedV1.new }

  describe 'test an instance of AuditLogsIncidentRoleDeletedV1' do
    it 'should create an instance of AuditLogsIncidentRoleDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentRoleDeletedV1)
    end
  end
