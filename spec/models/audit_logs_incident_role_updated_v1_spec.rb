...
# Unit tests for IncidentIoSdk::AuditLogsIncidentRoleUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentRoleUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentRoleUpdatedV1.new }

  describe 'test an instance of AuditLogsIncidentRoleUpdatedV1' do
    it 'should create an instance of AuditLogsIncidentRoleUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentRoleUpdatedV1)
    end
  end
