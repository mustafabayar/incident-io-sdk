...
# Unit tests for IncidentIoSdk::AuditLogsIncidentStatusCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentStatusCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentStatusCreatedV1.new }

  describe 'test an instance of AuditLogsIncidentStatusCreatedV1' do
    it 'should create an instance of AuditLogsIncidentStatusCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentStatusCreatedV1)
    end
  end
