...
# Unit tests for IncidentIoSdk::AuditLogsIncidentStatusDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentStatusDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentStatusDeletedV1.new }

  describe 'test an instance of AuditLogsIncidentStatusDeletedV1' do
    it 'should create an instance of AuditLogsIncidentStatusDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentStatusDeletedV1)
    end
  end
