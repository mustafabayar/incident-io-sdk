...
# Unit tests for IncidentIoSdk::AuditLogsIncidentStatusUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentStatusUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentStatusUpdatedV1.new }

  describe 'test an instance of AuditLogsIncidentStatusUpdatedV1' do
    it 'should create an instance of AuditLogsIncidentStatusUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentStatusUpdatedV1)
    end
  end
