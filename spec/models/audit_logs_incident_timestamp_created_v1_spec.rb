...
# Unit tests for IncidentIoSdk::AuditLogsIncidentTimestampCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentTimestampCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentTimestampCreatedV1.new }

  describe 'test an instance of AuditLogsIncidentTimestampCreatedV1' do
    it 'should create an instance of AuditLogsIncidentTimestampCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentTimestampCreatedV1)
    end
  end
