...
# Unit tests for IncidentIoSdk::AuditLogsIncidentTimestampDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentTimestampDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentTimestampDeletedV1.new }

  describe 'test an instance of AuditLogsIncidentTimestampDeletedV1' do
    it 'should create an instance of AuditLogsIncidentTimestampDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentTimestampDeletedV1)
    end
  end
