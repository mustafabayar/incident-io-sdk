...
# Unit tests for IncidentIoSdk::AuditLogsIncidentTimestampUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentTimestampUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentTimestampUpdatedV1.new }

  describe 'test an instance of AuditLogsIncidentTimestampUpdatedV1' do
    it 'should create an instance of AuditLogsIncidentTimestampUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentTimestampUpdatedV1)
    end
  end
