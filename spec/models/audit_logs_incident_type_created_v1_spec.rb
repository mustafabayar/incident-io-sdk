...
# Unit tests for IncidentIoSdk::AuditLogsIncidentTypeCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentTypeCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentTypeCreatedV1.new }

  describe 'test an instance of AuditLogsIncidentTypeCreatedV1' do
    it 'should create an instance of AuditLogsIncidentTypeCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentTypeCreatedV1)
    end
  end
