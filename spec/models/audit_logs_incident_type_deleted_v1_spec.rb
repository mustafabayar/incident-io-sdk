...
# Unit tests for IncidentIoSdk::AuditLogsIncidentTypeDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentTypeDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentTypeDeletedV1.new }

  describe 'test an instance of AuditLogsIncidentTypeDeletedV1' do
    it 'should create an instance of AuditLogsIncidentTypeDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentTypeDeletedV1)
    end
  end
