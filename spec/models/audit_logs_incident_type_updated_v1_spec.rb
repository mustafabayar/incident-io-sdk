...
# Unit tests for IncidentIoSdk::AuditLogsIncidentTypeUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIncidentTypeUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIncidentTypeUpdatedV1.new }

  describe 'test an instance of AuditLogsIncidentTypeUpdatedV1' do
    it 'should create an instance of AuditLogsIncidentTypeUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIncidentTypeUpdatedV1)
    end
  end
