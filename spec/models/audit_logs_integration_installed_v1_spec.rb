...
# Unit tests for IncidentIoSdk::AuditLogsIntegrationInstalledV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIntegrationInstalledV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIntegrationInstalledV1.new }

  describe 'test an instance of AuditLogsIntegrationInstalledV1' do
    it 'should create an instance of AuditLogsIntegrationInstalledV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIntegrationInstalledV1)
    end
  end
