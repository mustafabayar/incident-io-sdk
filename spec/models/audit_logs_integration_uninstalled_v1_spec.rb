...
# Unit tests for IncidentIoSdk::AuditLogsIntegrationUninstalledV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsIntegrationUninstalledV1 do
  let(:instance) { IncidentIoSdk::AuditLogsIntegrationUninstalledV1.new }

  describe 'test an instance of AuditLogsIntegrationUninstalledV1' do
    it 'should create an instance of AuditLogsIntegrationUninstalledV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsIntegrationUninstalledV1)
    end
  end
