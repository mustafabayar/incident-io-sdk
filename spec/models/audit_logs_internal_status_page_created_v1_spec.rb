...
# Unit tests for IncidentIoSdk::AuditLogsInternalStatusPageCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsInternalStatusPageCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsInternalStatusPageCreatedV1.new }

  describe 'test an instance of AuditLogsInternalStatusPageCreatedV1' do
    it 'should create an instance of AuditLogsInternalStatusPageCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsInternalStatusPageCreatedV1)
    end
  end
