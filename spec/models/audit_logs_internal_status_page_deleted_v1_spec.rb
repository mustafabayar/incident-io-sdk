...
# Unit tests for IncidentIoSdk::AuditLogsInternalStatusPageDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsInternalStatusPageDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsInternalStatusPageDeletedV1.new }

  describe 'test an instance of AuditLogsInternalStatusPageDeletedV1' do
    it 'should create an instance of AuditLogsInternalStatusPageDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsInternalStatusPageDeletedV1)
    end
  end
