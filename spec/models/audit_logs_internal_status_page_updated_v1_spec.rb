...
# Unit tests for IncidentIoSdk::AuditLogsInternalStatusPageUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsInternalStatusPageUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsInternalStatusPageUpdatedV1.new }

  describe 'test an instance of AuditLogsInternalStatusPageUpdatedV1' do
    it 'should create an instance of AuditLogsInternalStatusPageUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsInternalStatusPageUpdatedV1)
    end
  end
