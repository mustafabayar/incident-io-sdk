...
# Unit tests for IncidentIoSdk::AuditLogsNudgeCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsNudgeCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsNudgeCreatedV1.new }

  describe 'test an instance of AuditLogsNudgeCreatedV1' do
    it 'should create an instance of AuditLogsNudgeCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsNudgeCreatedV1)
    end
  end
