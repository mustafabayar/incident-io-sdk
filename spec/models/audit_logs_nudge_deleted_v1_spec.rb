...
# Unit tests for IncidentIoSdk::AuditLogsNudgeDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsNudgeDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsNudgeDeletedV1.new }

  describe 'test an instance of AuditLogsNudgeDeletedV1' do
    it 'should create an instance of AuditLogsNudgeDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsNudgeDeletedV1)
    end
  end
