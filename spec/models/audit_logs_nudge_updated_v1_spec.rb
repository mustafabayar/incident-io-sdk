...
# Unit tests for IncidentIoSdk::AuditLogsNudgeUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsNudgeUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsNudgeUpdatedV1.new }

  describe 'test an instance of AuditLogsNudgeUpdatedV1' do
    it 'should create an instance of AuditLogsNudgeUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsNudgeUpdatedV1)
    end
  end
