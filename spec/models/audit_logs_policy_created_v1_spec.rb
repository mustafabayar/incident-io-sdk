...
# Unit tests for IncidentIoSdk::AuditLogsPolicyCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPolicyCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPolicyCreatedV1.new }

  describe 'test an instance of AuditLogsPolicyCreatedV1' do
    it 'should create an instance of AuditLogsPolicyCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPolicyCreatedV1)
    end
  end
