...
# Unit tests for IncidentIoSdk::AuditLogsPolicyDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPolicyDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPolicyDeletedV1.new }

  describe 'test an instance of AuditLogsPolicyDeletedV1' do
    it 'should create an instance of AuditLogsPolicyDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPolicyDeletedV1)
    end
  end
