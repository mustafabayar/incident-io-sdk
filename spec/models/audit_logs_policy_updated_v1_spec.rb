...
# Unit tests for IncidentIoSdk::AuditLogsPolicyUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPolicyUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPolicyUpdatedV1.new }

  describe 'test an instance of AuditLogsPolicyUpdatedV1' do
    it 'should create an instance of AuditLogsPolicyUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPolicyUpdatedV1)
    end
  end
