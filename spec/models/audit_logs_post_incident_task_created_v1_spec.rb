...
# Unit tests for IncidentIoSdk::AuditLogsPostIncidentTaskCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostIncidentTaskCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostIncidentTaskCreatedV1.new }

  describe 'test an instance of AuditLogsPostIncidentTaskCreatedV1' do
    it 'should create an instance of AuditLogsPostIncidentTaskCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostIncidentTaskCreatedV1)
    end
  end
