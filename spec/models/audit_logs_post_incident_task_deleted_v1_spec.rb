...
# Unit tests for IncidentIoSdk::AuditLogsPostIncidentTaskDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostIncidentTaskDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostIncidentTaskDeletedV1.new }

  describe 'test an instance of AuditLogsPostIncidentTaskDeletedV1' do
    it 'should create an instance of AuditLogsPostIncidentTaskDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostIncidentTaskDeletedV1)
    end
  end
