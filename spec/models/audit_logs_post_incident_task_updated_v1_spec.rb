...
# Unit tests for IncidentIoSdk::AuditLogsPostIncidentTaskUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostIncidentTaskUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostIncidentTaskUpdatedV1.new }

  describe 'test an instance of AuditLogsPostIncidentTaskUpdatedV1' do
    it 'should create an instance of AuditLogsPostIncidentTaskUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostIncidentTaskUpdatedV1)
    end
  end
