...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemSectionCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemSectionCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemSectionCreatedV1.new }

  describe 'test an instance of AuditLogsPostmortemSectionCreatedV1' do
    it 'should create an instance of AuditLogsPostmortemSectionCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemSectionCreatedV1)
    end
  end
