...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemSectionCreatedV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemSectionCreatedV2 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemSectionCreatedV2.new }

  describe 'test an instance of AuditLogsPostmortemSectionCreatedV2' do
    it 'should create an instance of AuditLogsPostmortemSectionCreatedV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemSectionCreatedV2)
    end
  end
