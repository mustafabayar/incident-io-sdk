...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemSectionDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemSectionDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemSectionDeletedV1.new }

  describe 'test an instance of AuditLogsPostmortemSectionDeletedV1' do
    it 'should create an instance of AuditLogsPostmortemSectionDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemSectionDeletedV1)
    end
  end
