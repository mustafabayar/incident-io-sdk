...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemSectionDeletedV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemSectionDeletedV2 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemSectionDeletedV2.new }

  describe 'test an instance of AuditLogsPostmortemSectionDeletedV2' do
    it 'should create an instance of AuditLogsPostmortemSectionDeletedV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemSectionDeletedV2)
    end
  end
