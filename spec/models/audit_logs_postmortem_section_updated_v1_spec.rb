...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemSectionUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemSectionUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemSectionUpdatedV1.new }

  describe 'test an instance of AuditLogsPostmortemSectionUpdatedV1' do
    it 'should create an instance of AuditLogsPostmortemSectionUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemSectionUpdatedV1)
    end
  end
