...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemSectionUpdatedV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemSectionUpdatedV2 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemSectionUpdatedV2.new }

  describe 'test an instance of AuditLogsPostmortemSectionUpdatedV2' do
    it 'should create an instance of AuditLogsPostmortemSectionUpdatedV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemSectionUpdatedV2)
    end
  end
