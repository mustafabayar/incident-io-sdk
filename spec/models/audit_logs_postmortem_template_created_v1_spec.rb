...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemTemplateCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemTemplateCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemTemplateCreatedV1.new }

  describe 'test an instance of AuditLogsPostmortemTemplateCreatedV1' do
    it 'should create an instance of AuditLogsPostmortemTemplateCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemTemplateCreatedV1)
    end
  end
