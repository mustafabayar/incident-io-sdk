...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemTemplateCreatedV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemTemplateCreatedV2 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemTemplateCreatedV2.new }

  describe 'test an instance of AuditLogsPostmortemTemplateCreatedV2' do
    it 'should create an instance of AuditLogsPostmortemTemplateCreatedV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemTemplateCreatedV2)
    end
  end
