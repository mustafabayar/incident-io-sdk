...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemTemplateDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemTemplateDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemTemplateDeletedV1.new }

  describe 'test an instance of AuditLogsPostmortemTemplateDeletedV1' do
    it 'should create an instance of AuditLogsPostmortemTemplateDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemTemplateDeletedV1)
    end
  end
