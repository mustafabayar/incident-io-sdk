...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemTemplateDeletedV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemTemplateDeletedV2 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemTemplateDeletedV2.new }

  describe 'test an instance of AuditLogsPostmortemTemplateDeletedV2' do
    it 'should create an instance of AuditLogsPostmortemTemplateDeletedV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemTemplateDeletedV2)
    end
  end
