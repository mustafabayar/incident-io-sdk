...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemTemplateUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemTemplateUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemTemplateUpdatedV1.new }

  describe 'test an instance of AuditLogsPostmortemTemplateUpdatedV1' do
    it 'should create an instance of AuditLogsPostmortemTemplateUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemTemplateUpdatedV1)
    end
  end
