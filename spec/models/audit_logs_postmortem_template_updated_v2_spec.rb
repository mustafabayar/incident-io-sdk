...
# Unit tests for IncidentIoSdk::AuditLogsPostmortemTemplateUpdatedV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPostmortemTemplateUpdatedV2 do
  let(:instance) { IncidentIoSdk::AuditLogsPostmortemTemplateUpdatedV2.new }

  describe 'test an instance of AuditLogsPostmortemTemplateUpdatedV2' do
    it 'should create an instance of AuditLogsPostmortemTemplateUpdatedV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPostmortemTemplateUpdatedV2)
    end
  end
