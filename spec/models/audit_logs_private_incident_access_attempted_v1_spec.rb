...
# Unit tests for IncidentIoSdk::AuditLogsPrivateIncidentAccessAttemptedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPrivateIncidentAccessAttemptedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPrivateIncidentAccessAttemptedV1.new }

  describe 'test an instance of AuditLogsPrivateIncidentAccessAttemptedV1' do
    it 'should create an instance of AuditLogsPrivateIncidentAccessAttemptedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPrivateIncidentAccessAttemptedV1)
    end
  end
