...
# Unit tests for IncidentIoSdk::AuditLogsPrivateIncidentAccessRequestedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPrivateIncidentAccessRequestedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPrivateIncidentAccessRequestedV1.new }

  describe 'test an instance of AuditLogsPrivateIncidentAccessRequestedV1' do
    it 'should create an instance of AuditLogsPrivateIncidentAccessRequestedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPrivateIncidentAccessRequestedV1)
    end
  end
