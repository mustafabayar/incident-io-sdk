...
# Unit tests for IncidentIoSdk::AuditLogsPrivateIncidentMembershipGrantedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPrivateIncidentMembershipGrantedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPrivateIncidentMembershipGrantedV1.new }

  describe 'test an instance of AuditLogsPrivateIncidentMembershipGrantedV1' do
    it 'should create an instance of AuditLogsPrivateIncidentMembershipGrantedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPrivateIncidentMembershipGrantedV1)
    end
  end
