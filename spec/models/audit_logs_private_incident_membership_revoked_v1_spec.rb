...
# Unit tests for IncidentIoSdk::AuditLogsPrivateIncidentMembershipRevokedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsPrivateIncidentMembershipRevokedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsPrivateIncidentMembershipRevokedV1.new }

  describe 'test an instance of AuditLogsPrivateIncidentMembershipRevokedV1' do
    it 'should create an instance of AuditLogsPrivateIncidentMembershipRevokedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsPrivateIncidentMembershipRevokedV1)
    end
  end
