...
# Unit tests for IncidentIoSdk::AuditLogsRbacRoleCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsRbacRoleCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsRbacRoleCreatedV1.new }

  describe 'test an instance of AuditLogsRbacRoleCreatedV1' do
    it 'should create an instance of AuditLogsRbacRoleCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsRbacRoleCreatedV1)
    end
  end
