...
# Unit tests for IncidentIoSdk::AuditLogsRbacRoleDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsRbacRoleDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsRbacRoleDeletedV1.new }

  describe 'test an instance of AuditLogsRbacRoleDeletedV1' do
    it 'should create an instance of AuditLogsRbacRoleDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsRbacRoleDeletedV1)
    end
  end
