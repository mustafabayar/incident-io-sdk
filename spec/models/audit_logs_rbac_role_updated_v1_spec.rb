...
# Unit tests for IncidentIoSdk::AuditLogsRbacRoleUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsRbacRoleUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsRbacRoleUpdatedV1.new }

  describe 'test an instance of AuditLogsRbacRoleUpdatedV1' do
    it 'should create an instance of AuditLogsRbacRoleUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsRbacRoleUpdatedV1)
    end
  end
