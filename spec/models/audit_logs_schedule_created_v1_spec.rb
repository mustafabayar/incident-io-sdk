...
# Unit tests for IncidentIoSdk::AuditLogsScheduleCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsScheduleCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsScheduleCreatedV1.new }

  describe 'test an instance of AuditLogsScheduleCreatedV1' do
    it 'should create an instance of AuditLogsScheduleCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsScheduleCreatedV1)
    end
  end
