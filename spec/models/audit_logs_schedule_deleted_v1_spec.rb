...
# Unit tests for IncidentIoSdk::AuditLogsScheduleDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsScheduleDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsScheduleDeletedV1.new }

  describe 'test an instance of AuditLogsScheduleDeletedV1' do
    it 'should create an instance of AuditLogsScheduleDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsScheduleDeletedV1)
    end
  end
