...
# Unit tests for IncidentIoSdk::AuditLogsScheduleOverrideCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsScheduleOverrideCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsScheduleOverrideCreatedV1.new }

  describe 'test an instance of AuditLogsScheduleOverrideCreatedV1' do
    it 'should create an instance of AuditLogsScheduleOverrideCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsScheduleOverrideCreatedV1)
    end
  end
