...
# Unit tests for IncidentIoSdk::AuditLogsScheduleOverrideDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsScheduleOverrideDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsScheduleOverrideDeletedV1.new }

  describe 'test an instance of AuditLogsScheduleOverrideDeletedV1' do
    it 'should create an instance of AuditLogsScheduleOverrideDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsScheduleOverrideDeletedV1)
    end
  end
