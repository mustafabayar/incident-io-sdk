...
# Unit tests for IncidentIoSdk::AuditLogsScheduleOverrideUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsScheduleOverrideUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsScheduleOverrideUpdatedV1.new }

  describe 'test an instance of AuditLogsScheduleOverrideUpdatedV1' do
    it 'should create an instance of AuditLogsScheduleOverrideUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsScheduleOverrideUpdatedV1)
    end
  end
