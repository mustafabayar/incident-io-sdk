...
# Unit tests for IncidentIoSdk::AuditLogsScheduleUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsScheduleUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsScheduleUpdatedV1.new }

  describe 'test an instance of AuditLogsScheduleUpdatedV1' do
    it 'should create an instance of AuditLogsScheduleUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsScheduleUpdatedV1)
    end
  end
