...
# Unit tests for IncidentIoSdk::AuditLogsScimGroupRoleMappingsUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsScimGroupRoleMappingsUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsScimGroupRoleMappingsUpdatedV1.new }

  describe 'test an instance of AuditLogsScimGroupRoleMappingsUpdatedV1' do
    it 'should create an instance of AuditLogsScimGroupRoleMappingsUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsScimGroupRoleMappingsUpdatedV1)
    end
  end
