...
# Unit tests for IncidentIoSdk::AuditLogsSeverityCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsSeverityCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsSeverityCreatedV1.new }

  describe 'test an instance of AuditLogsSeverityCreatedV1' do
    it 'should create an instance of AuditLogsSeverityCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsSeverityCreatedV1)
    end
  end
