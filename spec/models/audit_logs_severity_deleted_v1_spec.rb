...
# Unit tests for IncidentIoSdk::AuditLogsSeverityDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsSeverityDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsSeverityDeletedV1.new }

  describe 'test an instance of AuditLogsSeverityDeletedV1' do
    it 'should create an instance of AuditLogsSeverityDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsSeverityDeletedV1)
    end
  end
