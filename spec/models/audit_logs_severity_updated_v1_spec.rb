...
# Unit tests for IncidentIoSdk::AuditLogsSeverityUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsSeverityUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsSeverityUpdatedV1.new }

  describe 'test an instance of AuditLogsSeverityUpdatedV1' do
    it 'should create an instance of AuditLogsSeverityUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsSeverityUpdatedV1)
    end
  end
