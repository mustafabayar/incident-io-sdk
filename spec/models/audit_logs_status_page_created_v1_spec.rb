...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageCreatedV1.new }

  describe 'test an instance of AuditLogsStatusPageCreatedV1' do
    it 'should create an instance of AuditLogsStatusPageCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageCreatedV1)
    end
  end
