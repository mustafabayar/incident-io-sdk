...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageDeletedV1.new }

  describe 'test an instance of AuditLogsStatusPageDeletedV1' do
    it 'should create an instance of AuditLogsStatusPageDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageDeletedV1)
    end
  end
