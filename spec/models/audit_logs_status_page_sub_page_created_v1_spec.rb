...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageSubPageCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageSubPageCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageSubPageCreatedV1.new }

  describe 'test an instance of AuditLogsStatusPageSubPageCreatedV1' do
    it 'should create an instance of AuditLogsStatusPageSubPageCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageSubPageCreatedV1)
    end
  end
