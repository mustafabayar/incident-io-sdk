...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageSubPageDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageSubPageDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageSubPageDeletedV1.new }

  describe 'test an instance of AuditLogsStatusPageSubPageDeletedV1' do
    it 'should create an instance of AuditLogsStatusPageSubPageDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageSubPageDeletedV1)
    end
  end
