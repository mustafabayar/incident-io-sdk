...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageSubPageUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageSubPageUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageSubPageUpdatedV1.new }

  describe 'test an instance of AuditLogsStatusPageSubPageUpdatedV1' do
    it 'should create an instance of AuditLogsStatusPageSubPageUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageSubPageUpdatedV1)
    end
  end
