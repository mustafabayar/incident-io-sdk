...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageTemplateCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageTemplateCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageTemplateCreatedV1.new }

  describe 'test an instance of AuditLogsStatusPageTemplateCreatedV1' do
    it 'should create an instance of AuditLogsStatusPageTemplateCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageTemplateCreatedV1)
    end
  end
