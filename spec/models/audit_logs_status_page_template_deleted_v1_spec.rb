...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageTemplateDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageTemplateDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageTemplateDeletedV1.new }

  describe 'test an instance of AuditLogsStatusPageTemplateDeletedV1' do
    it 'should create an instance of AuditLogsStatusPageTemplateDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageTemplateDeletedV1)
    end
  end
