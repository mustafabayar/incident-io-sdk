...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageTemplateUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageTemplateUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageTemplateUpdatedV1.new }

  describe 'test an instance of AuditLogsStatusPageTemplateUpdatedV1' do
    it 'should create an instance of AuditLogsStatusPageTemplateUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageTemplateUpdatedV1)
    end
  end
