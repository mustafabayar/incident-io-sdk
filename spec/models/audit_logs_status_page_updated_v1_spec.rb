...
# Unit tests for IncidentIoSdk::AuditLogsStatusPageUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsStatusPageUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsStatusPageUpdatedV1.new }

  describe 'test an instance of AuditLogsStatusPageUpdatedV1' do
    it 'should create an instance of AuditLogsStatusPageUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsStatusPageUpdatedV1)
    end
  end
