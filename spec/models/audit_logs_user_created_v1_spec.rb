...
# Unit tests for IncidentIoSdk::AuditLogsUserCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsUserCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsUserCreatedV1.new }

  describe 'test an instance of AuditLogsUserCreatedV1' do
    it 'should create an instance of AuditLogsUserCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsUserCreatedV1)
    end
  end
