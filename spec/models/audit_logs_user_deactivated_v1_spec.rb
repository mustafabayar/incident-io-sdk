...
# Unit tests for IncidentIoSdk::AuditLogsUserDeactivatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsUserDeactivatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsUserDeactivatedV1.new }

  describe 'test an instance of AuditLogsUserDeactivatedV1' do
    it 'should create an instance of AuditLogsUserDeactivatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsUserDeactivatedV1)
    end
  end
