...
# Unit tests for IncidentIoSdk::AuditLogsUserReinstatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsUserReinstatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsUserReinstatedV1.new }

  describe 'test an instance of AuditLogsUserReinstatedV1' do
    it 'should create an instance of AuditLogsUserReinstatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsUserReinstatedV1)
    end
  end
