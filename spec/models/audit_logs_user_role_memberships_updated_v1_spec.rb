...
# Unit tests for IncidentIoSdk::AuditLogsUserRoleMembershipsUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsUserRoleMembershipsUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsUserRoleMembershipsUpdatedV1.new }

  describe 'test an instance of AuditLogsUserRoleMembershipsUpdatedV1' do
    it 'should create an instance of AuditLogsUserRoleMembershipsUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsUserRoleMembershipsUpdatedV1)
    end
  end
