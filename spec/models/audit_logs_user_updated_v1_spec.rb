...
# Unit tests for IncidentIoSdk::AuditLogsUserUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsUserUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsUserUpdatedV1.new }

  describe 'test an instance of AuditLogsUserUpdatedV1' do
    it 'should create an instance of AuditLogsUserUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsUserUpdatedV1)
    end
  end
