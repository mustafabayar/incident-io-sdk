...
# Unit tests for IncidentIoSdk::AuditLogsWorkflowCreatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsWorkflowCreatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsWorkflowCreatedV1.new }

  describe 'test an instance of AuditLogsWorkflowCreatedV1' do
    it 'should create an instance of AuditLogsWorkflowCreatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsWorkflowCreatedV1)
    end
  end
