...
# Unit tests for IncidentIoSdk::AuditLogsWorkflowDeletedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsWorkflowDeletedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsWorkflowDeletedV1.new }

  describe 'test an instance of AuditLogsWorkflowDeletedV1' do
    it 'should create an instance of AuditLogsWorkflowDeletedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsWorkflowDeletedV1)
    end
  end
