...
# Unit tests for IncidentIoSdk::AuditLogsWorkflowUpdatedV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::AuditLogsWorkflowUpdatedV1 do
  let(:instance) { IncidentIoSdk::AuditLogsWorkflowUpdatedV1.new }

  describe 'test an instance of AuditLogsWorkflowUpdatedV1' do
    it 'should create an instance of AuditLogsWorkflowUpdatedV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::AuditLogsWorkflowUpdatedV1)
    end
  end
