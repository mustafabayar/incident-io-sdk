...
# Unit tests for IncidentIoSdk::CatalogCreateEntryPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogCreateEntryPayloadV2 do
  let(:instance) { IncidentIoSdk::CatalogCreateEntryPayloadV2.new }

  describe 'test an instance of CatalogCreateEntryPayloadV2' do
    it 'should create an instance of CatalogCreateEntryPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogCreateEntryPayloadV2)
    end
  end
