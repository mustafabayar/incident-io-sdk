...
# Unit tests for IncidentIoSdk::CatalogCreateEntryPayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogCreateEntryPayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogCreateEntryPayloadV3.new }

  describe 'test an instance of CatalogCreateEntryPayloadV3' do
    it 'should create an instance of CatalogCreateEntryPayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogCreateEntryPayloadV3)
    end
  end
