...
# Unit tests for IncidentIoSdk::CatalogCreateEntryResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogCreateEntryResultV2 do
  let(:instance) { IncidentIoSdk::CatalogCreateEntryResultV2.new }

  describe 'test an instance of CatalogCreateEntryResultV2' do
    it 'should create an instance of CatalogCreateEntryResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogCreateEntryResultV2)
    end
  end
