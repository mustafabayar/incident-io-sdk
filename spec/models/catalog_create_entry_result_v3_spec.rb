...
# Unit tests for IncidentIoSdk::CatalogCreateEntryResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogCreateEntryResultV3 do
  let(:instance) { IncidentIoSdk::CatalogCreateEntryResultV3.new }

  describe 'test an instance of CatalogCreateEntryResultV3' do
    it 'should create an instance of CatalogCreateEntryResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogCreateEntryResultV3)
    end
  end
