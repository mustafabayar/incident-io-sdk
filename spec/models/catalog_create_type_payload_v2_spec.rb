...
# Unit tests for IncidentIoSdk::CatalogCreateTypePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogCreateTypePayloadV2 do
  let(:instance) { IncidentIoSdk::CatalogCreateTypePayloadV2.new }

  describe 'test an instance of CatalogCreateTypePayloadV2' do
    it 'should create an instance of CatalogCreateTypePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogCreateTypePayloadV2)
    end
  end
