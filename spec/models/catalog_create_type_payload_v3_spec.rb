...
# Unit tests for IncidentIoSdk::CatalogCreateTypePayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogCreateTypePayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogCreateTypePayloadV3.new }

  describe 'test an instance of CatalogCreateTypePayloadV3' do
    it 'should create an instance of CatalogCreateTypePayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogCreateTypePayloadV3)
    end
  end
