...
# Unit tests for IncidentIoSdk::CatalogCreateTypeResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogCreateTypeResultV2 do
  let(:instance) { IncidentIoSdk::CatalogCreateTypeResultV2.new }

  describe 'test an instance of CatalogCreateTypeResultV2' do
    it 'should create an instance of CatalogCreateTypeResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogCreateTypeResultV2)
    end
  end
