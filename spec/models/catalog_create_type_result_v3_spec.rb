...
# Unit tests for IncidentIoSdk::CatalogCreateTypeResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogCreateTypeResultV3 do
  let(:instance) { IncidentIoSdk::CatalogCreateTypeResultV3.new }

  describe 'test an instance of CatalogCreateTypeResultV3' do
    it 'should create an instance of CatalogCreateTypeResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogCreateTypeResultV3)
    end
  end
