...
# Unit tests for IncidentIoSdk::CatalogEngineParamBindingPayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEngineParamBindingPayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogEngineParamBindingPayloadV3.new }

  describe 'test an instance of CatalogEngineParamBindingPayloadV3' do
    it 'should create an instance of CatalogEngineParamBindingPayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEngineParamBindingPayloadV3)
    end
  end
