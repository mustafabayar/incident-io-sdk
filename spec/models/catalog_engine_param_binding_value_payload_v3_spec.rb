...
# Unit tests for IncidentIoSdk::CatalogEngineParamBindingValuePayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEngineParamBindingValuePayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogEngineParamBindingValuePayloadV3.new }

  describe 'test an instance of CatalogEngineParamBindingValuePayloadV3' do
    it 'should create an instance of CatalogEngineParamBindingValuePayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEngineParamBindingValuePayloadV3)
    end
  end
