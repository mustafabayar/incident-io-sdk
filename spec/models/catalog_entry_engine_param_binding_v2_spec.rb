...
# Unit tests for IncidentIoSdk::CatalogEntryEngineParamBindingV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEntryEngineParamBindingV2 do
  let(:instance) { IncidentIoSdk::CatalogEntryEngineParamBindingV2.new }

  describe 'test an instance of CatalogEntryEngineParamBindingV2' do
    it 'should create an instance of CatalogEntryEngineParamBindingV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEntryEngineParamBindingV2)
    end
  end
