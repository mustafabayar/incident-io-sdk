...
# Unit tests for IncidentIoSdk::CatalogEntryEngineParamBindingV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEntryEngineParamBindingV3 do
  let(:instance) { IncidentIoSdk::CatalogEntryEngineParamBindingV3.new }

  describe 'test an instance of CatalogEntryEngineParamBindingV3' do
    it 'should create an instance of CatalogEntryEngineParamBindingV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEntryEngineParamBindingV3)
    end
  end
