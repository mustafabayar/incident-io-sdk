...
# Unit tests for IncidentIoSdk::CatalogEntryEngineParamBindingValueV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEntryEngineParamBindingValueV2 do
  let(:instance) { IncidentIoSdk::CatalogEntryEngineParamBindingValueV2.new }

  describe 'test an instance of CatalogEntryEngineParamBindingValueV2' do
    it 'should create an instance of CatalogEntryEngineParamBindingValueV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEntryEngineParamBindingValueV2)
    end
  end

  describe 'test attribute "catalog_entry"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "helptext"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "is_image_slack_icon"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "literal"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
