...
# Unit tests for IncidentIoSdk::CatalogEntryEngineParamBindingValueV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEntryEngineParamBindingValueV3 do
  let(:instance) { IncidentIoSdk::CatalogEntryEngineParamBindingValueV3.new }

  describe 'test an instance of CatalogEntryEngineParamBindingValueV3' do
    it 'should create an instance of CatalogEntryEngineParamBindingValueV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEntryEngineParamBindingValueV3)
    end
  end
