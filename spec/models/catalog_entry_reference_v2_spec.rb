...
# Unit tests for IncidentIoSdk::CatalogEntryReferenceV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEntryReferenceV2 do
  let(:instance) { IncidentIoSdk::CatalogEntryReferenceV2.new }

  describe 'test an instance of CatalogEntryReferenceV2' do
    it 'should create an instance of CatalogEntryReferenceV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEntryReferenceV2)
    end
  end
  ...
  describe 'test attribute "catalog_entry_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "catalog_entry_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
