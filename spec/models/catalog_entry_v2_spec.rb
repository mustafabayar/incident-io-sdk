...
# Unit tests for IncidentIoSdk::CatalogEntryV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEntryV2 do
  let(:instance) { IncidentIoSdk::CatalogEntryV2.new }

  describe 'test an instance of CatalogEntryV2' do
    it 'should create an instance of CatalogEntryV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEntryV2)
    end
  end
