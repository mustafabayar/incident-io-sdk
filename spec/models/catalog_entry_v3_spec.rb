...
# Unit tests for IncidentIoSdk::CatalogEntryV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogEntryV3 do
  let(:instance) { IncidentIoSdk::CatalogEntryV3.new }

  describe 'test an instance of CatalogEntryV3' do
    it 'should create an instance of CatalogEntryV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogEntryV3)
    end
  end
