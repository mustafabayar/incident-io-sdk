...
# Unit tests for IncidentIoSdk::CatalogListEntriesResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogListEntriesResultV2 do
  let(:instance) { IncidentIoSdk::CatalogListEntriesResultV2.new }

  describe 'test an instance of CatalogListEntriesResultV2' do
    it 'should create an instance of CatalogListEntriesResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogListEntriesResultV2)
    end
  end

  describe 'test attribute "catalog_entries"' do
    it 'should work' do
