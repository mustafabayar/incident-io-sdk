...
# Unit tests for IncidentIoSdk::CatalogListEntriesResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogListEntriesResultV3 do
  let(:instance) { IncidentIoSdk::CatalogListEntriesResultV3.new }

  describe 'test an instance of CatalogListEntriesResultV3' do
    it 'should create an instance of CatalogListEntriesResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogListEntriesResultV3)
    end
  end
