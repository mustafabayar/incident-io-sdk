...
# Unit tests for IncidentIoSdk::CatalogListResourcesResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogListResourcesResultV2 do
  let(:instance) { IncidentIoSdk::CatalogListResourcesResultV2.new }

  describe 'test an instance of CatalogListResourcesResultV2' do
    it 'should create an instance of CatalogListResourcesResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogListResourcesResultV2)
    end
  end
