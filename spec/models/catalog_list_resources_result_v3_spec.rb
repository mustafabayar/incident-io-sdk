...
# Unit tests for IncidentIoSdk::CatalogListResourcesResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogListResourcesResultV3 do
  let(:instance) { IncidentIoSdk::CatalogListResourcesResultV3.new }

  describe 'test an instance of CatalogListResourcesResultV3' do
    it 'should create an instance of CatalogListResourcesResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogListResourcesResultV3)
    end
  end
