...
# Unit tests for IncidentIoSdk::CatalogListTypesResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogListTypesResultV2 do
  let(:instance) { IncidentIoSdk::CatalogListTypesResultV2.new }

  describe 'test an instance of CatalogListTypesResultV2' do
    it 'should create an instance of CatalogListTypesResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogListTypesResultV2)
    end
  end

  describe 'test attribute "catalog_types"' do
    it 'should work' do
