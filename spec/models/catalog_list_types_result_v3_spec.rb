...
# Unit tests for IncidentIoSdk::CatalogListTypesResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogListTypesResultV3 do
  let(:instance) { IncidentIoSdk::CatalogListTypesResultV3.new }

  describe 'test an instance of CatalogListTypesResultV3' do
    it 'should create an instance of CatalogListTypesResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogListTypesResultV3)
    end
  end
