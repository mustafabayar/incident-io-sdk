...
# Unit tests for IncidentIoSdk::CatalogResourceV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogResourceV2 do
  let(:instance) { IncidentIoSdk::CatalogResourceV2.new }

  describe 'test an instance of CatalogResourceV2' do
    it 'should create an instance of CatalogResourceV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogResourceV2)
    end
  end
  ...
  describe 'test attribute "category"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["primitive", "custom", "external"])
  ...
  describe 'test attribute "value_docstring"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
