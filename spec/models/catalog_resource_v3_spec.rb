...
# Unit tests for IncidentIoSdk::CatalogResourceV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogResourceV3 do
  let(:instance) { IncidentIoSdk::CatalogResourceV3.new }

  describe 'test an instance of CatalogResourceV3' do
    it 'should create an instance of CatalogResourceV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogResourceV3)
    end
  end
