...
# Unit tests for IncidentIoSdk::CatalogShowEntryResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogShowEntryResultV2 do
  let(:instance) { IncidentIoSdk::CatalogShowEntryResultV2.new }

  describe 'test an instance of CatalogShowEntryResultV2' do
    it 'should create an instance of CatalogShowEntryResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogShowEntryResultV2)
    end
  end
