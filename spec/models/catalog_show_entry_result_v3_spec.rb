...
# Unit tests for IncidentIoSdk::CatalogShowEntryResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogShowEntryResultV3 do
  let(:instance) { IncidentIoSdk::CatalogShowEntryResultV3.new }

  describe 'test an instance of CatalogShowEntryResultV3' do
    it 'should create an instance of CatalogShowEntryResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogShowEntryResultV3)
    end
  end
