...
# Unit tests for IncidentIoSdk::CatalogShowTypeResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogShowTypeResultV2 do
  let(:instance) { IncidentIoSdk::CatalogShowTypeResultV2.new }

  describe 'test an instance of CatalogShowTypeResultV2' do
    it 'should create an instance of CatalogShowTypeResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogShowTypeResultV2)
    end
  end
