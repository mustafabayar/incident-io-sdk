...
# Unit tests for IncidentIoSdk::CatalogShowTypeResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogShowTypeResultV3 do
  let(:instance) { IncidentIoSdk::CatalogShowTypeResultV3.new }

  describe 'test an instance of CatalogShowTypeResultV3' do
    it 'should create an instance of CatalogShowTypeResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogShowTypeResultV3)
    end
  end
