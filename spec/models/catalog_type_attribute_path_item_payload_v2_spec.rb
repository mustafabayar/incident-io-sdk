...
# Unit tests for IncidentIoSdk::CatalogTypeAttributePathItemPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeAttributePathItemPayloadV2 do
  let(:instance) { IncidentIoSdk::CatalogTypeAttributePathItemPayloadV2.new }

  describe 'test an instance of CatalogTypeAttributePathItemPayloadV2' do
    it 'should create an instance of CatalogTypeAttributePathItemPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeAttributePathItemPayloadV2)
    end
  end
