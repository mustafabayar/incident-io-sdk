...
# Unit tests for IncidentIoSdk::CatalogTypeAttributePathItemPayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeAttributePathItemPayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogTypeAttributePathItemPayloadV3.new }

  describe 'test an instance of CatalogTypeAttributePathItemPayloadV3' do
    it 'should create an instance of CatalogTypeAttributePathItemPayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeAttributePathItemPayloadV3)
    end
  end
