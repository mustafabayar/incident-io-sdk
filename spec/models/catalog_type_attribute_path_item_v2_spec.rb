...
# Unit tests for IncidentIoSdk::CatalogTypeAttributePathItemV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeAttributePathItemV2 do
  let(:instance) { IncidentIoSdk::CatalogTypeAttributePathItemV2.new }

  describe 'test an instance of CatalogTypeAttributePathItemV2' do
    it 'should create an instance of CatalogTypeAttributePathItemV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeAttributePathItemV2)
    end
  end
