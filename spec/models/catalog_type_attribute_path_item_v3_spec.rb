...
# Unit tests for IncidentIoSdk::CatalogTypeAttributePathItemV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeAttributePathItemV3 do
  let(:instance) { IncidentIoSdk::CatalogTypeAttributePathItemV3.new }

  describe 'test an instance of CatalogTypeAttributePathItemV3' do
    it 'should create an instance of CatalogTypeAttributePathItemV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeAttributePathItemV3)
    end
  end
