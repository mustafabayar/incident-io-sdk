...
# Unit tests for IncidentIoSdk::CatalogTypeAttributePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeAttributePayloadV2 do
  let(:instance) { IncidentIoSdk::CatalogTypeAttributePayloadV2.new }

  describe 'test an instance of CatalogTypeAttributePayloadV2' do
    it 'should create an instance of CatalogTypeAttributePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeAttributePayloadV2)
    end
  end
  ...
  describe 'test attribute "mode"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["", "manual", "external", "internal", "dynamic", "backlink", "path"])
