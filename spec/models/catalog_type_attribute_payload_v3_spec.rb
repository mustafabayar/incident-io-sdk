...
# Unit tests for IncidentIoSdk::CatalogTypeAttributePayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeAttributePayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogTypeAttributePayloadV3.new }

  describe 'test an instance of CatalogTypeAttributePayloadV3' do
    it 'should create an instance of CatalogTypeAttributePayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeAttributePayloadV3)
    end
  end
  ...
  describe 'test attribute "backlink_attribute"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "mode"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["", "api", "dashboard", "external", "internal", "dynamic", "backlink", "path"])
