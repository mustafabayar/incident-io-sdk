...
# Unit tests for IncidentIoSdk::CatalogTypeAttributeV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeAttributeV2 do
  let(:instance) { IncidentIoSdk::CatalogTypeAttributeV2.new }

  describe 'test an instance of CatalogTypeAttributeV2' do
    it 'should create an instance of CatalogTypeAttributeV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeAttributeV2)
    end
  end
