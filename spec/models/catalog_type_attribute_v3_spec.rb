...
# Unit tests for IncidentIoSdk::CatalogTypeAttributeV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeAttributeV3 do
  let(:instance) { IncidentIoSdk::CatalogTypeAttributeV3.new }

  describe 'test an instance of CatalogTypeAttributeV3' do
    it 'should create an instance of CatalogTypeAttributeV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeAttributeV3)
    end
  end
