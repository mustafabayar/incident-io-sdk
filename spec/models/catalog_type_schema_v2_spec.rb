...
# Unit tests for IncidentIoSdk::CatalogTypeSchemaV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeSchemaV2 do
  let(:instance) { IncidentIoSdk::CatalogTypeSchemaV2.new }

  describe 'test an instance of CatalogTypeSchemaV2' do
    it 'should create an instance of CatalogTypeSchemaV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeSchemaV2)
    end
  end
