...
# Unit tests for IncidentIoSdk::CatalogTypeSchemaV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeSchemaV3 do
  let(:instance) { IncidentIoSdk::CatalogTypeSchemaV3.new }

  describe 'test an instance of CatalogTypeSchemaV3' do
    it 'should create an instance of CatalogTypeSchemaV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeSchemaV3)
    end
  end
