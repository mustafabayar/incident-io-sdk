...
# Unit tests for IncidentIoSdk::CatalogTypeV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogTypeV3 do
  let(:instance) { IncidentIoSdk::CatalogTypeV3.new }

  describe 'test an instance of CatalogTypeV3' do
    it 'should create an instance of CatalogTypeV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogTypeV3)
    end
  end
