...
# Unit tests for IncidentIoSdk::CatalogUpdateEntryPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateEntryPayloadV2 do
  let(:instance) { IncidentIoSdk::CatalogUpdateEntryPayloadV2.new }

  describe 'test an instance of CatalogUpdateEntryPayloadV2' do
    it 'should create an instance of CatalogUpdateEntryPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateEntryPayloadV2)
    end
  end
