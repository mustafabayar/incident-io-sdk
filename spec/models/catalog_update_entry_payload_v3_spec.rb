...
# Unit tests for IncidentIoSdk::CatalogUpdateEntryPayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateEntryPayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogUpdateEntryPayloadV3.new }

  describe 'test an instance of CatalogUpdateEntryPayloadV3' do
    it 'should create an instance of CatalogUpdateEntryPayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateEntryPayloadV3)
    end
  end
  ...
  describe 'test attribute "update_attributes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
