...
# Unit tests for IncidentIoSdk::CatalogUpdateEntryResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateEntryResultV2 do
  let(:instance) { IncidentIoSdk::CatalogUpdateEntryResultV2.new }

  describe 'test an instance of CatalogUpdateEntryResultV2' do
    it 'should create an instance of CatalogUpdateEntryResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateEntryResultV2)
    end
  end
