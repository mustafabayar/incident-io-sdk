...
# Unit tests for IncidentIoSdk::CatalogUpdateEntryResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateEntryResultV3 do
  let(:instance) { IncidentIoSdk::CatalogUpdateEntryResultV3.new }

  describe 'test an instance of CatalogUpdateEntryResultV3' do
    it 'should create an instance of CatalogUpdateEntryResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateEntryResultV3)
    end
  end
