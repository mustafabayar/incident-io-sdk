...
# Unit tests for IncidentIoSdk::CatalogUpdateTypePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateTypePayloadV2 do
  let(:instance) { IncidentIoSdk::CatalogUpdateTypePayloadV2.new }

  describe 'test an instance of CatalogUpdateTypePayloadV2' do
    it 'should create an instance of CatalogUpdateTypePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateTypePayloadV2)
    end
  end
