...
# Unit tests for IncidentIoSdk::CatalogUpdateTypePayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateTypePayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogUpdateTypePayloadV3.new }

  describe 'test an instance of CatalogUpdateTypePayloadV3' do
    it 'should create an instance of CatalogUpdateTypePayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateTypePayloadV3)
    end
  end
