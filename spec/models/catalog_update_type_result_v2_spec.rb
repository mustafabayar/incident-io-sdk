...
# Unit tests for IncidentIoSdk::CatalogUpdateTypeResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateTypeResultV2 do
  let(:instance) { IncidentIoSdk::CatalogUpdateTypeResultV2.new }

  describe 'test an instance of CatalogUpdateTypeResultV2' do
    it 'should create an instance of CatalogUpdateTypeResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateTypeResultV2)
    end
  end
