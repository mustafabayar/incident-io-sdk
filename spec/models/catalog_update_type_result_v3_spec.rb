...
# Unit tests for IncidentIoSdk::CatalogUpdateTypeResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateTypeResultV3 do
  let(:instance) { IncidentIoSdk::CatalogUpdateTypeResultV3.new }

  describe 'test an instance of CatalogUpdateTypeResultV3' do
    it 'should create an instance of CatalogUpdateTypeResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateTypeResultV3)
    end
  end
