...
# Unit tests for IncidentIoSdk::CatalogUpdateTypeSchemaPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateTypeSchemaPayloadV2 do
  let(:instance) { IncidentIoSdk::CatalogUpdateTypeSchemaPayloadV2.new }

  describe 'test an instance of CatalogUpdateTypeSchemaPayloadV2' do
    it 'should create an instance of CatalogUpdateTypeSchemaPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateTypeSchemaPayloadV2)
    end
  end
