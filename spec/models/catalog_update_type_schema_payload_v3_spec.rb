...
# Unit tests for IncidentIoSdk::CatalogUpdateTypeSchemaPayloadV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateTypeSchemaPayloadV3 do
  let(:instance) { IncidentIoSdk::CatalogUpdateTypeSchemaPayloadV3.new }

  describe 'test an instance of CatalogUpdateTypeSchemaPayloadV3' do
    it 'should create an instance of CatalogUpdateTypeSchemaPayloadV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateTypeSchemaPayloadV3)
    end
  end
