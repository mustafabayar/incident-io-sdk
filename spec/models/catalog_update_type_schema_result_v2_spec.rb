...
# Unit tests for IncidentIoSdk::CatalogUpdateTypeSchemaResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateTypeSchemaResultV2 do
  let(:instance) { IncidentIoSdk::CatalogUpdateTypeSchemaResultV2.new }

  describe 'test an instance of CatalogUpdateTypeSchemaResultV2' do
    it 'should create an instance of CatalogUpdateTypeSchemaResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateTypeSchemaResultV2)
    end
  end
