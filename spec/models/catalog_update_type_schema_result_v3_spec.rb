...
# Unit tests for IncidentIoSdk::CatalogUpdateTypeSchemaResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CatalogUpdateTypeSchemaResultV3 do
  let(:instance) { IncidentIoSdk::CatalogUpdateTypeSchemaResultV3.new }

  describe 'test an instance of CatalogUpdateTypeSchemaResultV3' do
    it 'should create an instance of CatalogUpdateTypeSchemaResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CatalogUpdateTypeSchemaResultV3)
    end
  end
