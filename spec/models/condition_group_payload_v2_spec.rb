...
# Unit tests for IncidentIoSdk::ConditionGroupPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ConditionGroupPayloadV2 do
  let(:instance) { IncidentIoSdk::ConditionGroupPayloadV2.new }

  describe 'test an instance of ConditionGroupPayloadV2' do
    it 'should create an instance of ConditionGroupPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ConditionGroupPayloadV2)
    end
  end
