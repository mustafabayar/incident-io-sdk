...
# Unit tests for IncidentIoSdk::ConditionGroupV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ConditionGroupV2 do
  let(:instance) { IncidentIoSdk::ConditionGroupV2.new }

  describe 'test an instance of ConditionGroupV2' do
    it 'should create an instance of ConditionGroupV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ConditionGroupV2)
    end
  end
