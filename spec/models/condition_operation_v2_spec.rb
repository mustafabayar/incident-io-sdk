...
# Unit tests for IncidentIoSdk::ConditionOperationV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ConditionOperationV2 do
  let(:instance) { IncidentIoSdk::ConditionOperationV2.new }

  describe 'test an instance of ConditionOperationV2' do
    it 'should create an instance of ConditionOperationV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ConditionOperationV2)
    end
  end
