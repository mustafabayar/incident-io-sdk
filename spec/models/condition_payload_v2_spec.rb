...
# Unit tests for IncidentIoSdk::ConditionPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ConditionPayloadV2 do
  let(:instance) { IncidentIoSdk::ConditionPayloadV2.new }

  describe 'test an instance of ConditionPayloadV2' do
    it 'should create an instance of ConditionPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ConditionPayloadV2)
    end
  end
