...
# Unit tests for IncidentIoSdk::ConditionSubjectV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ConditionSubjectV2 do
  let(:instance) { IncidentIoSdk::ConditionSubjectV2.new }

  describe 'test an instance of ConditionSubjectV2' do
    it 'should create an instance of ConditionSubjectV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ConditionSubjectV2)
    end
  end
