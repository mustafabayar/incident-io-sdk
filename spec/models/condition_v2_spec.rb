...
# Unit tests for IncidentIoSdk::ConditionV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ConditionV2 do
  let(:instance) { IncidentIoSdk::ConditionV2.new }

  describe 'test an instance of ConditionV2' do
    it 'should create an instance of ConditionV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ConditionV2)
    end
  end
