...
# Unit tests for IncidentIoSdk::CustomFieldEntryPayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldEntryPayloadV1 do
  let(:instance) { IncidentIoSdk::CustomFieldEntryPayloadV1.new }

  describe 'test an instance of CustomFieldEntryPayloadV1' do
    it 'should create an instance of CustomFieldEntryPayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldEntryPayloadV1)
    end
  end
