...
# Unit tests for IncidentIoSdk::CustomFieldEntryPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldEntryPayloadV2 do
  let(:instance) { IncidentIoSdk::CustomFieldEntryPayloadV2.new }

  describe 'test an instance of CustomFieldEntryPayloadV2' do
    it 'should create an instance of CustomFieldEntryPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldEntryPayloadV2)
    end
  end
