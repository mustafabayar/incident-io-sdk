...
# Unit tests for IncidentIoSdk::CustomFieldEntryV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldEntryV1 do
  let(:instance) { IncidentIoSdk::CustomFieldEntryV1.new }

  describe 'test an instance of CustomFieldEntryV1' do
    it 'should create an instance of CustomFieldEntryV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldEntryV1)
    end
  end
