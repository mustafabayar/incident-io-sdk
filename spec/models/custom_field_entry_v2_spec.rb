...
# Unit tests for IncidentIoSdk::CustomFieldEntryV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldEntryV2 do
  let(:instance) { IncidentIoSdk::CustomFieldEntryV2.new }

  describe 'test an instance of CustomFieldEntryV2' do
    it 'should create an instance of CustomFieldEntryV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldEntryV2)
    end
  end
