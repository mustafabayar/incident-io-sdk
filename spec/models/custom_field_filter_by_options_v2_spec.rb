...
# Unit tests for IncidentIoSdk::CustomFieldFilterByOptionsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldFilterByOptionsV2 do
  let(:instance) { IncidentIoSdk::CustomFieldFilterByOptionsV2.new }

  describe 'test an instance of CustomFieldFilterByOptionsV2' do
    it 'should create an instance of CustomFieldFilterByOptionsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldFilterByOptionsV2)
    end
  end

  describe 'test attribute "catalog_attribute_id"' do
    it 'should work' do
