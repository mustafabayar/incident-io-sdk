...
# Unit tests for IncidentIoSdk::CustomFieldOptionV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldOptionV1 do
  let(:instance) { IncidentIoSdk::CustomFieldOptionV1.new }

  describe 'test an instance of CustomFieldOptionV1' do
    it 'should create an instance of CustomFieldOptionV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldOptionV1)
    end
  end
