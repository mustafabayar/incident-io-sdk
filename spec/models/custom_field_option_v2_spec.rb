...
# Unit tests for IncidentIoSdk::CustomFieldOptionV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldOptionV2 do
  let(:instance) { IncidentIoSdk::CustomFieldOptionV2.new }

  describe 'test an instance of CustomFieldOptionV2' do
    it 'should create an instance of CustomFieldOptionV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldOptionV2)
    end
  end
