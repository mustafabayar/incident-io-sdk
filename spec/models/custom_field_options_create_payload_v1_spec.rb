...
# Unit tests for IncidentIoSdk::CustomFieldOptionsCreatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldOptionsCreatePayloadV1 do
  let(:instance) { IncidentIoSdk::CustomFieldOptionsCreatePayloadV1.new }

  describe 'test an instance of CustomFieldOptionsCreatePayloadV1' do
    it 'should create an instance of CustomFieldOptionsCreatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldOptionsCreatePayloadV1)
    end
  end
