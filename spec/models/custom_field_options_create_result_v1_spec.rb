...
# Unit tests for IncidentIoSdk::CustomFieldOptionsCreateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldOptionsCreateResultV1 do
  let(:instance) { IncidentIoSdk::CustomFieldOptionsCreateResultV1.new }

  describe 'test an instance of CustomFieldOptionsCreateResultV1' do
    it 'should create an instance of CustomFieldOptionsCreateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldOptionsCreateResultV1)
    end
  end
