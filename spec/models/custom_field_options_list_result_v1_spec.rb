...
# Unit tests for IncidentIoSdk::CustomFieldOptionsListResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldOptionsListResultV1 do
  let(:instance) { IncidentIoSdk::CustomFieldOptionsListResultV1.new }

  describe 'test an instance of CustomFieldOptionsListResultV1' do
    it 'should create an instance of CustomFieldOptionsListResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldOptionsListResultV1)
    end
  end
