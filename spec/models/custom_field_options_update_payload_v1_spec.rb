...
# Unit tests for IncidentIoSdk::CustomFieldOptionsUpdatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldOptionsUpdatePayloadV1 do
  let(:instance) { IncidentIoSdk::CustomFieldOptionsUpdatePayloadV1.new }

  describe 'test an instance of CustomFieldOptionsUpdatePayloadV1' do
    it 'should create an instance of CustomFieldOptionsUpdatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldOptionsUpdatePayloadV1)
    end
  end
