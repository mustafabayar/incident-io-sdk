...
# Unit tests for IncidentIoSdk::CustomFieldOptionsUpdateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldOptionsUpdateResultV1 do
  let(:instance) { IncidentIoSdk::CustomFieldOptionsUpdateResultV1.new }

  describe 'test an instance of CustomFieldOptionsUpdateResultV1' do
    it 'should create an instance of CustomFieldOptionsUpdateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldOptionsUpdateResultV1)
    end
  end

  describe 'test attribute "custom_field_option"' do
    it 'should work' do
