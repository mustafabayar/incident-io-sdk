...
# Unit tests for IncidentIoSdk::CustomFieldTypeInfoV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldTypeInfoV1 do
  let(:instance) { IncidentIoSdk::CustomFieldTypeInfoV1.new }

  describe 'test an instance of CustomFieldTypeInfoV1' do
    it 'should create an instance of CustomFieldTypeInfoV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldTypeInfoV1)
    end
  end
