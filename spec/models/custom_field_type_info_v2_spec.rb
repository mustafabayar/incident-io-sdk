...
# Unit tests for IncidentIoSdk::CustomFieldTypeInfoV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldTypeInfoV2 do
  let(:instance) { IncidentIoSdk::CustomFieldTypeInfoV2.new }

  describe 'test an instance of CustomFieldTypeInfoV2' do
    it 'should create an instance of CustomFieldTypeInfoV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldTypeInfoV2)
    end
  end
