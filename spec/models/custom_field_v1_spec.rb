...
# Unit tests for IncidentIoSdk::CustomFieldV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldV1 do
  let(:instance) { IncidentIoSdk::CustomFieldV1.new }

  describe 'test an instance of CustomFieldV1' do
    it 'should create an instance of CustomFieldV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldV1)
    end
  end

  describe 'test attribute "catalog_type_id"' do
    it 'should work' do
