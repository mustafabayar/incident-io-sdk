...
# Unit tests for IncidentIoSdk::CustomFieldV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldV2 do
  let(:instance) { IncidentIoSdk::CustomFieldV2.new }

  describe 'test an instance of CustomFieldV2' do
    it 'should create an instance of CustomFieldV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldV2)
    end
  end
