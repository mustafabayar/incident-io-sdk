...
# Unit tests for IncidentIoSdk::CustomFieldValuePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldValuePayloadV2 do
  let(:instance) { IncidentIoSdk::CustomFieldValuePayloadV2.new }

  describe 'test an instance of CustomFieldValuePayloadV2' do
    it 'should create an instance of CustomFieldValuePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldValuePayloadV2)
    end
  end
