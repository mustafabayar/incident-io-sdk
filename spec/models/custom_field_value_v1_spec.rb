...
# Unit tests for IncidentIoSdk::CustomFieldValueV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldValueV1 do
  let(:instance) { IncidentIoSdk::CustomFieldValueV1.new }

  describe 'test an instance of CustomFieldValueV1' do
    it 'should create an instance of CustomFieldValueV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldValueV1)
    end
  end

  describe 'test attribute "value_catalog_entry"' do
    it 'should work' do
  ...
  describe 'test attribute "value_option"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
