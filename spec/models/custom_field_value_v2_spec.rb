...
# Unit tests for IncidentIoSdk::CustomFieldValueV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldValueV2 do
  let(:instance) { IncidentIoSdk::CustomFieldValueV2.new }

  describe 'test an instance of CustomFieldValueV2' do
    it 'should create an instance of CustomFieldValueV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldValueV2)
    end
  end
