...
# Unit tests for IncidentIoSdk::CustomFieldsCreatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsCreatePayloadV1 do
  let(:instance) { IncidentIoSdk::CustomFieldsCreatePayloadV1.new }

  describe 'test an instance of CustomFieldsCreatePayloadV1' do
    it 'should create an instance of CustomFieldsCreatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsCreatePayloadV1)
    end
  end
  ...
  describe 'test attribute "field_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["single_select", "multi_select", "text", "link", "numeric"])
  ...
  describe 'test attribute "required"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["never", "before_closure", "always"])
      # validator.allowable_values.each do |value|
      #   expect { instance.required = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "required_v2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["never", "before_resolution", "always"])
      # validator.allowable_values.each do |value|
      #   expect { instance.required_v2 = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "show_before_closure"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "show_before_creation"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "show_before_update"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "show_in_announcement_post"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
