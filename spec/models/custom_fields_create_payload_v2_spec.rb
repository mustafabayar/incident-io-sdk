...
# Unit tests for IncidentIoSdk::CustomFieldsCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::CustomFieldsCreatePayloadV2.new }

  describe 'test an instance of CustomFieldsCreatePayloadV2' do
    it 'should create an instance of CustomFieldsCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsCreatePayloadV2)
    end
  end
  ...
  describe 'test attribute "group_by_catalog_attribute_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "helptext_catalog_attribute_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
