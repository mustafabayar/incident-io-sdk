...
# Unit tests for IncidentIoSdk::CustomFieldsCreateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsCreateResultV1 do
  let(:instance) { IncidentIoSdk::CustomFieldsCreateResultV1.new }

  describe 'test an instance of CustomFieldsCreateResultV1' do
    it 'should create an instance of CustomFieldsCreateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsCreateResultV1)
    end
  end
