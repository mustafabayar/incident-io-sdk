...
# Unit tests for IncidentIoSdk::CustomFieldsCreateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsCreateResultV2 do
  let(:instance) { IncidentIoSdk::CustomFieldsCreateResultV2.new }

  describe 'test an instance of CustomFieldsCreateResultV2' do
    it 'should create an instance of CustomFieldsCreateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsCreateResultV2)
    end
  end
