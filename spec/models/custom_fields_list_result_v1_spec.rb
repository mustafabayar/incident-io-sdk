...
# Unit tests for IncidentIoSdk::CustomFieldsListResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsListResultV1 do
  let(:instance) { IncidentIoSdk::CustomFieldsListResultV1.new }

  describe 'test an instance of CustomFieldsListResultV1' do
    it 'should create an instance of CustomFieldsListResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsListResultV1)
    end
  end
