...
# Unit tests for IncidentIoSdk::CustomFieldsListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsListResultV2 do
  let(:instance) { IncidentIoSdk::CustomFieldsListResultV2.new }

  describe 'test an instance of CustomFieldsListResultV2' do
    it 'should create an instance of CustomFieldsListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsListResultV2)
    end
  end
