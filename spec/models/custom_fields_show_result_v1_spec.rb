...
# Unit tests for IncidentIoSdk::CustomFieldsShowResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsShowResultV1 do
  let(:instance) { IncidentIoSdk::CustomFieldsShowResultV1.new }

  describe 'test an instance of CustomFieldsShowResultV1' do
    it 'should create an instance of CustomFieldsShowResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsShowResultV1)
    end
  end
