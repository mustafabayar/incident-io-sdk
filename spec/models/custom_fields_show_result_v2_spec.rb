...
# Unit tests for IncidentIoSdk::CustomFieldsShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsShowResultV2 do
  let(:instance) { IncidentIoSdk::CustomFieldsShowResultV2.new }

  describe 'test an instance of CustomFieldsShowResultV2' do
    it 'should create an instance of CustomFieldsShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsShowResultV2)
    end
  end
