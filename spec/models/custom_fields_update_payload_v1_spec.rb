...
# Unit tests for IncidentIoSdk::CustomFieldsUpdatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsUpdatePayloadV1 do
  let(:instance) { IncidentIoSdk::CustomFieldsUpdatePayloadV1.new }

  describe 'test an instance of CustomFieldsUpdatePayloadV1' do
    it 'should create an instance of CustomFieldsUpdatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsUpdatePayloadV1)
    end
  end
