...
# Unit tests for IncidentIoSdk::CustomFieldsUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::CustomFieldsUpdatePayloadV2.new }

  describe 'test an instance of CustomFieldsUpdatePayloadV2' do
    it 'should create an instance of CustomFieldsUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsUpdatePayloadV2)
    end
  end
