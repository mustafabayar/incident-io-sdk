...
# Unit tests for IncidentIoSdk::CustomFieldsUpdateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsUpdateResultV1 do
  let(:instance) { IncidentIoSdk::CustomFieldsUpdateResultV1.new }

  describe 'test an instance of CustomFieldsUpdateResultV1' do
    it 'should create an instance of CustomFieldsUpdateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsUpdateResultV1)
    end
  end
