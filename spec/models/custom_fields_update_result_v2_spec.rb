...
# Unit tests for IncidentIoSdk::CustomFieldsUpdateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::CustomFieldsUpdateResultV2 do
  let(:instance) { IncidentIoSdk::CustomFieldsUpdateResultV2.new }

  describe 'test an instance of CustomFieldsUpdateResultV2' do
    it 'should create an instance of CustomFieldsUpdateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::CustomFieldsUpdateResultV2)
    end
  end
