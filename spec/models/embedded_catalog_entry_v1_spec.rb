...
# Unit tests for IncidentIoSdk::EmbeddedCatalogEntryV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EmbeddedCatalogEntryV1 do
  let(:instance) { IncidentIoSdk::EmbeddedCatalogEntryV1.new }

  describe 'test an instance of EmbeddedCatalogEntryV1' do
    it 'should create an instance of EmbeddedCatalogEntryV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EmbeddedCatalogEntryV1)
    end
  end
