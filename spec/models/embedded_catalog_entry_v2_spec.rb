...
# Unit tests for IncidentIoSdk::EmbeddedCatalogEntryV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EmbeddedCatalogEntryV2 do
  let(:instance) { IncidentIoSdk::EmbeddedCatalogEntryV2.new }

  describe 'test an instance of EmbeddedCatalogEntryV2' do
    it 'should create an instance of EmbeddedCatalogEntryV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EmbeddedCatalogEntryV2)
    end
  end
