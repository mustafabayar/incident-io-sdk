...
# Unit tests for IncidentIoSdk::EmbeddedIncidentRoleV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EmbeddedIncidentRoleV2 do
  let(:instance) { IncidentIoSdk::EmbeddedIncidentRoleV2.new }

  describe 'test an instance of EmbeddedIncidentRoleV2' do
    it 'should create an instance of EmbeddedIncidentRoleV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EmbeddedIncidentRoleV2)
    end
  end
  ...
  describe 'test attribute "role_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["lead", "reporter", "custom"])
