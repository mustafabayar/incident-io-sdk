...
# Unit tests for IncidentIoSdk::EngineParamBindingPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EngineParamBindingPayloadV2 do
  let(:instance) { IncidentIoSdk::EngineParamBindingPayloadV2.new }

  describe 'test an instance of EngineParamBindingPayloadV2' do
    it 'should create an instance of EngineParamBindingPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EngineParamBindingPayloadV2)
    end
  end
