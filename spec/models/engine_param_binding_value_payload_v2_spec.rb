...
# Unit tests for IncidentIoSdk::EngineParamBindingValuePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EngineParamBindingValuePayloadV2 do
  let(:instance) { IncidentIoSdk::EngineParamBindingValuePayloadV2.new }

  describe 'test an instance of EngineParamBindingValuePayloadV2' do
    it 'should create an instance of EngineParamBindingValuePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EngineParamBindingValuePayloadV2)
    end
  end
