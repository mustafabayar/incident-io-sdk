...
# Unit tests for IncidentIoSdk::EngineReferenceV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EngineReferenceV2 do
  let(:instance) { IncidentIoSdk::EngineReferenceV2.new }

  describe 'test an instance of EngineReferenceV2' do
    it 'should create an instance of EngineReferenceV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EngineReferenceV2)
    end
  end
