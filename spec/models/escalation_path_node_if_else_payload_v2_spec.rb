...
# Unit tests for IncidentIoSdk::EscalationPathNodeIfElsePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EscalationPathNodeIfElsePayloadV2 do
  let(:instance) { IncidentIoSdk::EscalationPathNodeIfElsePayloadV2.new }

  describe 'test an instance of EscalationPathNodeIfElsePayloadV2' do
    it 'should create an instance of EscalationPathNodeIfElsePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EscalationPathNodeIfElsePayloadV2)
    end
  end
  ...
  describe 'test attribute "else_path"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "then_path"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
