...
# Unit tests for IncidentIoSdk::EscalationPathNodeIfElseV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EscalationPathNodeIfElseV2 do
  let(:instance) { IncidentIoSdk::EscalationPathNodeIfElseV2.new }

  describe 'test an instance of EscalationPathNodeIfElseV2' do
    it 'should create an instance of EscalationPathNodeIfElseV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EscalationPathNodeIfElseV2)
    end
  end
