...
# Unit tests for IncidentIoSdk::EscalationsCreatePathResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EscalationsCreatePathResultV2 do
  let(:instance) { IncidentIoSdk::EscalationsCreatePathResultV2.new }

  describe 'test an instance of EscalationsCreatePathResultV2' do
    it 'should create an instance of EscalationsCreatePathResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EscalationsCreatePathResultV2)
    end
  end

  describe 'test attribute "escalation_path"' do
    it 'should work' do
