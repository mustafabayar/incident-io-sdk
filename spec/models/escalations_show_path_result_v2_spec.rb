...
# Unit tests for IncidentIoSdk::EscalationsShowPathResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EscalationsShowPathResultV2 do
  let(:instance) { IncidentIoSdk::EscalationsShowPathResultV2.new }

  describe 'test an instance of EscalationsShowPathResultV2' do
    it 'should create an instance of EscalationsShowPathResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EscalationsShowPathResultV2)
    end
  end
