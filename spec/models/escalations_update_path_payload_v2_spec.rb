...
# Unit tests for IncidentIoSdk::EscalationsUpdatePathPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EscalationsUpdatePathPayloadV2 do
  let(:instance) { IncidentIoSdk::EscalationsUpdatePathPayloadV2.new }

  describe 'test an instance of EscalationsUpdatePathPayloadV2' do
    it 'should create an instance of EscalationsUpdatePathPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EscalationsUpdatePathPayloadV2)
    end
  end
