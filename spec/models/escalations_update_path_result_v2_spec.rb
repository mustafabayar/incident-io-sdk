...
# Unit tests for IncidentIoSdk::EscalationsUpdatePathResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::EscalationsUpdatePathResultV2 do
  let(:instance) { IncidentIoSdk::EscalationsUpdatePathResultV2.new }

  describe 'test an instance of EscalationsUpdatePathResultV2' do
    it 'should create an instance of EscalationsUpdatePathResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::EscalationsUpdatePathResultV2)
    end
  end
