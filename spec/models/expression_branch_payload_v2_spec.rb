...
# Unit tests for IncidentIoSdk::ExpressionBranchPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionBranchPayloadV2 do
  let(:instance) { IncidentIoSdk::ExpressionBranchPayloadV2.new }

  describe 'test an instance of ExpressionBranchPayloadV2' do
    it 'should create an instance of ExpressionBranchPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionBranchPayloadV2)
    end
  end
