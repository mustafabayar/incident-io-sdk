...
# Unit tests for IncidentIoSdk::ExpressionBranchV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionBranchV2 do
  let(:instance) { IncidentIoSdk::ExpressionBranchV2.new }

  describe 'test an instance of ExpressionBranchV2' do
    it 'should create an instance of ExpressionBranchV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionBranchV2)
    end
  end
