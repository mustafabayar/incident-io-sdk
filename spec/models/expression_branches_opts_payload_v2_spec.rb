...
# Unit tests for IncidentIoSdk::ExpressionBranchesOptsPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionBranchesOptsPayloadV2 do
  let(:instance) { IncidentIoSdk::ExpressionBranchesOptsPayloadV2.new }

  describe 'test an instance of ExpressionBranchesOptsPayloadV2' do
    it 'should create an instance of ExpressionBranchesOptsPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionBranchesOptsPayloadV2)
    end
  end
