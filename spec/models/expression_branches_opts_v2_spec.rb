...
# Unit tests for IncidentIoSdk::ExpressionBranchesOptsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionBranchesOptsV2 do
  let(:instance) { IncidentIoSdk::ExpressionBranchesOptsV2.new }

  describe 'test an instance of ExpressionBranchesOptsV2' do
    it 'should create an instance of ExpressionBranchesOptsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionBranchesOptsV2)
    end
  end
