...
# Unit tests for IncidentIoSdk::ExpressionElseBranchPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionElseBranchPayloadV2 do
  let(:instance) { IncidentIoSdk::ExpressionElseBranchPayloadV2.new }

  describe 'test an instance of ExpressionElseBranchPayloadV2' do
    it 'should create an instance of ExpressionElseBranchPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionElseBranchPayloadV2)
    end
  end
