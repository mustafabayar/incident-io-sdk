...
# Unit tests for IncidentIoSdk::ExpressionElseBranchV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionElseBranchV2 do
  let(:instance) { IncidentIoSdk::ExpressionElseBranchV2.new }

  describe 'test an instance of ExpressionElseBranchV2' do
    it 'should create an instance of ExpressionElseBranchV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionElseBranchV2)
    end
  end
