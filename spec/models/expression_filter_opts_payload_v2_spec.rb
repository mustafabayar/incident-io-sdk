...
# Unit tests for IncidentIoSdk::ExpressionFilterOptsPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionFilterOptsPayloadV2 do
  let(:instance) { IncidentIoSdk::ExpressionFilterOptsPayloadV2.new }

  describe 'test an instance of ExpressionFilterOptsPayloadV2' do
    it 'should create an instance of ExpressionFilterOptsPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionFilterOptsPayloadV2)
    end
  end
