...
# Unit tests for IncidentIoSdk::ExpressionFilterOptsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionFilterOptsV2 do
  let(:instance) { IncidentIoSdk::ExpressionFilterOptsV2.new }

  describe 'test an instance of ExpressionFilterOptsV2' do
    it 'should create an instance of ExpressionFilterOptsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionFilterOptsV2)
    end
  end
