...
# Unit tests for IncidentIoSdk::ExpressionNavigateOptsPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionNavigateOptsPayloadV2 do
  let(:instance) { IncidentIoSdk::ExpressionNavigateOptsPayloadV2.new }

  describe 'test an instance of ExpressionNavigateOptsPayloadV2' do
    it 'should create an instance of ExpressionNavigateOptsPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionNavigateOptsPayloadV2)
    end
  end
