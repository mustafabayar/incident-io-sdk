...
# Unit tests for IncidentIoSdk::ExpressionNavigateOptsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionNavigateOptsV2 do
  let(:instance) { IncidentIoSdk::ExpressionNavigateOptsV2.new }

  describe 'test an instance of ExpressionNavigateOptsV2' do
    it 'should create an instance of ExpressionNavigateOptsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionNavigateOptsV2)
    end
  end
  ...
  describe 'test attribute "reference_label"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
