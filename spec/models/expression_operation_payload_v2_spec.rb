...
# Unit tests for IncidentIoSdk::ExpressionOperationPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionOperationPayloadV2 do
  let(:instance) { IncidentIoSdk::ExpressionOperationPayloadV2.new }

  describe 'test an instance of ExpressionOperationPayloadV2' do
    it 'should create an instance of ExpressionOperationPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionOperationPayloadV2)
    end
  end
  ...
  describe 'test attribute "navigate"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "operation_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["navigate", "filter", "count", "min", "max", "sum", "random", "first", "parse", "branches"])
  ...
  describe 'test attribute "parse"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
