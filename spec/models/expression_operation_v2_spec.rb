...
# Unit tests for IncidentIoSdk::ExpressionOperationV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionOperationV2 do
  let(:instance) { IncidentIoSdk::ExpressionOperationV2.new }

  describe 'test an instance of ExpressionOperationV2' do
    it 'should create an instance of ExpressionOperationV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionOperationV2)
    end
  end
