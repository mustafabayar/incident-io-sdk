...
# Unit tests for IncidentIoSdk::ExpressionParseOptsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionParseOptsV2 do
  let(:instance) { IncidentIoSdk::ExpressionParseOptsV2.new }

  describe 'test an instance of ExpressionParseOptsV2' do
    it 'should create an instance of ExpressionParseOptsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionParseOptsV2)
    end
  end
