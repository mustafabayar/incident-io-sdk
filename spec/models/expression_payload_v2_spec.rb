...
# Unit tests for IncidentIoSdk::ExpressionPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionPayloadV2 do
  let(:instance) { IncidentIoSdk::ExpressionPayloadV2.new }

  describe 'test an instance of ExpressionPayloadV2' do
    it 'should create an instance of ExpressionPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionPayloadV2)
    end
  end

  describe 'test attribute "else_branch"' do
    it 'should work' do
