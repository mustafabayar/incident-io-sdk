...
# Unit tests for IncidentIoSdk::ExpressionV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExpressionV2 do
  let(:instance) { IncidentIoSdk::ExpressionV2.new }

  describe 'test an instance of ExpressionV2' do
    it 'should create an instance of ExpressionV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExpressionV2)
    end
  end
