...
# Unit tests for IncidentIoSdk::ExternalIssueReferenceV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExternalIssueReferenceV1 do
  let(:instance) { IncidentIoSdk::ExternalIssueReferenceV1.new }

  describe 'test an instance of ExternalIssueReferenceV1' do
    it 'should create an instance of ExternalIssueReferenceV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExternalIssueReferenceV1)
    end
  end
  ...
  describe 'test attribute "issue_permalink"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "provider"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["asana", "azure_devops", "click_up", "linear", "jira", "jira_server", "github", "gitlab", "shortcut"])
