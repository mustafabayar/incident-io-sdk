...
# Unit tests for IncidentIoSdk::ExternalIssueReferenceV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExternalIssueReferenceV2 do
  let(:instance) { IncidentIoSdk::ExternalIssueReferenceV2.new }

  describe 'test an instance of ExternalIssueReferenceV2' do
    it 'should create an instance of ExternalIssueReferenceV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExternalIssueReferenceV2)
    end
  end
