...
# Unit tests for IncidentIoSdk::ExternalIssueReferenceV6
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExternalIssueReferenceV6 do
  let(:instance) { IncidentIoSdk::ExternalIssueReferenceV6.new }

  describe 'test an instance of ExternalIssueReferenceV6' do
    it 'should create an instance of ExternalIssueReferenceV6' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExternalIssueReferenceV6)
    end
  end
