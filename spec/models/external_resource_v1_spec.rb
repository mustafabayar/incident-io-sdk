...
# Unit tests for IncidentIoSdk::ExternalResourceV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ExternalResourceV1 do
  let(:instance) { IncidentIoSdk::ExternalResourceV1.new }

  describe 'test an instance of ExternalResourceV1' do
    it 'should create an instance of ExternalResourceV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ExternalResourceV1)
    end
  end
