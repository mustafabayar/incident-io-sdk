...
# Unit tests for IncidentIoSdk::FollowUpPriorityV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::FollowUpPriorityV2 do
  let(:instance) { IncidentIoSdk::FollowUpPriorityV2.new }

  describe 'test an instance of FollowUpPriorityV2' do
    it 'should create an instance of FollowUpPriorityV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::FollowUpPriorityV2)
    end
  end
