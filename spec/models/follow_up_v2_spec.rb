...
# Unit tests for IncidentIoSdk::FollowUpV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::FollowUpV2 do
  let(:instance) { IncidentIoSdk::FollowUpV2.new }

  describe 'test an instance of FollowUpV2' do
    it 'should create an instance of FollowUpV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::FollowUpV2)
    end
  end
