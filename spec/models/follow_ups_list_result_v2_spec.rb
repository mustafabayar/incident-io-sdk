...
# Unit tests for IncidentIoSdk::FollowUpsListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::FollowUpsListResultV2 do
  let(:instance) { IncidentIoSdk::FollowUpsListResultV2.new }

  describe 'test an instance of FollowUpsListResultV2' do
    it 'should create an instance of FollowUpsListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::FollowUpsListResultV2)
    end
  end

  describe 'test attribute "follow_ups"' do
    it 'should work' do
