...
# Unit tests for IncidentIoSdk::FollowUpsShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::FollowUpsShowResultV2 do
  let(:instance) { IncidentIoSdk::FollowUpsShowResultV2.new }

  describe 'test an instance of FollowUpsShowResultV2' do
    it 'should create an instance of FollowUpsShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::FollowUpsShowResultV2)
    end
  end
