...
# Unit tests for IncidentIoSdk::GroupingKeyV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::GroupingKeyV2 do
  let(:instance) { IncidentIoSdk::GroupingKeyV2.new }

  describe 'test an instance of GroupingKeyV2' do
    it 'should create an instance of GroupingKeyV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::GroupingKeyV2)
    end
  end
