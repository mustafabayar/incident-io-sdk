...
# Unit tests for IncidentIoSdk::IdentityV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IdentityV1 do
  let(:instance) { IncidentIoSdk::IdentityV1.new }

  describe 'test an instance of IdentityV1' do
    it 'should create an instance of IdentityV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IdentityV1)
    end
  end
  ...
  describe 'test attribute "roles"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["viewer", "incident_creator", "incident_editor", "manage_settings", "global_access", "catalog_viewer", "catalog_editor", "incident_memberships_editor", "schedules_editor", "schedules_reader", "schedule_overrides_editor", "workflows_editor", "private_workflows_editor", "on_call_editor", "post_incident_flow_opt_out"])
