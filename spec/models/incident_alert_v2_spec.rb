...
# Unit tests for IncidentIoSdk::IncidentAlertV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentAlertV2 do
  let(:instance) { IncidentIoSdk::IncidentAlertV2.new }

  describe 'test an instance of IncidentAlertV2' do
    it 'should create an instance of IncidentAlertV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentAlertV2)
    end
  end
  ...
  describe 'test attribute "alert_route_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
