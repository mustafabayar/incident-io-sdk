...
# Unit tests for IncidentIoSdk::IncidentAttachmentV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentAttachmentV1 do
  let(:instance) { IncidentIoSdk::IncidentAttachmentV1.new }

  describe 'test an instance of IncidentAttachmentV1' do
    it 'should create an instance of IncidentAttachmentV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentAttachmentV1)
    end
  end
