...
# Unit tests for IncidentIoSdk::IncidentAttachmentsCreatePayloadV1Resource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentAttachmentsCreatePayloadV1Resource do
  let(:instance) { IncidentIoSdk::IncidentAttachmentsCreatePayloadV1Resource.new }

  describe 'test an instance of IncidentAttachmentsCreatePayloadV1Resource' do
    it 'should create an instance of IncidentAttachmentsCreatePayloadV1Resource' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentAttachmentsCreatePayloadV1Resource)
    end
  end
