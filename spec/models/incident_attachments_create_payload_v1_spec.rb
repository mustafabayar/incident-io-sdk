...
# Unit tests for IncidentIoSdk::IncidentAttachmentsCreatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentAttachmentsCreatePayloadV1 do
  let(:instance) { IncidentIoSdk::IncidentAttachmentsCreatePayloadV1.new }

  describe 'test an instance of IncidentAttachmentsCreatePayloadV1' do
    it 'should create an instance of IncidentAttachmentsCreatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentAttachmentsCreatePayloadV1)
    end
  end
