...
# Unit tests for IncidentIoSdk::IncidentAttachmentsCreateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentAttachmentsCreateResultV1 do
  let(:instance) { IncidentIoSdk::IncidentAttachmentsCreateResultV1.new }

  describe 'test an instance of IncidentAttachmentsCreateResultV1' do
    it 'should create an instance of IncidentAttachmentsCreateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentAttachmentsCreateResultV1)
    end
  end

  describe 'test attribute "incident_attachment"' do
    it 'should work' do
