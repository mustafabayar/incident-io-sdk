...
# Unit tests for IncidentIoSdk::IncidentAttachmentsListResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentAttachmentsListResultV1 do
  let(:instance) { IncidentIoSdk::IncidentAttachmentsListResultV1.new }

  describe 'test an instance of IncidentAttachmentsListResultV1' do
    it 'should create an instance of IncidentAttachmentsListResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentAttachmentsListResultV1)
    end
  end

  describe 'test attribute "incident_attachments"' do
    it 'should work' do
