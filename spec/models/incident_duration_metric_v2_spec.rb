...
# Unit tests for IncidentIoSdk::IncidentDurationMetricV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentDurationMetricV2 do
  let(:instance) { IncidentIoSdk::IncidentDurationMetricV2.new }

  describe 'test an instance of IncidentDurationMetricV2' do
    it 'should create an instance of IncidentDurationMetricV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentDurationMetricV2)
    end
  end
