...
# Unit tests for IncidentIoSdk::IncidentDurationMetricWithValueV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentDurationMetricWithValueV2 do
  let(:instance) { IncidentIoSdk::IncidentDurationMetricWithValueV2.new }

  describe 'test an instance of IncidentDurationMetricWithValueV2' do
    it 'should create an instance of IncidentDurationMetricWithValueV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentDurationMetricWithValueV2)
    end
  end

  describe 'test attribute "duration_metric"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "value_seconds"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
