...
# Unit tests for IncidentIoSdk::IncidentEditPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentEditPayloadV2 do
  let(:instance) { IncidentIoSdk::IncidentEditPayloadV2.new }

  describe 'test an instance of IncidentEditPayloadV2' do
    it 'should create an instance of IncidentEditPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentEditPayloadV2)
    end
  end
