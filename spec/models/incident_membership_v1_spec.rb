...
# Unit tests for IncidentIoSdk::IncidentMembershipV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentMembershipV1 do
  let(:instance) { IncidentIoSdk::IncidentMembershipV1.new }

  describe 'test an instance of IncidentMembershipV1' do
    it 'should create an instance of IncidentMembershipV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentMembershipV1)
    end
  end
