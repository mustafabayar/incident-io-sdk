...
# Unit tests for IncidentIoSdk::IncidentMembershipsCreatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentMembershipsCreatePayloadV1 do
  let(:instance) { IncidentIoSdk::IncidentMembershipsCreatePayloadV1.new }

  describe 'test an instance of IncidentMembershipsCreatePayloadV1' do
    it 'should create an instance of IncidentMembershipsCreatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentMembershipsCreatePayloadV1)
    end
  end
