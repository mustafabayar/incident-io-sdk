...
# Unit tests for IncidentIoSdk::IncidentMembershipsCreateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentMembershipsCreateResultV1 do
  let(:instance) { IncidentIoSdk::IncidentMembershipsCreateResultV1.new }

  describe 'test an instance of IncidentMembershipsCreateResultV1' do
    it 'should create an instance of IncidentMembershipsCreateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentMembershipsCreateResultV1)
    end
  end

  describe 'test attribute "incident_membership"' do
    it 'should work' do
