...
# Unit tests for IncidentIoSdk::IncidentMembershipsRevokePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentMembershipsRevokePayloadV1 do
  let(:instance) { IncidentIoSdk::IncidentMembershipsRevokePayloadV1.new }

  describe 'test an instance of IncidentMembershipsRevokePayloadV1' do
    it 'should create an instance of IncidentMembershipsRevokePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentMembershipsRevokePayloadV1)
    end
  end
