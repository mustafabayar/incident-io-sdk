...
# Unit tests for IncidentIoSdk::IncidentRoleAssignmentPayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRoleAssignmentPayloadV1 do
  let(:instance) { IncidentIoSdk::IncidentRoleAssignmentPayloadV1.new }

  describe 'test an instance of IncidentRoleAssignmentPayloadV1' do
    it 'should create an instance of IncidentRoleAssignmentPayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRoleAssignmentPayloadV1)
    end
  end
  ...
  describe 'test attribute "incident_role_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
