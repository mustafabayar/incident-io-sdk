...
# Unit tests for IncidentIoSdk::IncidentRoleAssignmentPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRoleAssignmentPayloadV2 do
  let(:instance) { IncidentIoSdk::IncidentRoleAssignmentPayloadV2.new }

  describe 'test an instance of IncidentRoleAssignmentPayloadV2' do
    it 'should create an instance of IncidentRoleAssignmentPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRoleAssignmentPayloadV2)
    end
  end
