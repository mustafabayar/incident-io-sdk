...
# Unit tests for IncidentIoSdk::IncidentRoleAssignmentV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRoleAssignmentV1 do
  let(:instance) { IncidentIoSdk::IncidentRoleAssignmentV1.new }

  describe 'test an instance of IncidentRoleAssignmentV1' do
    it 'should create an instance of IncidentRoleAssignmentV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRoleAssignmentV1)
    end
  end
