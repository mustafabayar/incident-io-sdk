...
# Unit tests for IncidentIoSdk::IncidentRoleAssignmentV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRoleAssignmentV2 do
  let(:instance) { IncidentIoSdk::IncidentRoleAssignmentV2.new }

  describe 'test an instance of IncidentRoleAssignmentV2' do
    it 'should create an instance of IncidentRoleAssignmentV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRoleAssignmentV2)
    end
  end
