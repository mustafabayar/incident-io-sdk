...
# Unit tests for IncidentIoSdk::IncidentRoleV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRoleV1 do
  let(:instance) { IncidentIoSdk::IncidentRoleV1.new }

  describe 'test an instance of IncidentRoleV1' do
    it 'should create an instance of IncidentRoleV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRoleV1)
    end
  end
