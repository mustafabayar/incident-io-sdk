...
# Unit tests for IncidentIoSdk::IncidentRoleV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRoleV2 do
  let(:instance) { IncidentIoSdk::IncidentRoleV2.new }

  describe 'test an instance of IncidentRoleV2' do
    it 'should create an instance of IncidentRoleV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRoleV2)
    end
  end
