...
# Unit tests for IncidentIoSdk::IncidentRolesCreatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesCreatePayloadV1 do
  let(:instance) { IncidentIoSdk::IncidentRolesCreatePayloadV1.new }

  describe 'test an instance of IncidentRolesCreatePayloadV1' do
    it 'should create an instance of IncidentRolesCreatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesCreatePayloadV1)
    end
  end
