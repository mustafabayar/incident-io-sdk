...
# Unit tests for IncidentIoSdk::IncidentRolesCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::IncidentRolesCreatePayloadV2.new }

  describe 'test an instance of IncidentRolesCreatePayloadV2' do
    it 'should create an instance of IncidentRolesCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesCreatePayloadV2)
    end
  end
