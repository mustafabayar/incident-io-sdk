...
# Unit tests for IncidentIoSdk::IncidentRolesCreateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesCreateResultV1 do
  let(:instance) { IncidentIoSdk::IncidentRolesCreateResultV1.new }

  describe 'test an instance of IncidentRolesCreateResultV1' do
    it 'should create an instance of IncidentRolesCreateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesCreateResultV1)
    end
  end
