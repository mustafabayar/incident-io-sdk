...
# Unit tests for IncidentIoSdk::IncidentRolesCreateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesCreateResultV2 do
  let(:instance) { IncidentIoSdk::IncidentRolesCreateResultV2.new }

  describe 'test an instance of IncidentRolesCreateResultV2' do
    it 'should create an instance of IncidentRolesCreateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesCreateResultV2)
    end
  end
