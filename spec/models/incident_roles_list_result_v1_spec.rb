...
# Unit tests for IncidentIoSdk::IncidentRolesListResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesListResultV1 do
  let(:instance) { IncidentIoSdk::IncidentRolesListResultV1.new }

  describe 'test an instance of IncidentRolesListResultV1' do
    it 'should create an instance of IncidentRolesListResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesListResultV1)
    end
  end

  describe 'test attribute "incident_roles"' do
    it 'should work' do
