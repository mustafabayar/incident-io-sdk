...
# Unit tests for IncidentIoSdk::IncidentRolesListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesListResultV2 do
  let(:instance) { IncidentIoSdk::IncidentRolesListResultV2.new }

  describe 'test an instance of IncidentRolesListResultV2' do
    it 'should create an instance of IncidentRolesListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesListResultV2)
    end
  end
