...
# Unit tests for IncidentIoSdk::IncidentRolesShowResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesShowResultV1 do
  let(:instance) { IncidentIoSdk::IncidentRolesShowResultV1.new }

  describe 'test an instance of IncidentRolesShowResultV1' do
    it 'should create an instance of IncidentRolesShowResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesShowResultV1)
    end
  end
