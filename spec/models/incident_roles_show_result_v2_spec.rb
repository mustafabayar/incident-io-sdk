...
# Unit tests for IncidentIoSdk::IncidentRolesShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesShowResultV2 do
  let(:instance) { IncidentIoSdk::IncidentRolesShowResultV2.new }

  describe 'test an instance of IncidentRolesShowResultV2' do
    it 'should create an instance of IncidentRolesShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesShowResultV2)
    end
  end
