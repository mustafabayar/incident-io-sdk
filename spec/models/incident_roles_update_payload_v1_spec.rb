...
# Unit tests for IncidentIoSdk::IncidentRolesUpdatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesUpdatePayloadV1 do
  let(:instance) { IncidentIoSdk::IncidentRolesUpdatePayloadV1.new }

  describe 'test an instance of IncidentRolesUpdatePayloadV1' do
    it 'should create an instance of IncidentRolesUpdatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesUpdatePayloadV1)
    end
  end
