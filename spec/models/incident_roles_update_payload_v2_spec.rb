...
# Unit tests for IncidentIoSdk::IncidentRolesUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::IncidentRolesUpdatePayloadV2.new }

  describe 'test an instance of IncidentRolesUpdatePayloadV2' do
    it 'should create an instance of IncidentRolesUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesUpdatePayloadV2)
    end
  end
