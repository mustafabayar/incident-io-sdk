...
# Unit tests for IncidentIoSdk::IncidentRolesUpdateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesUpdateResultV1 do
  let(:instance) { IncidentIoSdk::IncidentRolesUpdateResultV1.new }

  describe 'test an instance of IncidentRolesUpdateResultV1' do
    it 'should create an instance of IncidentRolesUpdateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesUpdateResultV1)
    end
  end
