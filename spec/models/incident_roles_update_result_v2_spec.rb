...
# Unit tests for IncidentIoSdk::IncidentRolesUpdateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentRolesUpdateResultV2 do
  let(:instance) { IncidentIoSdk::IncidentRolesUpdateResultV2.new }

  describe 'test an instance of IncidentRolesUpdateResultV2' do
    it 'should create an instance of IncidentRolesUpdateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentRolesUpdateResultV2)
    end
  end

  describe 'test attribute "incident_role"' do
    it 'should work' do
