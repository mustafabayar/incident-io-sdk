...
# Unit tests for IncidentIoSdk::IncidentSlimV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentSlimV2 do
  let(:instance) { IncidentIoSdk::IncidentSlimV2.new }

  describe 'test an instance of IncidentSlimV2' do
    it 'should create an instance of IncidentSlimV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentSlimV2)
    end
  end
  ...
  describe 'test attribute "status_category"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["triage", "declined", "merged", "canceled", "active", "post-incident", "closed", "paused"])
      # validator.allowable_values.each do |value|
      #   expect { instance.status_category = value }.not_to raise_error
      # end
    end
  end
