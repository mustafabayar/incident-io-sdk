...
# Unit tests for IncidentIoSdk::IncidentStatusV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentStatusV1 do
  let(:instance) { IncidentIoSdk::IncidentStatusV1.new }

  describe 'test an instance of IncidentStatusV1' do
    it 'should create an instance of IncidentStatusV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentStatusV1)
    end
  end
  ...
  describe 'test attribute "category"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["triage", "declined", "merged", "canceled", "live", "learning", "closed", "paused"])
