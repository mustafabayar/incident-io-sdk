...
# Unit tests for IncidentIoSdk::IncidentStatusV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentStatusV2 do
  let(:instance) { IncidentIoSdk::IncidentStatusV2.new }

  describe 'test an instance of IncidentStatusV2' do
    it 'should create an instance of IncidentStatusV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentStatusV2)
    end
  end
