...
# Unit tests for IncidentIoSdk::IncidentStatusesCreatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentStatusesCreatePayloadV1 do
  let(:instance) { IncidentIoSdk::IncidentStatusesCreatePayloadV1.new }

  describe 'test an instance of IncidentStatusesCreatePayloadV1' do
    it 'should create an instance of IncidentStatusesCreatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentStatusesCreatePayloadV1)
    end
  end
  ...
  describe 'test attribute "category"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["live", "learning", "closed"])
