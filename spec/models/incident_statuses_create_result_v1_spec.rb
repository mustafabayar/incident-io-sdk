...
# Unit tests for IncidentIoSdk::IncidentStatusesCreateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentStatusesCreateResultV1 do
  let(:instance) { IncidentIoSdk::IncidentStatusesCreateResultV1.new }

  describe 'test an instance of IncidentStatusesCreateResultV1' do
    it 'should create an instance of IncidentStatusesCreateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentStatusesCreateResultV1)
    end
  end
