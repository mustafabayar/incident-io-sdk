...
# Unit tests for IncidentIoSdk::IncidentStatusesListResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentStatusesListResultV1 do
  let(:instance) { IncidentIoSdk::IncidentStatusesListResultV1.new }

  describe 'test an instance of IncidentStatusesListResultV1' do
    it 'should create an instance of IncidentStatusesListResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentStatusesListResultV1)
    end
  end

  describe 'test attribute "incident_statuses"' do
    it 'should work' do
