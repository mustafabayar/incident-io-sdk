...
# Unit tests for IncidentIoSdk::IncidentStatusesShowResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentStatusesShowResultV1 do
  let(:instance) { IncidentIoSdk::IncidentStatusesShowResultV1.new }

  describe 'test an instance of IncidentStatusesShowResultV1' do
    it 'should create an instance of IncidentStatusesShowResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentStatusesShowResultV1)
    end
  end
