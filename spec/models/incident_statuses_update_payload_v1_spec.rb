...
# Unit tests for IncidentIoSdk::IncidentStatusesUpdatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentStatusesUpdatePayloadV1 do
  let(:instance) { IncidentIoSdk::IncidentStatusesUpdatePayloadV1.new }

  describe 'test an instance of IncidentStatusesUpdatePayloadV1' do
    it 'should create an instance of IncidentStatusesUpdatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentStatusesUpdatePayloadV1)
    end
  end
