...
# Unit tests for IncidentIoSdk::IncidentStatusesUpdateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentStatusesUpdateResultV1 do
  let(:instance) { IncidentIoSdk::IncidentStatusesUpdateResultV1.new }

  describe 'test an instance of IncidentStatusesUpdateResultV1' do
    it 'should create an instance of IncidentStatusesUpdateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentStatusesUpdateResultV1)
    end
  end
