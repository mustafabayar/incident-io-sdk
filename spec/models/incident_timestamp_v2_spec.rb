...
# Unit tests for IncidentIoSdk::IncidentTimestampV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTimestampV2 do
  let(:instance) { IncidentIoSdk::IncidentTimestampV2.new }

  describe 'test an instance of IncidentTimestampV2' do
    it 'should create an instance of IncidentTimestampV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTimestampV2)
    end
  end
