...
# Unit tests for IncidentIoSdk::IncidentTimestampValuePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTimestampValuePayloadV2 do
  let(:instance) { IncidentIoSdk::IncidentTimestampValuePayloadV2.new }

  describe 'test an instance of IncidentTimestampValuePayloadV2' do
    it 'should create an instance of IncidentTimestampValuePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTimestampValuePayloadV2)
    end
  end

  describe 'test attribute "incident_timestamp_id"' do
    it 'should work' do
