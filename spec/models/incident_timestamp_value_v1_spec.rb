...
# Unit tests for IncidentIoSdk::IncidentTimestampValueV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTimestampValueV1 do
  let(:instance) { IncidentIoSdk::IncidentTimestampValueV1.new }

  describe 'test an instance of IncidentTimestampValueV1' do
    it 'should create an instance of IncidentTimestampValueV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTimestampValueV1)
    end
  end
