...
# Unit tests for IncidentIoSdk::IncidentTimestampValueV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTimestampValueV2 do
  let(:instance) { IncidentIoSdk::IncidentTimestampValueV2.new }

  describe 'test an instance of IncidentTimestampValueV2' do
    it 'should create an instance of IncidentTimestampValueV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTimestampValueV2)
    end
  end
