...
# Unit tests for IncidentIoSdk::IncidentTimestampWithValueV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTimestampWithValueV2 do
  let(:instance) { IncidentIoSdk::IncidentTimestampWithValueV2.new }

  describe 'test an instance of IncidentTimestampWithValueV2' do
    it 'should create an instance of IncidentTimestampWithValueV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTimestampWithValueV2)
    end
  end
