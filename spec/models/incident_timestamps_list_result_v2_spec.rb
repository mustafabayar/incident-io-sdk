...
# Unit tests for IncidentIoSdk::IncidentTimestampsListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTimestampsListResultV2 do
  let(:instance) { IncidentIoSdk::IncidentTimestampsListResultV2.new }

  describe 'test an instance of IncidentTimestampsListResultV2' do
    it 'should create an instance of IncidentTimestampsListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTimestampsListResultV2)
    end
  end

  describe 'test attribute "incident_timestamps"' do
    it 'should work' do
