...
# Unit tests for IncidentIoSdk::IncidentTimestampsShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTimestampsShowResultV2 do
  let(:instance) { IncidentIoSdk::IncidentTimestampsShowResultV2.new }

  describe 'test an instance of IncidentTimestampsShowResultV2' do
    it 'should create an instance of IncidentTimestampsShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTimestampsShowResultV2)
    end
  end

  describe 'test attribute "incident_timestamp"' do
    it 'should work' do
