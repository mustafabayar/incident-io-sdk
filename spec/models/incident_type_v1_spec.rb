...
# Unit tests for IncidentIoSdk::IncidentTypeV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTypeV1 do
  let(:instance) { IncidentIoSdk::IncidentTypeV1.new }

  describe 'test an instance of IncidentTypeV1' do
    it 'should create an instance of IncidentTypeV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTypeV1)
    end
  end

  describe 'test attribute "create_in_triage"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["always", "optional"])
      # validator.allowable_values.each do |value|
      #   expect { instance.create_in_triage = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "private_incidents_only"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
