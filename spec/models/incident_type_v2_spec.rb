...
# Unit tests for IncidentIoSdk::IncidentTypeV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTypeV2 do
  let(:instance) { IncidentIoSdk::IncidentTypeV2.new }

  describe 'test an instance of IncidentTypeV2' do
    it 'should create an instance of IncidentTypeV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTypeV2)
    end
  end
