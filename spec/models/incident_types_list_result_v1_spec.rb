...
# Unit tests for IncidentIoSdk::IncidentTypesListResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTypesListResultV1 do
  let(:instance) { IncidentIoSdk::IncidentTypesListResultV1.new }

  describe 'test an instance of IncidentTypesListResultV1' do
    it 'should create an instance of IncidentTypesListResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTypesListResultV1)
    end
  end

  describe 'test attribute "incident_types"' do
    it 'should work' do
