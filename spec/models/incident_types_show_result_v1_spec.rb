...
# Unit tests for IncidentIoSdk::IncidentTypesShowResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentTypesShowResultV1 do
  let(:instance) { IncidentIoSdk::IncidentTypesShowResultV1.new }

  describe 'test an instance of IncidentTypesShowResultV1' do
    it 'should create an instance of IncidentTypesShowResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentTypesShowResultV1)
    end
  end
