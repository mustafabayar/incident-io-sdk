...
# Unit tests for IncidentIoSdk::IncidentUpdateV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentUpdateV2 do
  let(:instance) { IncidentIoSdk::IncidentUpdateV2.new }

  describe 'test an instance of IncidentUpdateV2' do
    it 'should create an instance of IncidentUpdateV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentUpdateV2)
    end
  end
  ...
  describe 'test attribute "merged_into_incident_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "new_incident_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "new_severity"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
