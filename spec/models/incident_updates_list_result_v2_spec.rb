...
# Unit tests for IncidentIoSdk::IncidentUpdatesListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentUpdatesListResultV2 do
  let(:instance) { IncidentIoSdk::IncidentUpdatesListResultV2.new }

  describe 'test an instance of IncidentUpdatesListResultV2' do
    it 'should create an instance of IncidentUpdatesListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentUpdatesListResultV2)
    end
  end
