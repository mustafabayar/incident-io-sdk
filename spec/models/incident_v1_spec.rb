...
# Unit tests for IncidentIoSdk::IncidentV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentV1 do
  let(:instance) { IncidentIoSdk::IncidentV1.new }

  describe 'test an instance of IncidentV1' do
    it 'should create an instance of IncidentV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentV1)
    end
  end
  ...
  describe 'test attribute "mode"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["real", "test", "tutorial"])
