...
# Unit tests for IncidentIoSdk::IncidentV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentV2 do
  let(:instance) { IncidentIoSdk::IncidentV2.new }

  describe 'test an instance of IncidentV2' do
    it 'should create an instance of IncidentV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentV2)
    end
  end
