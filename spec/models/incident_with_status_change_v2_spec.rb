...
# Unit tests for IncidentIoSdk::IncidentWithStatusChangeV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentWithStatusChangeV2 do
  let(:instance) { IncidentIoSdk::IncidentWithStatusChangeV2.new }

  describe 'test an instance of IncidentWithStatusChangeV2' do
    it 'should create an instance of IncidentWithStatusChangeV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentWithStatusChangeV2)
    end
  end
