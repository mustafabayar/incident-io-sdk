...
# Unit tests for IncidentIoSdk::IncidentsCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::IncidentsCreatePayloadV2.new }

  describe 'test an instance of IncidentsCreatePayloadV2' do
    it 'should create an instance of IncidentsCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsCreatePayloadV2)
    end
  end
  ...
  describe 'test attribute "incident_status_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "retrospective_incident_options"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "slack_channel_name_override"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
