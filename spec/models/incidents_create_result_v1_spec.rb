...
# Unit tests for IncidentIoSdk::IncidentsCreateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsCreateResultV1 do
  let(:instance) { IncidentIoSdk::IncidentsCreateResultV1.new }

  describe 'test an instance of IncidentsCreateResultV1' do
    it 'should create an instance of IncidentsCreateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsCreateResultV1)
    end
  end
