...
# Unit tests for IncidentIoSdk::IncidentsCreateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsCreateResultV2 do
  let(:instance) { IncidentIoSdk::IncidentsCreateResultV2.new }

  describe 'test an instance of IncidentsCreateResultV2' do
    it 'should create an instance of IncidentsCreateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsCreateResultV2)
    end
  end
