...
# Unit tests for IncidentIoSdk::IncidentsEditPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsEditPayloadV2 do
  let(:instance) { IncidentIoSdk::IncidentsEditPayloadV2.new }

  describe 'test an instance of IncidentsEditPayloadV2' do
    it 'should create an instance of IncidentsEditPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsEditPayloadV2)
    end
  end
  ...
  describe 'test attribute "notify_incident_channel"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
