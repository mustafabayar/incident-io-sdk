...
# Unit tests for IncidentIoSdk::IncidentsEditResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsEditResultV2 do
  let(:instance) { IncidentIoSdk::IncidentsEditResultV2.new }

  describe 'test an instance of IncidentsEditResultV2' do
    it 'should create an instance of IncidentsEditResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsEditResultV2)
    end
  end
