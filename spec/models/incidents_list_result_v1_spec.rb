...
# Unit tests for IncidentIoSdk::IncidentsListResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsListResultV1 do
  let(:instance) { IncidentIoSdk::IncidentsListResultV1.new }

  describe 'test an instance of IncidentsListResultV1' do
    it 'should create an instance of IncidentsListResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsListResultV1)
    end
  end
