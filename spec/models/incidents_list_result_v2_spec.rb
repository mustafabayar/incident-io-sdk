...
# Unit tests for IncidentIoSdk::IncidentsListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsListResultV2 do
  let(:instance) { IncidentIoSdk::IncidentsListResultV2.new }

  describe 'test an instance of IncidentsListResultV2' do
    it 'should create an instance of IncidentsListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsListResultV2)
    end
  end
