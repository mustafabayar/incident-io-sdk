...
# Unit tests for IncidentIoSdk::IncidentsShowResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsShowResultV1 do
  let(:instance) { IncidentIoSdk::IncidentsShowResultV1.new }

  describe 'test an instance of IncidentsShowResultV1' do
    it 'should create an instance of IncidentsShowResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsShowResultV1)
    end
  end
