...
# Unit tests for IncidentIoSdk::IncidentsShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::IncidentsShowResultV2 do
  let(:instance) { IncidentIoSdk::IncidentsShowResultV2.new }

  describe 'test an instance of IncidentsShowResultV2' do
    it 'should create an instance of IncidentsShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::IncidentsShowResultV2)
    end
  end
