...
# Unit tests for IncidentIoSdk::ManagementMetaV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ManagementMetaV2 do
  let(:instance) { IncidentIoSdk::ManagementMetaV2.new }

  describe 'test an instance of ManagementMetaV2' do
    it 'should create an instance of ManagementMetaV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ManagementMetaV2)
    end
  end
  ...
  describe 'test attribute "managed_by"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["dashboard", "terraform", "external"])
