...
# Unit tests for IncidentIoSdk::PaginationMetaResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::PaginationMetaResultV1 do
  let(:instance) { IncidentIoSdk::PaginationMetaResultV1.new }

  describe 'test an instance of PaginationMetaResultV1' do
    it 'should create an instance of PaginationMetaResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::PaginationMetaResultV1)
    end
  end
