...
# Unit tests for IncidentIoSdk::PaginationMetaResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::PaginationMetaResultV2 do
  let(:instance) { IncidentIoSdk::PaginationMetaResultV2.new }

  describe 'test an instance of PaginationMetaResultV2' do
    it 'should create an instance of PaginationMetaResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::PaginationMetaResultV2)
    end
  end
