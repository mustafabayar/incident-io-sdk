...
# Unit tests for IncidentIoSdk::PaginationMetaResultV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::PaginationMetaResultV3 do
  let(:instance) { IncidentIoSdk::PaginationMetaResultV3.new }

  describe 'test an instance of PaginationMetaResultV3' do
    it 'should create an instance of PaginationMetaResultV3' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::PaginationMetaResultV3)
    end
  end
