...
# Unit tests for IncidentIoSdk::PaginationMetaResultWithTotalV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::PaginationMetaResultWithTotalV1 do
  let(:instance) { IncidentIoSdk::PaginationMetaResultWithTotalV1.new }

  describe 'test an instance of PaginationMetaResultWithTotalV1' do
    it 'should create an instance of PaginationMetaResultWithTotalV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::PaginationMetaResultWithTotalV1)
    end
  end
