...
# Unit tests for IncidentIoSdk::PaginationMetaResultWithTotalV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::PaginationMetaResultWithTotalV2 do
  let(:instance) { IncidentIoSdk::PaginationMetaResultWithTotalV2.new }

  describe 'test an instance of PaginationMetaResultWithTotalV2' do
    it 'should create an instance of PaginationMetaResultWithTotalV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::PaginationMetaResultWithTotalV2)
    end
  end
