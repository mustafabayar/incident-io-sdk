...
# Unit tests for IncidentIoSdk::RBACRoleV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::RBACRoleV2 do
  let(:instance) { IncidentIoSdk::RBACRoleV2.new }

  describe 'test an instance of RBACRoleV2' do
    it 'should create an instance of RBACRoleV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::RBACRoleV2)
    end
  end
