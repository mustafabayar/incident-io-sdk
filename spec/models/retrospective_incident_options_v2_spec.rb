...
# Unit tests for IncidentIoSdk::RetrospectiveIncidentOptionsV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::RetrospectiveIncidentOptionsV2 do
  let(:instance) { IncidentIoSdk::RetrospectiveIncidentOptionsV2.new }

  describe 'test an instance of RetrospectiveIncidentOptionsV2' do
    it 'should create an instance of RetrospectiveIncidentOptionsV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::RetrospectiveIncidentOptionsV2)
    end
  end
