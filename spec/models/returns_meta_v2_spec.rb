...
# Unit tests for IncidentIoSdk::ReturnsMetaV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ReturnsMetaV2 do
  let(:instance) { IncidentIoSdk::ReturnsMetaV2.new }

  describe 'test an instance of ReturnsMetaV2' do
    it 'should create an instance of ReturnsMetaV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ReturnsMetaV2)
    end
  end
