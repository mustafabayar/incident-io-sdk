...
# Unit tests for IncidentIoSdk::ScheduleConfigCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleConfigCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleConfigCreatePayloadV2.new }

  describe 'test an instance of ScheduleConfigCreatePayloadV2' do
    it 'should create an instance of ScheduleConfigCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleConfigCreatePayloadV2)
    end
  end
