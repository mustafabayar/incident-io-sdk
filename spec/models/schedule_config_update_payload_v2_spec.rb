...
# Unit tests for IncidentIoSdk::ScheduleConfigUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleConfigUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleConfigUpdatePayloadV2.new }

  describe 'test an instance of ScheduleConfigUpdatePayloadV2' do
    it 'should create an instance of ScheduleConfigUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleConfigUpdatePayloadV2)
    end
  end
