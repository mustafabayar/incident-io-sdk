...
# Unit tests for IncidentIoSdk::ScheduleConfigV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleConfigV2 do
  let(:instance) { IncidentIoSdk::ScheduleConfigV2.new }

  describe 'test an instance of ScheduleConfigV2' do
    it 'should create an instance of ScheduleConfigV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleConfigV2)
    end
  end
