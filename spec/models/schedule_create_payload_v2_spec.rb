...
# Unit tests for IncidentIoSdk::ScheduleCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleCreatePayloadV2.new }

  describe 'test an instance of ScheduleCreatePayloadV2' do
    it 'should create an instance of ScheduleCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleCreatePayloadV2)
    end
  end
