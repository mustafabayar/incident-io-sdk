...
# Unit tests for IncidentIoSdk::ScheduleEntriesListPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleEntriesListPayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleEntriesListPayloadV2.new }

  describe 'test an instance of ScheduleEntriesListPayloadV2' do
    it 'should create an instance of ScheduleEntriesListPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleEntriesListPayloadV2)
    end
  end

  describe 'test attribute "final"' do
    it 'should work' do
