...
# Unit tests for IncidentIoSdk::ScheduleEntryV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleEntryV2 do
  let(:instance) { IncidentIoSdk::ScheduleEntryV2.new }

  describe 'test an instance of ScheduleEntryV2' do
    it 'should create an instance of ScheduleEntryV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleEntryV2)
    end
  end
