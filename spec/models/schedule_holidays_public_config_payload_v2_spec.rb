...
# Unit tests for IncidentIoSdk::ScheduleHolidaysPublicConfigPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleHolidaysPublicConfigPayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleHolidaysPublicConfigPayloadV2.new }

  describe 'test an instance of ScheduleHolidaysPublicConfigPayloadV2' do
    it 'should create an instance of ScheduleHolidaysPublicConfigPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleHolidaysPublicConfigPayloadV2)
    end
  end
