...
# Unit tests for IncidentIoSdk::ScheduleHolidaysPublicConfigV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleHolidaysPublicConfigV2 do
  let(:instance) { IncidentIoSdk::ScheduleHolidaysPublicConfigV2.new }

  describe 'test an instance of ScheduleHolidaysPublicConfigV2' do
    it 'should create an instance of ScheduleHolidaysPublicConfigV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleHolidaysPublicConfigV2)
    end
  end
