...
# Unit tests for IncidentIoSdk::ScheduleLayerCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleLayerCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleLayerCreatePayloadV2.new }

  describe 'test an instance of ScheduleLayerCreatePayloadV2' do
    it 'should create an instance of ScheduleLayerCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleLayerCreatePayloadV2)
    end
  end
