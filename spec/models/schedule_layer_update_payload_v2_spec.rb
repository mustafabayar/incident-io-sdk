...
# Unit tests for IncidentIoSdk::ScheduleLayerUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleLayerUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleLayerUpdatePayloadV2.new }

  describe 'test an instance of ScheduleLayerUpdatePayloadV2' do
    it 'should create an instance of ScheduleLayerUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleLayerUpdatePayloadV2)
    end
  end
