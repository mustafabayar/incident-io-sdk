...
# Unit tests for IncidentIoSdk::ScheduleLayerV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleLayerV2 do
  let(:instance) { IncidentIoSdk::ScheduleLayerV2.new }

  describe 'test an instance of ScheduleLayerV2' do
    it 'should create an instance of ScheduleLayerV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleLayerV2)
    end
  end
