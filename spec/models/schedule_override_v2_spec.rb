...
# Unit tests for IncidentIoSdk::ScheduleOverrideV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleOverrideV2 do
  let(:instance) { IncidentIoSdk::ScheduleOverrideV2.new }

  describe 'test an instance of ScheduleOverrideV2' do
    it 'should create an instance of ScheduleOverrideV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleOverrideV2)
    end
  end
