...
# Unit tests for IncidentIoSdk::ScheduleRotationCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleRotationCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleRotationCreatePayloadV2.new }

  describe 'test an instance of ScheduleRotationCreatePayloadV2' do
    it 'should create an instance of ScheduleRotationCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleRotationCreatePayloadV2)
    end
  end
