...
# Unit tests for IncidentIoSdk::ScheduleRotationHandoverV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleRotationHandoverV2 do
  let(:instance) { IncidentIoSdk::ScheduleRotationHandoverV2.new }

  describe 'test an instance of ScheduleRotationHandoverV2' do
    it 'should create an instance of ScheduleRotationHandoverV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleRotationHandoverV2)
    end
  end
  ...
  describe 'test attribute "interval_type"' do
    it 'should work' do
      ...
      #   expect { instance.interval_type = value }.not_to raise_error
      # end
    end
  end
