...
# Unit tests for IncidentIoSdk::ScheduleRotationUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleRotationUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleRotationUpdatePayloadV2.new }

  describe 'test an instance of ScheduleRotationUpdatePayloadV2' do
    it 'should create an instance of ScheduleRotationUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleRotationUpdatePayloadV2)
    end
  end
  ...
  describe 'test attribute "handover_start_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "handovers"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "working_interval"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
