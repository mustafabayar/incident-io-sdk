...
# Unit tests for IncidentIoSdk::ScheduleRotationV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleRotationV2 do
  let(:instance) { IncidentIoSdk::ScheduleRotationV2.new }

  describe 'test an instance of ScheduleRotationV2' do
    it 'should create an instance of ScheduleRotationV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleRotationV2)
    end
  end
  ...
  describe 'test attribute "working_intervals"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
