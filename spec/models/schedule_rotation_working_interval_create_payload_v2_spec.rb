...
# Unit tests for IncidentIoSdk::ScheduleRotationWorkingIntervalCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleRotationWorkingIntervalCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleRotationWorkingIntervalCreatePayloadV2.new }

  describe 'test an instance of ScheduleRotationWorkingIntervalCreatePayloadV2' do
    it 'should create an instance of ScheduleRotationWorkingIntervalCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleRotationWorkingIntervalCreatePayloadV2)
    end
  end
