...
# Unit tests for IncidentIoSdk::ScheduleRotationWorkingIntervalUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleRotationWorkingIntervalUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleRotationWorkingIntervalUpdatePayloadV2.new }

  describe 'test an instance of ScheduleRotationWorkingIntervalUpdatePayloadV2' do
    it 'should create an instance of ScheduleRotationWorkingIntervalUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleRotationWorkingIntervalUpdatePayloadV2)
    end
  end
  ...
  describe 'test attribute "weekday"' do
    it 'should work' do
      ...
      #   expect { instance.weekday = value }.not_to raise_error
      # end
    end
  end
