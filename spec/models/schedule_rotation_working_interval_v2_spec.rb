...
# Unit tests for IncidentIoSdk::ScheduleRotationWorkingIntervalV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleRotationWorkingIntervalV2 do
  let(:instance) { IncidentIoSdk::ScheduleRotationWorkingIntervalV2.new }

  describe 'test an instance of ScheduleRotationWorkingIntervalV2' do
    it 'should create an instance of ScheduleRotationWorkingIntervalV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleRotationWorkingIntervalV2)
    end
  end
