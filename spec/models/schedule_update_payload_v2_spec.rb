...
# Unit tests for IncidentIoSdk::ScheduleUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::ScheduleUpdatePayloadV2.new }

  describe 'test an instance of ScheduleUpdatePayloadV2' do
    it 'should create an instance of ScheduleUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleUpdatePayloadV2)
    end
  end
  ...
  describe 'test attribute "holidays_public_config"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
