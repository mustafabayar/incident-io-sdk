...
# Unit tests for IncidentIoSdk::ScheduleV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::ScheduleV2 do
  let(:instance) { IncidentIoSdk::ScheduleV2.new }

  describe 'test an instance of ScheduleV2' do
    it 'should create an instance of ScheduleV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::ScheduleV2)
    end
  end
  ...
  describe 'test attribute "current_shifts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
