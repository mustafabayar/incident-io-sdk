...
# Unit tests for IncidentIoSdk::SchedulesCreateOverridePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesCreateOverridePayloadV2 do
  let(:instance) { IncidentIoSdk::SchedulesCreateOverridePayloadV2.new }

  describe 'test an instance of SchedulesCreateOverridePayloadV2' do
    it 'should create an instance of SchedulesCreateOverridePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesCreateOverridePayloadV2)
    end
  end
  ...
  describe 'test attribute "rotation_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
