...
# Unit tests for IncidentIoSdk::SchedulesCreateOverrideResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesCreateOverrideResultV2 do
  let(:instance) { IncidentIoSdk::SchedulesCreateOverrideResultV2.new }

  describe 'test an instance of SchedulesCreateOverrideResultV2' do
    it 'should create an instance of SchedulesCreateOverrideResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesCreateOverrideResultV2)
    end
  end
