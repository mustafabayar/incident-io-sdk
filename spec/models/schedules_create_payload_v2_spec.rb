...
# Unit tests for IncidentIoSdk::SchedulesCreatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesCreatePayloadV2 do
  let(:instance) { IncidentIoSdk::SchedulesCreatePayloadV2.new }

  describe 'test an instance of SchedulesCreatePayloadV2' do
    it 'should create an instance of SchedulesCreatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesCreatePayloadV2)
    end
  end
