...
# Unit tests for IncidentIoSdk::SchedulesCreateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesCreateResultV2 do
  let(:instance) { IncidentIoSdk::SchedulesCreateResultV2.new }

  describe 'test an instance of SchedulesCreateResultV2' do
    it 'should create an instance of SchedulesCreateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesCreateResultV2)
    end
  end
