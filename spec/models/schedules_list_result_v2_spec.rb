...
# Unit tests for IncidentIoSdk::SchedulesListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesListResultV2 do
  let(:instance) { IncidentIoSdk::SchedulesListResultV2.new }

  describe 'test an instance of SchedulesListResultV2' do
    it 'should create an instance of SchedulesListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesListResultV2)
    end
  end
