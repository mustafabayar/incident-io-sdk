...
# Unit tests for IncidentIoSdk::SchedulesListScheduleEntriesResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesListScheduleEntriesResultV2 do
  let(:instance) { IncidentIoSdk::SchedulesListScheduleEntriesResultV2.new }

  describe 'test an instance of SchedulesListScheduleEntriesResultV2' do
    it 'should create an instance of SchedulesListScheduleEntriesResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesListScheduleEntriesResultV2)
    end
  end
