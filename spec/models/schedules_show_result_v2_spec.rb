...
# Unit tests for IncidentIoSdk::SchedulesShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesShowResultV2 do
  let(:instance) { IncidentIoSdk::SchedulesShowResultV2.new }

  describe 'test an instance of SchedulesShowResultV2' do
    it 'should create an instance of SchedulesShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesShowResultV2)
    end
  end
