...
# Unit tests for IncidentIoSdk::SchedulesUpdatePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesUpdatePayloadV2 do
  let(:instance) { IncidentIoSdk::SchedulesUpdatePayloadV2.new }

  describe 'test an instance of SchedulesUpdatePayloadV2' do
    it 'should create an instance of SchedulesUpdatePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesUpdatePayloadV2)
    end
  end
