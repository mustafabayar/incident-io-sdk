...
# Unit tests for IncidentIoSdk::SchedulesUpdateResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SchedulesUpdateResultV2 do
  let(:instance) { IncidentIoSdk::SchedulesUpdateResultV2.new }

  describe 'test an instance of SchedulesUpdateResultV2' do
    it 'should create an instance of SchedulesUpdateResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SchedulesUpdateResultV2)
    end
  end
