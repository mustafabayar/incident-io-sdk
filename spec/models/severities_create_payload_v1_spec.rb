...
# Unit tests for IncidentIoSdk::SeveritiesCreatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SeveritiesCreatePayloadV1 do
  let(:instance) { IncidentIoSdk::SeveritiesCreatePayloadV1.new }

  describe 'test an instance of SeveritiesCreatePayloadV1' do
    it 'should create an instance of SeveritiesCreatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SeveritiesCreatePayloadV1)
    end
  end
