...
# Unit tests for IncidentIoSdk::SeveritiesCreateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SeveritiesCreateResultV1 do
  let(:instance) { IncidentIoSdk::SeveritiesCreateResultV1.new }

  describe 'test an instance of SeveritiesCreateResultV1' do
    it 'should create an instance of SeveritiesCreateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SeveritiesCreateResultV1)
    end
  end
