...
# Unit tests for IncidentIoSdk::SeveritiesListResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SeveritiesListResultV1 do
  let(:instance) { IncidentIoSdk::SeveritiesListResultV1.new }

  describe 'test an instance of SeveritiesListResultV1' do
    it 'should create an instance of SeveritiesListResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SeveritiesListResultV1)
    end
  end
