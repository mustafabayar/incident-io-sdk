...
# Unit tests for IncidentIoSdk::SeveritiesShowResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SeveritiesShowResultV1 do
  let(:instance) { IncidentIoSdk::SeveritiesShowResultV1.new }

  describe 'test an instance of SeveritiesShowResultV1' do
    it 'should create an instance of SeveritiesShowResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SeveritiesShowResultV1)
    end
  end
