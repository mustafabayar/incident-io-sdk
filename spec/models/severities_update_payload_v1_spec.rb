...
# Unit tests for IncidentIoSdk::SeveritiesUpdatePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SeveritiesUpdatePayloadV1 do
  let(:instance) { IncidentIoSdk::SeveritiesUpdatePayloadV1.new }

  describe 'test an instance of SeveritiesUpdatePayloadV1' do
    it 'should create an instance of SeveritiesUpdatePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SeveritiesUpdatePayloadV1)
    end
  end
