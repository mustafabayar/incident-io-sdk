...
# Unit tests for IncidentIoSdk::SeveritiesUpdateResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SeveritiesUpdateResultV1 do
  let(:instance) { IncidentIoSdk::SeveritiesUpdateResultV1.new }

  describe 'test an instance of SeveritiesUpdateResultV1' do
    it 'should create an instance of SeveritiesUpdateResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SeveritiesUpdateResultV1)
    end
  end
