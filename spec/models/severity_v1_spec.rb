...
# Unit tests for IncidentIoSdk::SeverityV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SeverityV1 do
  let(:instance) { IncidentIoSdk::SeverityV1.new }

  describe 'test an instance of SeverityV1' do
    it 'should create an instance of SeverityV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SeverityV1)
    end
  end
