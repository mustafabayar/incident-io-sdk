...
# Unit tests for IncidentIoSdk::SeverityV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::SeverityV2 do
  let(:instance) { IncidentIoSdk::SeverityV2.new }

  describe 'test an instance of SeverityV2' do
    it 'should create an instance of SeverityV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::SeverityV2)
    end
  end
