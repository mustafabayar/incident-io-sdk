...
# Unit tests for IncidentIoSdk::StepConfigPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::StepConfigPayloadV2 do
  let(:instance) { IncidentIoSdk::StepConfigPayloadV2.new }

  describe 'test an instance of StepConfigPayloadV2' do
    it 'should create an instance of StepConfigPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::StepConfigPayloadV2)
    end
  end
  ...
  describe 'test attribute "param_bindings"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
