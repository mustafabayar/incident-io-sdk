...
# Unit tests for IncidentIoSdk::StepConfigSlimV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::StepConfigSlimV2 do
  let(:instance) { IncidentIoSdk::StepConfigSlimV2.new }

  describe 'test an instance of StepConfigSlimV2' do
    it 'should create an instance of StepConfigSlimV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::StepConfigSlimV2)
    end
  end
