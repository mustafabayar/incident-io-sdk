...
# Unit tests for IncidentIoSdk::StepConfigV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::StepConfigV2 do
  let(:instance) { IncidentIoSdk::StepConfigV2.new }

  describe 'test an instance of StepConfigV2' do
    it 'should create an instance of StepConfigV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::StepConfigV2)
    end
  end
