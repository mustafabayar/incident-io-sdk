...
# Unit tests for IncidentIoSdk::TriggerSlimV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::TriggerSlimV2 do
  let(:instance) { IncidentIoSdk::TriggerSlimV2.new }

  describe 'test an instance of TriggerSlimV2' do
    it 'should create an instance of TriggerSlimV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::TriggerSlimV2)
    end
  end
