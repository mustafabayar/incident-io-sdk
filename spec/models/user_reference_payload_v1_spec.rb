...
# Unit tests for IncidentIoSdk::UserReferencePayloadV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::UserReferencePayloadV1 do
  let(:instance) { IncidentIoSdk::UserReferencePayloadV1.new }

  describe 'test an instance of UserReferencePayloadV1' do
    it 'should create an instance of UserReferencePayloadV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::UserReferencePayloadV1)
    end
  end
