...
# Unit tests for IncidentIoSdk::UserReferencePayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::UserReferencePayloadV2 do
  let(:instance) { IncidentIoSdk::UserReferencePayloadV2.new }

  describe 'test an instance of UserReferencePayloadV2' do
    it 'should create an instance of UserReferencePayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::UserReferencePayloadV2)
    end
  end
