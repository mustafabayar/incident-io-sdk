...
# Unit tests for IncidentIoSdk::UserV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::UserV1 do
  let(:instance) { IncidentIoSdk::UserV1.new }

  describe 'test an instance of UserV1' do
    it 'should create an instance of UserV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::UserV1)
    end
  end
