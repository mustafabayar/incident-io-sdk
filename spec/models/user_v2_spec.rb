...
# Unit tests for IncidentIoSdk::UserV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::UserV2 do
  let(:instance) { IncidentIoSdk::UserV2.new }

  describe 'test an instance of UserV2' do
    it 'should create an instance of UserV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::UserV2)
    end
  end
