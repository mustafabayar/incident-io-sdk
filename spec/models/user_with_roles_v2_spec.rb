...
# Unit tests for IncidentIoSdk::UserWithRolesV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::UserWithRolesV2 do
  let(:instance) { IncidentIoSdk::UserWithRolesV2.new }

  describe 'test an instance of UserWithRolesV2' do
    it 'should create an instance of UserWithRolesV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::UserWithRolesV2)
    end
  end

  describe 'test attribute "base_role"' do
    it 'should work' do
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["viewer", "responder", "administrator", "owner", "unset"])
  ...
  describe 'test attribute "slack_user_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
