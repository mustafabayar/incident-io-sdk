...
# Unit tests for IncidentIoSdk::UsersListResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::UsersListResultV2 do
  let(:instance) { IncidentIoSdk::UsersListResultV2.new }

  describe 'test an instance of UsersListResultV2' do
    it 'should create an instance of UsersListResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::UsersListResultV2)
    end
  end
