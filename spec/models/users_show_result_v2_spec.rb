...
# Unit tests for IncidentIoSdk::UsersShowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::UsersShowResultV2 do
  let(:instance) { IncidentIoSdk::UsersShowResultV2.new }

  describe 'test an instance of UsersShowResultV2' do
    it 'should create an instance of UsersShowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::UsersShowResultV2)
    end
  end
