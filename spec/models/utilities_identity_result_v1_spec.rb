...
# Unit tests for IncidentIoSdk::UtilitiesIdentityResultV1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::UtilitiesIdentityResultV1 do
  let(:instance) { IncidentIoSdk::UtilitiesIdentityResultV1.new }

  describe 'test an instance of UtilitiesIdentityResultV1' do
    it 'should create an instance of UtilitiesIdentityResultV1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::UtilitiesIdentityResultV1)
    end
  end
