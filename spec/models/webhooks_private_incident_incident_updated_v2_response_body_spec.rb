...
# Unit tests for IncidentIoSdk::WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody do
  let(:instance) { IncidentIoSdk::WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody.new }

  describe 'test an instance of WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody' do
    it 'should create an instance of WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WebhooksPrivateIncidentIncidentUpdatedV2ResponseBody)
    end
  end
  ...
  describe 'test attribute "private_incident_incident_updated_v2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
