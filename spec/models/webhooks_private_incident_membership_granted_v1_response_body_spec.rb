...
# Unit tests for IncidentIoSdk::WebhooksPrivateIncidentMembershipGrantedV1ResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WebhooksPrivateIncidentMembershipGrantedV1ResponseBody do
  let(:instance) { IncidentIoSdk::WebhooksPrivateIncidentMembershipGrantedV1ResponseBody.new }

  describe 'test an instance of WebhooksPrivateIncidentMembershipGrantedV1ResponseBody' do
    it 'should create an instance of WebhooksPrivateIncidentMembershipGrantedV1ResponseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WebhooksPrivateIncidentMembershipGrantedV1ResponseBody)
    end
  end
  ...
  describe 'test attribute "private_incident_membership_granted_v1"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
