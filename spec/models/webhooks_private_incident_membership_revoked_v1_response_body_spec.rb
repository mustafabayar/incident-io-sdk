...
# Unit tests for IncidentIoSdk::WebhooksPrivateIncidentMembershipRevokedV1ResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WebhooksPrivateIncidentMembershipRevokedV1ResponseBody do
  let(:instance) { IncidentIoSdk::WebhooksPrivateIncidentMembershipRevokedV1ResponseBody.new }

  describe 'test an instance of WebhooksPrivateIncidentMembershipRevokedV1ResponseBody' do
    it 'should create an instance of WebhooksPrivateIncidentMembershipRevokedV1ResponseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WebhooksPrivateIncidentMembershipRevokedV1ResponseBody)
    end
  end
  ...
  describe 'test attribute "private_incident_membership_revoked_v1"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
