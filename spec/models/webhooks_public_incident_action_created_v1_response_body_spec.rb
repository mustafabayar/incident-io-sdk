...
# Unit tests for IncidentIoSdk::WebhooksPublicIncidentActionCreatedV1ResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WebhooksPublicIncidentActionCreatedV1ResponseBody do
  let(:instance) { IncidentIoSdk::WebhooksPublicIncidentActionCreatedV1ResponseBody.new }

  describe 'test an instance of WebhooksPublicIncidentActionCreatedV1ResponseBody' do
    it 'should create an instance of WebhooksPublicIncidentActionCreatedV1ResponseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WebhooksPublicIncidentActionCreatedV1ResponseBody)
    end
  end
  ...
  describe 'test attribute "public_incident_action_created_v1"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
