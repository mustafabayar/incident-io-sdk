...
# Unit tests for IncidentIoSdk::WebhooksPublicIncidentFollowUpCreatedV1ResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WebhooksPublicIncidentFollowUpCreatedV1ResponseBody do
  let(:instance) { IncidentIoSdk::WebhooksPublicIncidentFollowUpCreatedV1ResponseBody.new }

  describe 'test an instance of WebhooksPublicIncidentFollowUpCreatedV1ResponseBody' do
    it 'should create an instance of WebhooksPublicIncidentFollowUpCreatedV1ResponseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WebhooksPublicIncidentFollowUpCreatedV1ResponseBody)
    end
  end
  ...
  describe 'test attribute "public_incident_follow_up_created_v1"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
