...
# Unit tests for IncidentIoSdk::WebhooksPublicIncidentFollowUpUpdatedV1ResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WebhooksPublicIncidentFollowUpUpdatedV1ResponseBody do
  let(:instance) { IncidentIoSdk::WebhooksPublicIncidentFollowUpUpdatedV1ResponseBody.new }

  describe 'test an instance of WebhooksPublicIncidentFollowUpUpdatedV1ResponseBody' do
    it 'should create an instance of WebhooksPublicIncidentFollowUpUpdatedV1ResponseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WebhooksPublicIncidentFollowUpUpdatedV1ResponseBody)
    end
  end
  ...
  describe 'test attribute "public_incident_follow_up_updated_v1"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
