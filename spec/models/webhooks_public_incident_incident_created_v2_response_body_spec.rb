...
# Unit tests for IncidentIoSdk::WebhooksPublicIncidentIncidentCreatedV2ResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WebhooksPublicIncidentIncidentCreatedV2ResponseBody do
  let(:instance) { IncidentIoSdk::WebhooksPublicIncidentIncidentCreatedV2ResponseBody.new }

  describe 'test an instance of WebhooksPublicIncidentIncidentCreatedV2ResponseBody' do
    it 'should create an instance of WebhooksPublicIncidentIncidentCreatedV2ResponseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WebhooksPublicIncidentIncidentCreatedV2ResponseBody)
    end
  end
  ...
  describe 'test attribute "public_incident_incident_created_v2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
