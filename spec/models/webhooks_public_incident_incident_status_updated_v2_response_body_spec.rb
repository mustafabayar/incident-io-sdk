...
# Unit tests for IncidentIoSdk::WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody do
  let(:instance) { IncidentIoSdk::WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody.new }

  describe 'test an instance of WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody' do
    it 'should create an instance of WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WebhooksPublicIncidentIncidentStatusUpdatedV2ResponseBody)
    end
  end
  ...
  describe 'test attribute "public_incident_incident_status_updated_v2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
