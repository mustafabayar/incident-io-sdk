...
# Unit tests for IncidentIoSdk::WeekdayIntervalConfigV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WeekdayIntervalConfigV2 do
  let(:instance) { IncidentIoSdk::WeekdayIntervalConfigV2.new }

  describe 'test an instance of WeekdayIntervalConfigV2' do
    it 'should create an instance of WeekdayIntervalConfigV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WeekdayIntervalConfigV2)
    end
  end
  ...
  describe 'test attribute "weekday_intervals"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
