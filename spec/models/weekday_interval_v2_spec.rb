...
# Unit tests for IncidentIoSdk::WeekdayIntervalV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WeekdayIntervalV2 do
  let(:instance) { IncidentIoSdk::WeekdayIntervalV2.new }

  describe 'test an instance of WeekdayIntervalV2' do
    it 'should create an instance of WeekdayIntervalV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WeekdayIntervalV2)
    end
  end
