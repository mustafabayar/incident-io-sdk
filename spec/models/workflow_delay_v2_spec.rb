...
# Unit tests for IncidentIoSdk::WorkflowDelayV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WorkflowDelayV2 do
  let(:instance) { IncidentIoSdk::WorkflowDelayV2.new }

  describe 'test an instance of WorkflowDelayV2' do
    it 'should create an instance of WorkflowDelayV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WorkflowDelayV2)
    end
  end

  describe 'test attribute "conditions_apply_over_delay"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "for_seconds"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
