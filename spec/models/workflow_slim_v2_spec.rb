...
# Unit tests for IncidentIoSdk::WorkflowSlimV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WorkflowSlimV2 do
  let(:instance) { IncidentIoSdk::WorkflowSlimV2.new }

  describe 'test an instance of WorkflowSlimV2' do
    it 'should create an instance of WorkflowSlimV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WorkflowSlimV2)
    end
  end
  ...
  describe 'test attribute "runs_from"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
