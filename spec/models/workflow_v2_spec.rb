...
# Unit tests for IncidentIoSdk::WorkflowV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WorkflowV2 do
  let(:instance) { IncidentIoSdk::WorkflowV2.new }

  describe 'test an instance of WorkflowV2' do
    it 'should create an instance of WorkflowV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WorkflowV2)
    end
  end
