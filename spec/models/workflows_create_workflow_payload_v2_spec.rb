...
# Unit tests for IncidentIoSdk::WorkflowsCreateWorkflowPayloadV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WorkflowsCreateWorkflowPayloadV2 do
  let(:instance) { IncidentIoSdk::WorkflowsCreateWorkflowPayloadV2.new }

  describe 'test an instance of WorkflowsCreateWorkflowPayloadV2' do
    it 'should create an instance of WorkflowsCreateWorkflowPayloadV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WorkflowsCreateWorkflowPayloadV2)
    end
  end
  ...
  describe 'test attribute "continue_on_step_error"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "include_private_incidents"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "once_for"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "runs_on_incident_modes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["standard", "test", "retrospective"])
      # validator.allowable_values.each do |value|
      #   expect { instance.runs_on_incident_modes = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "runs_on_incidents"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["newly_created", "newly_created_and_active"])
      # validator.allowable_values.each do |value|
      #   expect { instance.runs_on_incidents = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "shortform"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["active", "disabled", "draft", "error"])
      # validator.allowable_values.each do |value|
