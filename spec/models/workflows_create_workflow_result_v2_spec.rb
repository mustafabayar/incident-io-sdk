...
# Unit tests for IncidentIoSdk::WorkflowsCreateWorkflowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WorkflowsCreateWorkflowResultV2 do
  let(:instance) { IncidentIoSdk::WorkflowsCreateWorkflowResultV2.new }

  describe 'test an instance of WorkflowsCreateWorkflowResultV2' do
    it 'should create an instance of WorkflowsCreateWorkflowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WorkflowsCreateWorkflowResultV2)
    end
  end

  describe 'test attribute "management_meta"' do
    it 'should work' do
