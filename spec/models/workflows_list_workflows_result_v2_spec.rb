...
# Unit tests for IncidentIoSdk::WorkflowsListWorkflowsResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WorkflowsListWorkflowsResultV2 do
  let(:instance) { IncidentIoSdk::WorkflowsListWorkflowsResultV2.new }

  describe 'test an instance of WorkflowsListWorkflowsResultV2' do
    it 'should create an instance of WorkflowsListWorkflowsResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WorkflowsListWorkflowsResultV2)
    end
  end
