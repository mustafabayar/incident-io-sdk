...
# Unit tests for IncidentIoSdk::WorkflowsShowWorkflowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WorkflowsShowWorkflowResultV2 do
  let(:instance) { IncidentIoSdk::WorkflowsShowWorkflowResultV2.new }

  describe 'test an instance of WorkflowsShowWorkflowResultV2' do
    it 'should create an instance of WorkflowsShowWorkflowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WorkflowsShowWorkflowResultV2)
    end
  end
