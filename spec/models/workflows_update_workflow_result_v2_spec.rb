...
# Unit tests for IncidentIoSdk::WorkflowsUpdateWorkflowResultV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IncidentIoSdk::WorkflowsUpdateWorkflowResultV2 do
  let(:instance) { IncidentIoSdk::WorkflowsUpdateWorkflowResultV2.new }

  describe 'test an instance of WorkflowsUpdateWorkflowResultV2' do
    it 'should create an instance of WorkflowsUpdateWorkflowResultV2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IncidentIoSdk::WorkflowsUpdateWorkflowResultV2)
    end
  end
